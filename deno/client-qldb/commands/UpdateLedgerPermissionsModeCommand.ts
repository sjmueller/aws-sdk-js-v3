...
import { UpdateLedgerPermissionsModeRequest, UpdateLedgerPermissionsModeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QLDBClient, UpdateLedgerPermissionsModeCommand } from "../../client-qldb/mod.ts";
