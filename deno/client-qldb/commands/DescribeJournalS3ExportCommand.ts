...
import { DescribeJournalS3ExportRequest, DescribeJournalS3ExportResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QLDBClient, DescribeJournalS3ExportCommand } from "../../client-qldb/mod.ts";
