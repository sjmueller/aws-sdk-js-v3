...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeAggregateComplianceByConfigRulesCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeAggregateComplianceByConfigRulesCommand(
      output,
      context
    );
  }
