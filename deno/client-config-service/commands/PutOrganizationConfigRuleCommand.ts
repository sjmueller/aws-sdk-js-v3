...
import { PutOrganizationConfigRuleRequest, PutOrganizationConfigRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConfigServiceClient, PutOrganizationConfigRuleCommand } from "../../client-config-service/mod.ts";
