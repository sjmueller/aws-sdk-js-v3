...
import { DeleteConfigurationAggregatorRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConfigServiceClient, DeleteConfigurationAggregatorCommand } from "../../client-config-service/mod.ts";
