...
import { DeleteAggregationAuthorizationRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConfigServiceClient, DeleteAggregationAuthorizationCommand } from "../../client-config-service/mod.ts";
