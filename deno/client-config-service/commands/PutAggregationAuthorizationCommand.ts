...
export type PutAggregationAuthorizationCommandOutput = PutAggregationAuthorizationResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1PutAggregationAuthorizationCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1PutAggregationAuthorizationCommand(
      output,
      context
    );
  }
