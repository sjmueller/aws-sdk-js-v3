...
import { GetStoredQueryRequest, GetStoredQueryResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConfigServiceClient, GetStoredQueryCommand } from "../../client-config-service/mod.ts";
