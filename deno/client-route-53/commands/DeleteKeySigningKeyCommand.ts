...
import { DeleteKeySigningKeyRequest, DeleteKeySigningKeyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, DeleteKeySigningKeyCommand } from "../../client-route-53/mod.ts";
