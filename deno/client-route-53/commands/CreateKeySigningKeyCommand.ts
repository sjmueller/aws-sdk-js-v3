...
import { CreateKeySigningKeyRequest, CreateKeySigningKeyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, CreateKeySigningKeyCommand } from "../../client-route-53/mod.ts";
