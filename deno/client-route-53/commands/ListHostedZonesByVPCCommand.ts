...
import { ListHostedZonesByVPCRequest, ListHostedZonesByVPCResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, ListHostedZonesByVPCCommand } from "../../client-route-53/mod.ts";
