...
import { DeleteTrafficPolicyInstanceRequest, DeleteTrafficPolicyInstanceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, DeleteTrafficPolicyInstanceCommand } from "../../client-route-53/mod.ts";
