...
import { UpdateTrafficPolicyInstanceRequest, UpdateTrafficPolicyInstanceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, UpdateTrafficPolicyInstanceCommand } from "../../client-route-53/mod.ts";
