...
import { ListGeoLocationsRequest, ListGeoLocationsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, ListGeoLocationsCommand } from "../../client-route-53/mod.ts";
