...
import { UpdateTrafficPolicyCommentRequest, UpdateTrafficPolicyCommentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, UpdateTrafficPolicyCommentCommand } from "../../client-route-53/mod.ts";
