...
import { DeleteQueryLoggingConfigRequest, DeleteQueryLoggingConfigResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, DeleteQueryLoggingConfigCommand } from "../../client-route-53/mod.ts";
