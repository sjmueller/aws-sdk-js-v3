...
import { GetDNSSECRequest, GetDNSSECResponse } from "../models/models_0.ts";
import { deserializeAws_restXmlGetDNSSECCommand, serializeAws_restXmlGetDNSSECCommand } from "../protocols/Aws_restXml.ts";
 ...
 * ```javascript
 * import { Route53Client, GetDNSSECCommand } from "../../client-route-53/mod.ts";
