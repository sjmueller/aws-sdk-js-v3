...
import { ChangeResourceRecordSetsRequest, ChangeResourceRecordSetsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, ChangeResourceRecordSetsCommand } from "../../client-route-53/mod.ts";
