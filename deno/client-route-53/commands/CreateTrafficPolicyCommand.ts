...
import { CreateTrafficPolicyRequest, CreateTrafficPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, CreateTrafficPolicyCommand } from "../../client-route-53/mod.ts";
