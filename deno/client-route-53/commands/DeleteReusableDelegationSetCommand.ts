...
import { DeleteReusableDelegationSetRequest, DeleteReusableDelegationSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53Client, DeleteReusableDelegationSetCommand } from "../../client-route-53/mod.ts";
