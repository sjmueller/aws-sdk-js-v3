...
import { DeletePresetRequest, DeletePresetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticTranscoderClient, DeletePresetCommand } from "../../client-elastic-transcoder/mod.ts";
