...
import { UpdatePipelineRequest, UpdatePipelineResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticTranscoderClient, UpdatePipelineCommand } from "../../client-elastic-transcoder/mod.ts";
