...
import { GetOutpostCommandInput, GetOutpostCommandOutput } from "../commands/GetOutpostCommand.ts";
import {
  GetOutpostInstanceTypesCommandInput,
  GetOutpostInstanceTypesCommandOutput,
} from "../commands/GetOutpostInstanceTypesCommand.ts";
import { ListOutpostsCommandInput, ListOutpostsCommandOutput } from "../commands/ListOutpostsCommand.ts";
import { ListSitesCommandInput, ListSitesCommandOutput } from "../commands/ListSitesCommand.ts";
import {
...
const deserializeAws_restJson1InstanceTypeListDefinition = (
  ...
  return (output || []).map((entry: any) => deserializeAws_restJson1InstanceTypeItem(entry, context));
};
...
const deserializeAws_restJson1outpostListDefinition = (output: any, context: __SerdeContext): Outpost[] => {
  return (output || []).map((entry: any) => deserializeAws_restJson1Outpost(entry, context));
};
