...
import { CreateWebLoginTokenRequest, CreateWebLoginTokenResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MWAAClient, CreateWebLoginTokenCommand } from "../../client-mwaa/mod.ts";
