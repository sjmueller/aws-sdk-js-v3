...
import { UpdateClusterVersionRequest, UpdateClusterVersionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EKSClient, UpdateClusterVersionCommand } from "../../client-eks/mod.ts";
