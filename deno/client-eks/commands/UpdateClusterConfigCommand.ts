...
import { UpdateClusterConfigRequest, UpdateClusterConfigResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EKSClient, UpdateClusterConfigCommand } from "../../client-eks/mod.ts";
