...
import { ListIdentityProviderConfigsRequest, ListIdentityProviderConfigsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EKSClient, ListIdentityProviderConfigsCommand } from "../../client-eks/mod.ts";
