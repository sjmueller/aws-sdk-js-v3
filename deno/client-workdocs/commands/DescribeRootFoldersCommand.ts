...
import { DescribeRootFoldersRequest, DescribeRootFoldersResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkDocsClient, DescribeRootFoldersCommand } from "../../client-workdocs/mod.ts";
