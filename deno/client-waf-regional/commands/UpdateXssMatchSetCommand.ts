...
import { UpdateXssMatchSetRequest, UpdateXssMatchSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WAFRegionalClient, UpdateXssMatchSetCommand } from "../../client-waf-regional/mod.ts";
