...
import { CreateRegexMatchSetRequest, CreateRegexMatchSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WAFRegionalClient, CreateRegexMatchSetCommand } from "../../client-waf-regional/mod.ts";
