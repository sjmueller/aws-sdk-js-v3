...
import { DeleteGeoMatchSetRequest, DeleteGeoMatchSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WAFRegionalClient, DeleteGeoMatchSetCommand } from "../../client-waf-regional/mod.ts";
