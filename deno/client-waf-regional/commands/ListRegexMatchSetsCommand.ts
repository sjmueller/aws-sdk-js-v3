...
import { ListRegexMatchSetsRequest, ListRegexMatchSetsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WAFRegionalClient, ListRegexMatchSetsCommand } from "../../client-waf-regional/mod.ts";
