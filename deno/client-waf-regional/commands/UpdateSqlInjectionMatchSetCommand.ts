...
import { UpdateSqlInjectionMatchSetRequest, UpdateSqlInjectionMatchSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WAFRegionalClient, UpdateSqlInjectionMatchSetCommand } from "../../client-waf-regional/mod.ts";
