...
import { DescribeOriginEndpointRequest, DescribeOriginEndpointResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaPackageClient, DescribeOriginEndpointCommand } from "../../client-mediapackage/mod.ts";
