...
import { CreateStudioComponentRequest, CreateStudioComponentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NimbleClient, CreateStudioComponentCommand } from "../../client-nimble/mod.ts";
