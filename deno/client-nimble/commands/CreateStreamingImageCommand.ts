...
import { CreateStreamingImageRequest, CreateStreamingImageResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NimbleClient, CreateStreamingImageCommand } from "../../client-nimble/mod.ts";
