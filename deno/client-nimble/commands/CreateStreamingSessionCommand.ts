...
import { CreateStreamingSessionRequest, CreateStreamingSessionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NimbleClient, CreateStreamingSessionCommand } from "../../client-nimble/mod.ts";
