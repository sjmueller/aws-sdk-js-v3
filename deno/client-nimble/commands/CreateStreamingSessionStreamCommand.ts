...
import { CreateStreamingSessionStreamRequest, CreateStreamingSessionStreamResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NimbleClient, CreateStreamingSessionStreamCommand } from "../../client-nimble/mod.ts";
