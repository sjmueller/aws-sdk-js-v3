...
import { UpdateLaunchProfileMemberRequest, UpdateLaunchProfileMemberResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NimbleClient, UpdateLaunchProfileMemberCommand } from "../../client-nimble/mod.ts";
