...
import { GetStreamingSessionRequest, GetStreamingSessionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NimbleClient, GetStreamingSessionCommand } from "../../client-nimble/mod.ts";
