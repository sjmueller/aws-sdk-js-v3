...
import { CreateLaunchProfileRequest, CreateLaunchProfileResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NimbleClient, CreateLaunchProfileCommand } from "../../client-nimble/mod.ts";
