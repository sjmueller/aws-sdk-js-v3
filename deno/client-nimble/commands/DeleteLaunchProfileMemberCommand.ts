...
import { DeleteLaunchProfileMemberRequest, DeleteLaunchProfileMemberResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NimbleClient, DeleteLaunchProfileMemberCommand } from "../../client-nimble/mod.ts";
