...
import { GetDocumentTextDetectionRequest, GetDocumentTextDetectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TextractClient, GetDocumentTextDetectionCommand } from "../../client-textract/mod.ts";
