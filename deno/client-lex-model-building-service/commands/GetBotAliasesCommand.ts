...
import { GetBotAliasesRequest, GetBotAliasesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelBuildingServiceClient, GetBotAliasesCommand } from "../../client-lex-model-building-service/mod.ts";
