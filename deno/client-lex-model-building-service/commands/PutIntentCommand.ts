...
import { PutIntentRequest, PutIntentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelBuildingServiceClient, PutIntentCommand } from "../../client-lex-model-building-service/mod.ts";
