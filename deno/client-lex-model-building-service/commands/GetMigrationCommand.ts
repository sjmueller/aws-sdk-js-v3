...
import { GetMigrationRequest, GetMigrationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelBuildingServiceClient, GetMigrationCommand } from "../../client-lex-model-building-service/mod.ts";
