...
import { GetBotAliasRequest, GetBotAliasResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelBuildingServiceClient, GetBotAliasCommand } from "../../client-lex-model-building-service/mod.ts";
