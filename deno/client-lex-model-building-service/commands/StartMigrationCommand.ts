...
import { StartMigrationRequest, StartMigrationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelBuildingServiceClient, StartMigrationCommand } from "../../client-lex-model-building-service/mod.ts";
