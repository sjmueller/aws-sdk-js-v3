...
import { DisassociateConnectionAliasRequest, DisassociateConnectionAliasResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkSpacesClient, DisassociateConnectionAliasCommand } from "../../client-workspaces/mod.ts";
