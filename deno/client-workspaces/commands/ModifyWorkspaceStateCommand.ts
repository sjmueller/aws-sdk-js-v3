...
import { ModifyWorkspaceStateRequest, ModifyWorkspaceStateResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkSpacesClient, ModifyWorkspaceStateCommand } from "../../client-workspaces/mod.ts";
