...
export type DescribeWorkspaceSnapshotsCommandOutput = DescribeWorkspaceSnapshotsResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeWorkspaceSnapshotsCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeWorkspaceSnapshotsCommand(
      output,
      context
    );
  }
