...
import { CreateConnectionAliasRequest, CreateConnectionAliasResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkSpacesClient, CreateConnectionAliasCommand } from "../../client-workspaces/mod.ts";
