...
import { ModifyWorkspacePropertiesRequest, ModifyWorkspacePropertiesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkSpacesClient, ModifyWorkspacePropertiesCommand } from "../../client-workspaces/mod.ts";
