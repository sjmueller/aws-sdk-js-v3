...
import { DeleteConnectionAliasRequest, DeleteConnectionAliasResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkSpacesClient, DeleteConnectionAliasCommand } from "../../client-workspaces/mod.ts";
