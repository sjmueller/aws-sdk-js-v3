...
} from "./commands/CreateCanaryCommand.ts";
import {
  DeleteCanaryCommand,
  DeleteCanaryCommandInput,
  DeleteCanaryCommandOutput,
} from "./commands/DeleteCanaryCommand.ts";
import {
...
import { GetCanaryCommand, GetCanaryCommandInput, GetCanaryCommandOutput } from "./commands/GetCanaryCommand.ts";
import {
  GetCanaryRunsCommand,
  GetCanaryRunsCommandInput,
  GetCanaryRunsCommandOutput,
} from "./commands/GetCanaryRunsCommand.ts";
import {
...
} from "./commands/UpdateCanaryCommand.ts";
