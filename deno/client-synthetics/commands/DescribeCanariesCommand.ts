...
import { DescribeCanariesRequest, DescribeCanariesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SyntheticsClient, DescribeCanariesCommand } from "../../client-synthetics/mod.ts";
