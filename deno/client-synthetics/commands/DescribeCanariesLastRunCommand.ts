...
import { DescribeCanariesLastRunRequest, DescribeCanariesLastRunResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SyntheticsClient, DescribeCanariesLastRunCommand } from "../../client-synthetics/mod.ts";
