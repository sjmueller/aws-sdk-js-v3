...
import { UpdateFirewallPolicyRequest, UpdateFirewallPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NetworkFirewallClient, UpdateFirewallPolicyCommand } from "../../client-network-firewall/mod.ts";
