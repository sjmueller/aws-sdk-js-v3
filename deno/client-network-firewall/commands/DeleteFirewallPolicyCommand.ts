...
import { DeleteFirewallPolicyRequest, DeleteFirewallPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NetworkFirewallClient, DeleteFirewallPolicyCommand } from "../../client-network-firewall/mod.ts";
