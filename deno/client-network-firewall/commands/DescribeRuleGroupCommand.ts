...
import { DescribeRuleGroupRequest, DescribeRuleGroupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NetworkFirewallClient, DescribeRuleGroupCommand } from "../../client-network-firewall/mod.ts";
