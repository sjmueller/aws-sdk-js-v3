...
import { AssociateSubnetsRequest, AssociateSubnetsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NetworkFirewallClient, AssociateSubnetsCommand } from "../../client-network-firewall/mod.ts";
