...
import { CreateFileSystemFromBackupRequest, CreateFileSystemFromBackupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FSxClient, CreateFileSystemFromBackupCommand } from "../../client-fsx/mod.ts";
