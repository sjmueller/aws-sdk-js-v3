...
import { DescribeDimensionKeysRequest, DescribeDimensionKeysResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PIClient, DescribeDimensionKeysCommand } from "../../client-pi/mod.ts";
