...
import { RollbackApplicationRequest, RollbackApplicationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KinesisAnalyticsV2Client, RollbackApplicationCommand } from "../../client-kinesis-analytics-v2/mod.ts";
