...
import { DeleteExperimentRequest, DeleteExperimentResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, DeleteExperimentCommand } from "../../client-sagemaker/mod.ts";
