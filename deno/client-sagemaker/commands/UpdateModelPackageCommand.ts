...
import { UpdateModelPackageInput, UpdateModelPackageOutput } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, UpdateModelPackageCommand } from "../../client-sagemaker/mod.ts";
