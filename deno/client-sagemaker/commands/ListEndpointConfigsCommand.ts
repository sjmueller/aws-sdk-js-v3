...
import { ListEndpointConfigsInput, ListEndpointConfigsOutput } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, ListEndpointConfigsCommand } from "../../client-sagemaker/mod.ts";
