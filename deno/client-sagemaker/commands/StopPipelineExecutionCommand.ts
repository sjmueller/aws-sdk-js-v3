...
import { StopPipelineExecutionRequest, StopPipelineExecutionResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, StopPipelineExecutionCommand } from "../../client-sagemaker/mod.ts";
