...
import { CreateModelPackageInput, CreateModelPackageOutput } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, CreateModelPackageCommand } from "../../client-sagemaker/mod.ts";
