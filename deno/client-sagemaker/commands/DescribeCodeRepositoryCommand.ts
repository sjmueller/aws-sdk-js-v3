...
import { DescribeCodeRepositoryInput, DescribeCodeRepositoryOutput } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, DescribeCodeRepositoryCommand } from "../../client-sagemaker/mod.ts";
