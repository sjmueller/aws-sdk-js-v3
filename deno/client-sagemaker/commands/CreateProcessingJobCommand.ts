...
import { CreateProcessingJobRequest, CreateProcessingJobResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, CreateProcessingJobCommand } from "../../client-sagemaker/mod.ts";
