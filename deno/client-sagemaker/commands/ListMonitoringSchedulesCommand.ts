...
import { ListMonitoringSchedulesRequest, ListMonitoringSchedulesResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, ListMonitoringSchedulesCommand } from "../../client-sagemaker/mod.ts";
