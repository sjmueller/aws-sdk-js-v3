...
import { CreateAppImageConfigRequest, CreateAppImageConfigResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, CreateAppImageConfigCommand } from "../../client-sagemaker/mod.ts";
