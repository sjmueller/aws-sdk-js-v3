...
import { DescribeWorkteamRequest } from "../models/models_1.ts";
import { DescribeWorkteamResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, DescribeWorkteamCommand } from "../../client-sagemaker/mod.ts";
