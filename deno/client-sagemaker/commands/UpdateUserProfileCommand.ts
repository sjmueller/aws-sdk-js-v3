...
import { UpdateUserProfileRequest, UpdateUserProfileResponse } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, UpdateUserProfileCommand } from "../../client-sagemaker/mod.ts";
