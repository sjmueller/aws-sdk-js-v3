...
import { DeleteModelPackageGroupPolicyInput } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, DeleteModelPackageGroupPolicyCommand } from "../../client-sagemaker/mod.ts";
