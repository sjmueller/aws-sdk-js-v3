...
import { DescribeAlgorithmInput, DescribeAlgorithmOutput } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, DescribeAlgorithmCommand } from "../../client-sagemaker/mod.ts";
