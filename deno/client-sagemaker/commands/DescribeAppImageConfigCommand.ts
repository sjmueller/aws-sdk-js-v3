...
import { DescribeAppImageConfigRequest, DescribeAppImageConfigResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, DescribeAppImageConfigCommand } from "../../client-sagemaker/mod.ts";
