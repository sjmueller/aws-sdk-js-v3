...
import { ListCodeRepositoriesInput, ListCodeRepositoriesOutput } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, ListCodeRepositoriesCommand } from "../../client-sagemaker/mod.ts";
