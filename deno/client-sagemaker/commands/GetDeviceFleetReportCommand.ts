...
import { GetDeviceFleetReportRequest, GetDeviceFleetReportResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, GetDeviceFleetReportCommand } from "../../client-sagemaker/mod.ts";
