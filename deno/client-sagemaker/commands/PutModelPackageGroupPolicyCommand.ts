...
import { PutModelPackageGroupPolicyInput, PutModelPackageGroupPolicyOutput } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, PutModelPackageGroupPolicyCommand } from "../../client-sagemaker/mod.ts";
