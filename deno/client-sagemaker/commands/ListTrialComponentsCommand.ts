...
import { ListTrialComponentsRequest, ListTrialComponentsResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, ListTrialComponentsCommand } from "../../client-sagemaker/mod.ts";
