...
import { StopHyperParameterTuningJobRequest } from "../models/index.ts";
import {
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1StopHyperParameterTuningJobCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1StopHyperParameterTuningJobCommand(
      output,
      context
    );
  }
