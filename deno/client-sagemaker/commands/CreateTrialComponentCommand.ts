...
import { CreateTrialComponentRequest, CreateTrialComponentResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, CreateTrialComponentCommand } from "../../client-sagemaker/mod.ts";
