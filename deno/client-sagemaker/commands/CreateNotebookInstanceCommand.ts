...
import { CreateNotebookInstanceInput, CreateNotebookInstanceOutput } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, CreateNotebookInstanceCommand } from "../../client-sagemaker/mod.ts";
