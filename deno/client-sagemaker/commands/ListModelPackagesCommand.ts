...
import { ListModelPackagesInput, ListModelPackagesOutput } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, ListModelPackagesCommand } from "../../client-sagemaker/mod.ts";
