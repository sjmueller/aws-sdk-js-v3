...
import { CreateCodeRepositoryInput, CreateCodeRepositoryOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, CreateCodeRepositoryCommand } from "../../client-sagemaker/mod.ts";
