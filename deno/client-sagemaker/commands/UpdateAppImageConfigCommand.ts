...
import { UpdateAppImageConfigRequest, UpdateAppImageConfigResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, UpdateAppImageConfigCommand } from "../../client-sagemaker/mod.ts";
