...
import { ListAssociationsRequest, ListAssociationsResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, ListAssociationsCommand } from "../../client-sagemaker/mod.ts";
