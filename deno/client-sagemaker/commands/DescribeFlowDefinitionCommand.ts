...
import { DescribeFlowDefinitionRequest, DescribeFlowDefinitionResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, DescribeFlowDefinitionCommand } from "../../client-sagemaker/mod.ts";
