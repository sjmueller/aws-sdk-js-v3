...
import { UpdateWorkforceRequest, UpdateWorkforceResponse } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, UpdateWorkforceCommand } from "../../client-sagemaker/mod.ts";
