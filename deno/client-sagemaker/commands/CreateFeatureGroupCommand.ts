...
import { CreateFeatureGroupRequest, CreateFeatureGroupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, CreateFeatureGroupCommand } from "../../client-sagemaker/mod.ts";
