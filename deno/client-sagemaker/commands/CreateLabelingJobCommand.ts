...
import { CreateLabelingJobRequest, CreateLabelingJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, CreateLabelingJobCommand } from "../../client-sagemaker/mod.ts";
