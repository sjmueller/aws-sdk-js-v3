...
import { UpdatePipelineExecutionRequest, UpdatePipelineExecutionResponse } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, UpdatePipelineExecutionCommand } from "../../client-sagemaker/mod.ts";
