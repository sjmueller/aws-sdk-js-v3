...
import { DescribeFHIRExportJobRequest, DescribeFHIRExportJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { HealthLakeClient, DescribeFHIRExportJobCommand } from "../../client-healthlake/mod.ts";
