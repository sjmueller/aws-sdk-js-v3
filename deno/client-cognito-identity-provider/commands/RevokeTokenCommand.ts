...
import { RevokeTokenRequest, RevokeTokenResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityProviderClient, RevokeTokenCommand } from "../../client-cognito-identity-provider/mod.ts";
