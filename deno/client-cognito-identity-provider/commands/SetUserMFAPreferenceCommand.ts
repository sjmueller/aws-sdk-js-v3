...
import { SetUserMFAPreferenceRequest, SetUserMFAPreferenceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityProviderClient, SetUserMFAPreferenceCommand } from "../../client-cognito-identity-provider/mod.ts";
