...
import { AdminCreateUserRequest, AdminCreateUserResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityProviderClient, AdminCreateUserCommand } from "../../client-cognito-identity-provider/mod.ts";
