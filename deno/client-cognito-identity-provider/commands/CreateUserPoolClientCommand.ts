...
import { CreateUserPoolClientRequest, CreateUserPoolClientResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityProviderClient, CreateUserPoolClientCommand } from "../../client-cognito-identity-provider/mod.ts";
