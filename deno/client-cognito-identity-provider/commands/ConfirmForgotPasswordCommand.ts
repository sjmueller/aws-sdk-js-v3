...
import { ConfirmForgotPasswordRequest, ConfirmForgotPasswordResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityProviderClient, ConfirmForgotPasswordCommand } from "../../client-cognito-identity-provider/mod.ts";
