...
import { DeleteUserPoolRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityProviderClient, DeleteUserPoolCommand } from "../../client-cognito-identity-provider/mod.ts";
