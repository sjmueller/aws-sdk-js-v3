...
import { DeleteGitHubAccountTokenInput, DeleteGitHubAccountTokenOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeDeployClient, DeleteGitHubAccountTokenCommand } from "../../client-codedeploy/mod.ts";
