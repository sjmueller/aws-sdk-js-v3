...
import { GetDeploymentTargetInput, GetDeploymentTargetOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeDeployClient, GetDeploymentTargetCommand } from "../../client-codedeploy/mod.ts";
