...
import { RegisterApplicationRevisionInput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeDeployClient, RegisterApplicationRevisionCommand } from "../../client-codedeploy/mod.ts";
