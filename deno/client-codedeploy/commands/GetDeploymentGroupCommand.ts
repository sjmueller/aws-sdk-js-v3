...
import { GetDeploymentGroupInput, GetDeploymentGroupOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeDeployClient, GetDeploymentGroupCommand } from "../../client-codedeploy/mod.ts";
