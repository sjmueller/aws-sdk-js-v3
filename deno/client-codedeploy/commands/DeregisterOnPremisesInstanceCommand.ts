...
import { DeregisterOnPremisesInstanceInput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeDeployClient, DeregisterOnPremisesInstanceCommand } from "../../client-codedeploy/mod.ts";
