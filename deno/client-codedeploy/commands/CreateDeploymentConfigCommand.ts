...
import { CreateDeploymentConfigInput, CreateDeploymentConfigOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeDeployClient, CreateDeploymentConfigCommand } from "../../client-codedeploy/mod.ts";
