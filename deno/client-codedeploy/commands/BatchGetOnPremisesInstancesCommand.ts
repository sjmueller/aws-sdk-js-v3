...
import { BatchGetOnPremisesInstancesInput, BatchGetOnPremisesInstancesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeDeployClient, BatchGetOnPremisesInstancesCommand } from "../../client-codedeploy/mod.ts";
