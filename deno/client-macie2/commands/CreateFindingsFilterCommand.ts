...
import { CreateFindingsFilterRequest, CreateFindingsFilterResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Macie2Client, CreateFindingsFilterCommand } from "../../client-macie2/mod.ts";
