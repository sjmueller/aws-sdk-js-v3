...
import { BatchGetCustomDataIdentifiersRequest, BatchGetCustomDataIdentifiersResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Macie2Client, BatchGetCustomDataIdentifiersCommand } from "../../client-macie2/mod.ts";
