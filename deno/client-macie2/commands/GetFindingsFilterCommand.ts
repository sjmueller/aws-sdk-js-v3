...
import { GetFindingsFilterRequest, GetFindingsFilterResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Macie2Client, GetFindingsFilterCommand } from "../../client-macie2/mod.ts";
