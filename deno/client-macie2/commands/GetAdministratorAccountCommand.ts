...
import { GetAdministratorAccountRequest, GetAdministratorAccountResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Macie2Client, GetAdministratorAccountCommand } from "../../client-macie2/mod.ts";
