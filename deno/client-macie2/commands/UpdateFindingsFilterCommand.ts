...
import { UpdateFindingsFilterRequest, UpdateFindingsFilterResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Macie2Client, UpdateFindingsFilterCommand } from "../../client-macie2/mod.ts";
