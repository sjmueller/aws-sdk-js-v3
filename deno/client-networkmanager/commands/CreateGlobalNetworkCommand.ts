...
import { CreateGlobalNetworkRequest, CreateGlobalNetworkResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NetworkManagerClient, CreateGlobalNetworkCommand } from "../../client-networkmanager/mod.ts";
