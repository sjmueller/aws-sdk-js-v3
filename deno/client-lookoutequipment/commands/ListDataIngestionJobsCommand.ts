...
import { ListDataIngestionJobsRequest, ListDataIngestionJobsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LookoutEquipmentClient, ListDataIngestionJobsCommand } from "../../client-lookoutequipment/mod.ts";
