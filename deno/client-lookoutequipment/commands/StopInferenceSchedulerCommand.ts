...
import { StopInferenceSchedulerRequest, StopInferenceSchedulerResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LookoutEquipmentClient, StopInferenceSchedulerCommand } from "../../client-lookoutequipment/mod.ts";
