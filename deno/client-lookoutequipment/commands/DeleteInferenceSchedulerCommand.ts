...
import { DeleteInferenceSchedulerRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LookoutEquipmentClient, DeleteInferenceSchedulerCommand } from "../../client-lookoutequipment/mod.ts";
