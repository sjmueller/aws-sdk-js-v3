...
import { CreateExperimentTemplateRequest, CreateExperimentTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FisClient, CreateExperimentTemplateCommand } from "../../client-fis/mod.ts";
