...
import { GetExperimentTemplateRequest, GetExperimentTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FisClient, GetExperimentTemplateCommand } from "../../client-fis/mod.ts";
