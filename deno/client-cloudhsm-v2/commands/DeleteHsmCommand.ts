...
import { DeleteHsmRequest, DeleteHsmResponse } from "../models/models_0.ts";
import { deserializeAws_json1_1DeleteHsmCommand, serializeAws_json1_1DeleteHsmCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { CloudHSMV2Client, DeleteHsmCommand } from "../../client-cloudhsm-v2/mod.ts";
