...
import { DescribeScheduledActionsRequest, DescribeScheduledActionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApplicationAutoScalingClient, DescribeScheduledActionsCommand } from "../../client-application-auto-scaling/mod.ts";
