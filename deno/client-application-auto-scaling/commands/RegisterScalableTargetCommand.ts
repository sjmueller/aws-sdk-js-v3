...
import { RegisterScalableTargetRequest, RegisterScalableTargetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApplicationAutoScalingClient, RegisterScalableTargetCommand } from "../../client-application-auto-scaling/mod.ts";
