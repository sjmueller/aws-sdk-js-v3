...
import { UpdateInputDeviceRequest, UpdateInputDeviceResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { MediaLiveClient, UpdateInputDeviceCommand } from "../../client-medialive/mod.ts";
