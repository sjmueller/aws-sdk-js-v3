...
import { RejectInputDeviceTransferRequest, RejectInputDeviceTransferResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { MediaLiveClient, RejectInputDeviceTransferCommand } from "../../client-medialive/mod.ts";
