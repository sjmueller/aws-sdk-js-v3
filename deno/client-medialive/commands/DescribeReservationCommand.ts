...
import { DescribeReservationRequest, DescribeReservationResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { MediaLiveClient, DescribeReservationCommand } from "../../client-medialive/mod.ts";
