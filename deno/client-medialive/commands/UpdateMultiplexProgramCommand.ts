...
import { UpdateMultiplexProgramRequest, UpdateMultiplexProgramResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { MediaLiveClient, UpdateMultiplexProgramCommand } from "../../client-medialive/mod.ts";
