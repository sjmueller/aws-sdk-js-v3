...
import { ListInputSecurityGroupsRequest, ListInputSecurityGroupsResponse } from "../models/models_1.ts";
import {
...
export type ListInputSecurityGroupsCommandOutput = ListInputSecurityGroupsResponse & __MetadataBearer;
