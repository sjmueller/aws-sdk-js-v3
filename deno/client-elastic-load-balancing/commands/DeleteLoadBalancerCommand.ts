...
import { DeleteAccessPointInput, DeleteAccessPointOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticLoadBalancingClient, DeleteLoadBalancerCommand } from "../../client-elastic-load-balancing/mod.ts";
