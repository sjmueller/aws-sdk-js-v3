...
import { CreateAccessPointInput, CreateAccessPointOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticLoadBalancingClient, CreateLoadBalancerCommand } from "../../client-elastic-load-balancing/mod.ts";
