...
import { UpdateRoutingProfileDefaultOutboundQueueRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, UpdateRoutingProfileDefaultOutboundQueueCommand } from "../../client-connect/mod.ts";
