...
import { StartOutboundVoiceContactRequest, StartOutboundVoiceContactResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, StartOutboundVoiceContactCommand } from "../../client-connect/mod.ts";
