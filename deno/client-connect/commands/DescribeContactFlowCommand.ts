...
import { DescribeContactFlowRequest, DescribeContactFlowResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, DescribeContactFlowCommand } from "../../client-connect/mod.ts";
