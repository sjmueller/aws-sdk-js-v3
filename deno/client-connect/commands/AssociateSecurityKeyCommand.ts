...
import { AssociateSecurityKeyRequest, AssociateSecurityKeyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, AssociateSecurityKeyCommand } from "../../client-connect/mod.ts";
