...
import { CreateQuickConnectRequest, CreateQuickConnectResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, CreateQuickConnectCommand } from "../../client-connect/mod.ts";
