...
import { SuspendContactRecordingRequest, SuspendContactRecordingResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, SuspendContactRecordingCommand } from "../../client-connect/mod.ts";
