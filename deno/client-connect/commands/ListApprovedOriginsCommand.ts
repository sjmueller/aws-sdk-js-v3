...
import { ListApprovedOriginsRequest, ListApprovedOriginsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, ListApprovedOriginsCommand } from "../../client-connect/mod.ts";
