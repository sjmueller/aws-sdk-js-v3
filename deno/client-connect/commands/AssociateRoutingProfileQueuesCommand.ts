...
import { AssociateRoutingProfileQueuesRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, AssociateRoutingProfileQueuesCommand } from "../../client-connect/mod.ts";
