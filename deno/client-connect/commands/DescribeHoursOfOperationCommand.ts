...
import { DescribeHoursOfOperationRequest, DescribeHoursOfOperationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, DescribeHoursOfOperationCommand } from "../../client-connect/mod.ts";
