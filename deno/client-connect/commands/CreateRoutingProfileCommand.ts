...
import { CreateRoutingProfileRequest, CreateRoutingProfileResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectClient, CreateRoutingProfileCommand } from "../../client-connect/mod.ts";
