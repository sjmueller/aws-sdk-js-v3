...
import { RegisterEventTopicRequest, RegisterEventTopicResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, RegisterEventTopicCommand } from "../../client-directory-service/mod.ts";
