...
import { DescribeRegionsRequest, DescribeRegionsResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, DescribeRegionsCommand } from "../../client-directory-service/mod.ts";
