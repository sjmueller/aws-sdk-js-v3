...
import { DescribeTrustsRequest, DescribeTrustsResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, DescribeTrustsCommand } from "../../client-directory-service/mod.ts";
