...
import { CreateAliasRequest, CreateAliasResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, CreateAliasCommand } from "../../client-directory-service/mod.ts";
