...
import { CreateMicrosoftADRequest, CreateMicrosoftADResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, CreateMicrosoftADCommand } from "../../client-directory-service/mod.ts";
