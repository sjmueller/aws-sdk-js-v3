...
import { DescribeDirectoriesRequest, DescribeDirectoriesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, DescribeDirectoriesCommand } from "../../client-directory-service/mod.ts";
