...
import { RemoveIpRoutesRequest, RemoveIpRoutesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, RemoveIpRoutesCommand } from "../../client-directory-service/mod.ts";
