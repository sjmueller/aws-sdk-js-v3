...
import { RestoreFromSnapshotRequest, RestoreFromSnapshotResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, RestoreFromSnapshotCommand } from "../../client-directory-service/mod.ts";
