...
import { StartSchemaExtensionRequest, StartSchemaExtensionResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, StartSchemaExtensionCommand } from "../../client-directory-service/mod.ts";
