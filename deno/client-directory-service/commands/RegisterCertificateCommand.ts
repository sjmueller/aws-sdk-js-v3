...
import { RegisterCertificateRequest, RegisterCertificateResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectoryServiceClient, RegisterCertificateCommand } from "../../client-directory-service/mod.ts";
