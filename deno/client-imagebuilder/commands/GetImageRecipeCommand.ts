...
import { GetImageRecipeRequest, GetImageRecipeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ImagebuilderClient, GetImageRecipeCommand } from "../../client-imagebuilder/mod.ts";
