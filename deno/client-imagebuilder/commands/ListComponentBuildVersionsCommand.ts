...
import { ListComponentBuildVersionsRequest, ListComponentBuildVersionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ImagebuilderClient, ListComponentBuildVersionsCommand } from "../../client-imagebuilder/mod.ts";
