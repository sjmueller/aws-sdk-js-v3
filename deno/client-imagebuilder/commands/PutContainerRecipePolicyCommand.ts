...
import { PutContainerRecipePolicyRequest, PutContainerRecipePolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ImagebuilderClient, PutContainerRecipePolicyCommand } from "../../client-imagebuilder/mod.ts";
