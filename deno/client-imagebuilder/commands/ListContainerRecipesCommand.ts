...
import { ListContainerRecipesRequest, ListContainerRecipesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ImagebuilderClient, ListContainerRecipesCommand } from "../../client-imagebuilder/mod.ts";
