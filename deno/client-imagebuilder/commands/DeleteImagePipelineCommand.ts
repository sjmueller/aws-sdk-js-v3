...
import { DeleteImagePipelineRequest, DeleteImagePipelineResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ImagebuilderClient, DeleteImagePipelineCommand } from "../../client-imagebuilder/mod.ts";
