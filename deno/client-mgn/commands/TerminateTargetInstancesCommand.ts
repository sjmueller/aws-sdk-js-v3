...
import { TerminateTargetInstancesRequest, TerminateTargetInstancesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MgnClient, TerminateTargetInstancesCommand } from "../../client-mgn/mod.ts";
