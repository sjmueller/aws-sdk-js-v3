...
import { LaunchConfiguration, UpdateLaunchConfigurationRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MgnClient, UpdateLaunchConfigurationCommand } from "../../client-mgn/mod.ts";
