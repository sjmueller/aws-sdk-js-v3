...
import { ReplicationConfiguration, UpdateReplicationConfigurationRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MgnClient, UpdateReplicationConfigurationCommand } from "../../client-mgn/mod.ts";
