...
import { GetReplicationConfigurationRequest, ReplicationConfiguration } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MgnClient, GetReplicationConfigurationCommand } from "../../client-mgn/mod.ts";
