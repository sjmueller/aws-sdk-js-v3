...
import { ChangeServerLifeCycleStateRequest, SourceServer } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MgnClient, ChangeServerLifeCycleStateCommand } from "../../client-mgn/mod.ts";
