...
import { ListManagedEndpointsRequest, ListManagedEndpointsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EMRContainersClient, ListManagedEndpointsCommand } from "../../client-emr-containers/mod.ts";
