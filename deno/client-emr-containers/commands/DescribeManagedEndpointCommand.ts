...
import { DescribeManagedEndpointRequest, DescribeManagedEndpointResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EMRContainersClient, DescribeManagedEndpointCommand } from "../../client-emr-containers/mod.ts";
