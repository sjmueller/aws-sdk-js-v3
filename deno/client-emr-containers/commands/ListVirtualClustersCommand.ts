...
import { ListVirtualClustersRequest, ListVirtualClustersResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EMRContainersClient, ListVirtualClustersCommand } from "../../client-emr-containers/mod.ts";
