...
import { CreateManagedEndpointRequest, CreateManagedEndpointResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EMRContainersClient, CreateManagedEndpointCommand } from "../../client-emr-containers/mod.ts";
