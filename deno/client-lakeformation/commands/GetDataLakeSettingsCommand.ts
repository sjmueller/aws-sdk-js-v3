...
import { GetDataLakeSettingsRequest, GetDataLakeSettingsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LakeFormationClient, GetDataLakeSettingsCommand } from "../../client-lakeformation/mod.ts";
