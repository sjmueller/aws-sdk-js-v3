...
import { GetLFTagRequest, GetLFTagResponse } from "../models/models_0.ts";
import { deserializeAws_json1_1GetLFTagCommand, serializeAws_json1_1GetLFTagCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { LakeFormationClient, GetLFTagCommand } from "../../client-lakeformation/mod.ts";
