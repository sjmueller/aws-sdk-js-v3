...
import { SearchDatabasesByLFTagsRequest, SearchDatabasesByLFTagsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LakeFormationClient, SearchDatabasesByLFTagsCommand } from "../../client-lakeformation/mod.ts";
