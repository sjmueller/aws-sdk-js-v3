...
import { BatchRevokePermissionsRequest, BatchRevokePermissionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LakeFormationClient, BatchRevokePermissionsCommand } from "../../client-lakeformation/mod.ts";
