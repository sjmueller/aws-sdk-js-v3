...
import { SearchTablesByLFTagsRequest, SearchTablesByLFTagsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LakeFormationClient, SearchTablesByLFTagsCommand } from "../../client-lakeformation/mod.ts";
