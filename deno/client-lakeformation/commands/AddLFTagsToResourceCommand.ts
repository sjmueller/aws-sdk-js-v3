...
import { AddLFTagsToResourceRequest, AddLFTagsToResourceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LakeFormationClient, AddLFTagsToResourceCommand } from "../../client-lakeformation/mod.ts";
