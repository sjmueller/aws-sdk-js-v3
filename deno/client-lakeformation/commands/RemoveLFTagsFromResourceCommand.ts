...
import { RemoveLFTagsFromResourceRequest, RemoveLFTagsFromResourceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LakeFormationClient, RemoveLFTagsFromResourceCommand } from "../../client-lakeformation/mod.ts";
