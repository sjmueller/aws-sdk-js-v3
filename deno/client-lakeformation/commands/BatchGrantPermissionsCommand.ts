...
import { BatchGrantPermissionsRequest, BatchGrantPermissionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LakeFormationClient, BatchGrantPermissionsCommand } from "../../client-lakeformation/mod.ts";
