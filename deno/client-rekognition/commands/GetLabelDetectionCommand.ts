...
import { GetLabelDetectionRequest, GetLabelDetectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, GetLabelDetectionCommand } from "../../client-rekognition/mod.ts";
