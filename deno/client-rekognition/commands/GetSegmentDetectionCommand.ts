...
import { GetSegmentDetectionRequest, GetSegmentDetectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, GetSegmentDetectionCommand } from "../../client-rekognition/mod.ts";
