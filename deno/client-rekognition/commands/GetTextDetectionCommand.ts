...
import { GetTextDetectionRequest, GetTextDetectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, GetTextDetectionCommand } from "../../client-rekognition/mod.ts";
