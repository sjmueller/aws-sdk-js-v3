...
import { CreateStreamProcessorRequest, CreateStreamProcessorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, CreateStreamProcessorCommand } from "../../client-rekognition/mod.ts";
