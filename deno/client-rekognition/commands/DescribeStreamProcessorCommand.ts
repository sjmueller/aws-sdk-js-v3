...
import { DescribeStreamProcessorRequest, DescribeStreamProcessorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, DescribeStreamProcessorCommand } from "../../client-rekognition/mod.ts";
