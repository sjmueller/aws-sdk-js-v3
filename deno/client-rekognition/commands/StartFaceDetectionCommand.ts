...
import { StartFaceDetectionRequest, StartFaceDetectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, StartFaceDetectionCommand } from "../../client-rekognition/mod.ts";
