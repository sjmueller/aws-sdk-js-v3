...
import { SearchFacesByImageRequest, SearchFacesByImageResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, SearchFacesByImageCommand } from "../../client-rekognition/mod.ts";
