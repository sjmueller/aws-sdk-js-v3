...
import { DetectProtectiveEquipmentRequest, DetectProtectiveEquipmentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, DetectProtectiveEquipmentCommand } from "../../client-rekognition/mod.ts";
