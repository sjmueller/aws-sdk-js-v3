...
import { StopStreamProcessorRequest, StopStreamProcessorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, StopStreamProcessorCommand } from "../../client-rekognition/mod.ts";
