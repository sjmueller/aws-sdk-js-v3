...
import { StartPersonTrackingRequest, StartPersonTrackingResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, StartPersonTrackingCommand } from "../../client-rekognition/mod.ts";
