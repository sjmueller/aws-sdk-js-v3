...
import { StartContentModerationRequest, StartContentModerationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, StartContentModerationCommand } from "../../client-rekognition/mod.ts";
