...
import { StartSegmentDetectionRequest, StartSegmentDetectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, StartSegmentDetectionCommand } from "../../client-rekognition/mod.ts";
