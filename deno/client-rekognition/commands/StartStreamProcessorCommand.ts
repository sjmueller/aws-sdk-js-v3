...
import { StartStreamProcessorRequest, StartStreamProcessorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RekognitionClient, StartStreamProcessorCommand } from "../../client-rekognition/mod.ts";
