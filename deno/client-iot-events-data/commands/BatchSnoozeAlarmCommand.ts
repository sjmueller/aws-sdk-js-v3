...
import { BatchSnoozeAlarmRequest, BatchSnoozeAlarmResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTEventsDataClient, BatchSnoozeAlarmCommand } from "../../client-iot-events-data/mod.ts";
