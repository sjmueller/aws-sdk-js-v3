...
import { BatchDisableAlarmRequest, BatchDisableAlarmResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTEventsDataClient, BatchDisableAlarmCommand } from "../../client-iot-events-data/mod.ts";
