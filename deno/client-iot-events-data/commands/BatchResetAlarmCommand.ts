...
import { BatchResetAlarmRequest, BatchResetAlarmResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTEventsDataClient, BatchResetAlarmCommand } from "../../client-iot-events-data/mod.ts";
