...
import { GetChangeTokenStatusRequest, GetChangeTokenStatusResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WAFClient, GetChangeTokenStatusCommand } from "../../client-waf/mod.ts";
