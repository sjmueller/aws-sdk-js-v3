...
import { GetVaultAccessPolicyInput, GetVaultAccessPolicyOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlacierClient, GetVaultAccessPolicyCommand } from "../../client-glacier/mod.ts";
