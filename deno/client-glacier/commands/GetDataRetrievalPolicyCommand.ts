...
import { GetDataRetrievalPolicyInput, GetDataRetrievalPolicyOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlacierClient, GetDataRetrievalPolicyCommand } from "../../client-glacier/mod.ts";
