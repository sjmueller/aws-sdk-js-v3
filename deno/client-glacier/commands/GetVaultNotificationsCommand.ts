...
import { GetVaultNotificationsInput, GetVaultNotificationsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlacierClient, GetVaultNotificationsCommand } from "../../client-glacier/mod.ts";
