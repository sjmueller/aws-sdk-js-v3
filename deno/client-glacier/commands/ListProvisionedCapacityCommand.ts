...
import { ListProvisionedCapacityInput, ListProvisionedCapacityOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlacierClient, ListProvisionedCapacityCommand } from "../../client-glacier/mod.ts";
