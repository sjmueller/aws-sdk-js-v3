...
import { RegisterJobDefinitionRequest, RegisterJobDefinitionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BatchClient, RegisterJobDefinitionCommand } from "../../client-batch/mod.ts";
