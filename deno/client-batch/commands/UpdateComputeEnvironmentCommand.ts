...
import { UpdateComputeEnvironmentRequest, UpdateComputeEnvironmentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BatchClient, UpdateComputeEnvironmentCommand } from "../../client-batch/mod.ts";
