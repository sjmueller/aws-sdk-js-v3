...
import { DeregisterJobDefinitionRequest, DeregisterJobDefinitionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BatchClient, DeregisterJobDefinitionCommand } from "../../client-batch/mod.ts";
