...
import { DescribeScheduleRequest, DescribeScheduleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DataBrewClient, DescribeScheduleCommand } from "../../client-databrew/mod.ts";
