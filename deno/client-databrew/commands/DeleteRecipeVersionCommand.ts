...
import { DeleteRecipeVersionRequest, DeleteRecipeVersionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DataBrewClient, DeleteRecipeVersionCommand } from "../../client-databrew/mod.ts";
