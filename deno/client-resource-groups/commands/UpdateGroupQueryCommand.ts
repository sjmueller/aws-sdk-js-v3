...
import { UpdateGroupQueryInput, UpdateGroupQueryOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ResourceGroupsClient, UpdateGroupQueryCommand } from "../../client-resource-groups/mod.ts";
