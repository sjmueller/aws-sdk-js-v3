...
import { UpdateTableRequest, UpdateTableResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TimestreamWriteClient, UpdateTableCommand } from "../../client-timestream-write/mod.ts";
