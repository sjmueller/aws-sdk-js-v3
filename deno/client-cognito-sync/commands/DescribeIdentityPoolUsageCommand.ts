...
import { DescribeIdentityPoolUsageRequest, DescribeIdentityPoolUsageResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoSyncClient, DescribeIdentityPoolUsageCommand } from "../../client-cognito-sync/mod.ts";
