...
export type GetIdentityPoolConfigurationCommandOutput = GetIdentityPoolConfigurationResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1GetIdentityPoolConfigurationCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1GetIdentityPoolConfigurationCommand(
      output,
      context
    );
  }
