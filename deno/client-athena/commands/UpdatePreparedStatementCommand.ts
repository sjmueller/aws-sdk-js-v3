...
import { UpdatePreparedStatementInput, UpdatePreparedStatementOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AthenaClient, UpdatePreparedStatementCommand } from "../../client-athena/mod.ts";
