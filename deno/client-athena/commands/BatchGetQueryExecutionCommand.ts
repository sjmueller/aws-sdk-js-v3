...
import { BatchGetQueryExecutionInput, BatchGetQueryExecutionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AthenaClient, BatchGetQueryExecutionCommand } from "../../client-athena/mod.ts";
