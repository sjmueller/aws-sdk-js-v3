...
import { GetCompatibleKafkaVersionsRequest, GetCompatibleKafkaVersionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KafkaClient, GetCompatibleKafkaVersionsCommand } from "../../client-kafka/mod.ts";
