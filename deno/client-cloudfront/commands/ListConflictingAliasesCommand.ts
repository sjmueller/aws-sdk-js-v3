...
import { ListConflictingAliasesRequest, ListConflictingAliasesResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, ListConflictingAliasesCommand } from "../../client-cloudfront/mod.ts";
