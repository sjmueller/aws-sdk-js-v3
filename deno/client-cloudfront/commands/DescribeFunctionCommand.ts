...
import { DescribeFunctionRequest, DescribeFunctionResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, DescribeFunctionCommand } from "../../client-cloudfront/mod.ts";
