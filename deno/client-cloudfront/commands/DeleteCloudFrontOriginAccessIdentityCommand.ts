...
import { DeleteCloudFrontOriginAccessIdentityRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, DeleteCloudFrontOriginAccessIdentityCommand } from "../../client-cloudfront/mod.ts";
