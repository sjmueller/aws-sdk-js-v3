...
import { GetFieldLevelEncryptionConfigRequest, GetFieldLevelEncryptionConfigResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, GetFieldLevelEncryptionConfigCommand } from "../../client-cloudfront/mod.ts";
