...
import { ListDistributionsByWebACLIdRequest, ListDistributionsByWebACLIdResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, ListDistributionsByWebACLIdCommand } from "../../client-cloudfront/mod.ts";
