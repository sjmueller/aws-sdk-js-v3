...
import { CreateStreamingDistributionRequest, CreateStreamingDistributionResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, CreateStreamingDistributionCommand } from "../../client-cloudfront/mod.ts";
