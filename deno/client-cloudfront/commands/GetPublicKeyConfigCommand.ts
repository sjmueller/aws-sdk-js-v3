...
import { GetPublicKeyConfigRequest, GetPublicKeyConfigResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, GetPublicKeyConfigCommand } from "../../client-cloudfront/mod.ts";
