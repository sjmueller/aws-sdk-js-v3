...
import { GetOriginRequestPolicyRequest, GetOriginRequestPolicyResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, GetOriginRequestPolicyCommand } from "../../client-cloudfront/mod.ts";
