...
import { UpdateOriginRequestPolicyRequest, UpdateOriginRequestPolicyResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, UpdateOriginRequestPolicyCommand } from "../../client-cloudfront/mod.ts";
