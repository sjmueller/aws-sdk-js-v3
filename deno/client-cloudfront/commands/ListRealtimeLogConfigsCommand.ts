...
import { ListRealtimeLogConfigsRequest, ListRealtimeLogConfigsResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, ListRealtimeLogConfigsCommand } from "../../client-cloudfront/mod.ts";
