...
import { DeleteFieldLevelEncryptionConfigRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, DeleteFieldLevelEncryptionConfigCommand } from "../../client-cloudfront/mod.ts";
