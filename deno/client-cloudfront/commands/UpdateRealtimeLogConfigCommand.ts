...
import { UpdateRealtimeLogConfigRequest, UpdateRealtimeLogConfigResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, UpdateRealtimeLogConfigCommand } from "../../client-cloudfront/mod.ts";
