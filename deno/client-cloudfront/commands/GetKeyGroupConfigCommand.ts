...
import { GetKeyGroupConfigRequest, GetKeyGroupConfigResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, GetKeyGroupConfigCommand } from "../../client-cloudfront/mod.ts";
