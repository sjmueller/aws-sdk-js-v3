...
import { GetOriginRequestPolicyConfigRequest, GetOriginRequestPolicyConfigResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, GetOriginRequestPolicyConfigCommand } from "../../client-cloudfront/mod.ts";
