...
import { UpdatePublicKeyRequest, UpdatePublicKeyResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, UpdatePublicKeyCommand } from "../../client-cloudfront/mod.ts";
