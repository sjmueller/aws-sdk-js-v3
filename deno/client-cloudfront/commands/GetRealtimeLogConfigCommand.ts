...
import { GetRealtimeLogConfigRequest, GetRealtimeLogConfigResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CloudFrontClient, GetRealtimeLogConfigCommand } from "../../client-cloudfront/mod.ts";
