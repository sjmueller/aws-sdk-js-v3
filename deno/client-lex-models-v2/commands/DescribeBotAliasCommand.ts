...
import { DescribeBotAliasRequest, DescribeBotAliasResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, DescribeBotAliasCommand } from "../../client-lex-models-v2/mod.ts";
