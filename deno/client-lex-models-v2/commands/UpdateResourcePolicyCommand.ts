...
import { UpdateResourcePolicyRequest, UpdateResourcePolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, UpdateResourcePolicyCommand } from "../../client-lex-models-v2/mod.ts";
