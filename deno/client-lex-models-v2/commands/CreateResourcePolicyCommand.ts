...
import { CreateResourcePolicyRequest, CreateResourcePolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, CreateResourcePolicyCommand } from "../../client-lex-models-v2/mod.ts";
