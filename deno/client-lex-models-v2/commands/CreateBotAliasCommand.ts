...
import { CreateBotAliasRequest, CreateBotAliasResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, CreateBotAliasCommand } from "../../client-lex-models-v2/mod.ts";
