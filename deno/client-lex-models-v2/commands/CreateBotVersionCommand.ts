...
import { CreateBotVersionRequest, CreateBotVersionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, CreateBotVersionCommand } from "../../client-lex-models-v2/mod.ts";
