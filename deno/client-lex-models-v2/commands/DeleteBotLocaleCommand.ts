...
import { DeleteBotLocaleRequest, DeleteBotLocaleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, DeleteBotLocaleCommand } from "../../client-lex-models-v2/mod.ts";
