...
import { ListBuiltInIntentsRequest, ListBuiltInIntentsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, ListBuiltInIntentsCommand } from "../../client-lex-models-v2/mod.ts";
