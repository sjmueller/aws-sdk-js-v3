...
import { DescribeSlotTypeRequest, DescribeSlotTypeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, DescribeSlotTypeCommand } from "../../client-lex-models-v2/mod.ts";
