...
import { CreateUploadUrlRequest, CreateUploadUrlResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, CreateUploadUrlCommand } from "../../client-lex-models-v2/mod.ts";
