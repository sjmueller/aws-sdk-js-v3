...
import { CreateBotLocaleRequest, CreateBotLocaleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LexModelsV2Client, CreateBotLocaleCommand } from "../../client-lex-models-v2/mod.ts";
