...
const AWS_TEMPLATE = "codepipeline.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "codepipeline.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "codepipeline.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "codepipeline.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "codepipeline.{region}.amazonaws.com";
