...
import { PutActionRevisionInput, PutActionRevisionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodePipelineClient, PutActionRevisionCommand } from "../../client-codepipeline/mod.ts";
