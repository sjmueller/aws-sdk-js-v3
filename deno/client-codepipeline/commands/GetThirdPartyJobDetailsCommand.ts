...
import { GetThirdPartyJobDetailsInput, GetThirdPartyJobDetailsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodePipelineClient, GetThirdPartyJobDetailsCommand } from "../../client-codepipeline/mod.ts";
