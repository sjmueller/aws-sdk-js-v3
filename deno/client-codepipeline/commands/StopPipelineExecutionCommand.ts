...
import { StopPipelineExecutionInput, StopPipelineExecutionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodePipelineClient, StopPipelineExecutionCommand } from "../../client-codepipeline/mod.ts";
