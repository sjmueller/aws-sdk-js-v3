...
import { DescribeWorkflowExecutionInput, WorkflowExecutionDetail } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SWFClient, DescribeWorkflowExecutionCommand } from "../../client-swf/mod.ts";
