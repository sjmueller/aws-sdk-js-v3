...
import { ListClosedWorkflowExecutionsInput, WorkflowExecutionInfos } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SWFClient, ListClosedWorkflowExecutionsCommand } from "../../client-swf/mod.ts";
