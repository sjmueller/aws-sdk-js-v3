...
import { CountClosedWorkflowExecutionsInput, WorkflowExecutionCount } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SWFClient, CountClosedWorkflowExecutionsCommand } from "../../client-swf/mod.ts";
