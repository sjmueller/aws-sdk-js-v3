...
import { RegisterTaskDefinitionRequest, RegisterTaskDefinitionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ECSClient, RegisterTaskDefinitionCommand } from "../../client-ecs/mod.ts";
