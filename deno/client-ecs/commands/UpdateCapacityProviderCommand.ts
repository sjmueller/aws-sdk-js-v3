...
import { UpdateCapacityProviderRequest, UpdateCapacityProviderResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ECSClient, UpdateCapacityProviderCommand } from "../../client-ecs/mod.ts";
