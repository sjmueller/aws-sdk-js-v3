...
import { RegisterContainerInstanceRequest, RegisterContainerInstanceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ECSClient, RegisterContainerInstanceCommand } from "../../client-ecs/mod.ts";
