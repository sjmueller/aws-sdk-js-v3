...
import { DeregisterTaskDefinitionRequest, DeregisterTaskDefinitionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ECSClient, DeregisterTaskDefinitionCommand } from "../../client-ecs/mod.ts";
