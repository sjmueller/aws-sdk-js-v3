...
import { BatchUpsertTableRowsRequest, BatchUpsertTableRowsResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { HoneycodeClient, BatchUpsertTableRowsCommand } from "../../client-honeycode/mod.ts";
