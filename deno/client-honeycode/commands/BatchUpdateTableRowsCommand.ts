...
import { BatchUpdateTableRowsRequest, BatchUpdateTableRowsResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { HoneycodeClient, BatchUpdateTableRowsCommand } from "../../client-honeycode/mod.ts";
