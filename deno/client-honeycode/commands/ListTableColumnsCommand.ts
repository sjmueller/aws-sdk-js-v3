...
import { ListTableColumnsRequest, ListTableColumnsResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { HoneycodeClient, ListTableColumnsCommand } from "../../client-honeycode/mod.ts";
