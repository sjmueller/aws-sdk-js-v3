...
import { GetSkillGroupRequest, GetSkillGroupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, GetSkillGroupCommand } from "../../client-alexa-for-business/mod.ts";
