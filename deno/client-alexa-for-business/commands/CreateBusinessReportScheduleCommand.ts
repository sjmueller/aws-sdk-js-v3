...
export type CreateBusinessReportScheduleCommandOutput = CreateBusinessReportScheduleResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1CreateBusinessReportScheduleCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1CreateBusinessReportScheduleCommand(
      output,
      context
    );
  }
