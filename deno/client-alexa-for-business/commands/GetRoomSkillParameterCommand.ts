...
import { GetRoomSkillParameterRequest, GetRoomSkillParameterResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, GetRoomSkillParameterCommand } from "../../client-alexa-for-business/mod.ts";
