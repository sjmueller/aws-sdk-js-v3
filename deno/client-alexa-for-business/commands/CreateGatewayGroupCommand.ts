...
import { CreateGatewayGroupRequest, CreateGatewayGroupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, CreateGatewayGroupCommand } from "../../client-alexa-for-business/mod.ts";
