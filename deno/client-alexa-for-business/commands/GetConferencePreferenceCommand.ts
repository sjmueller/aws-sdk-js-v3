...
import { GetConferencePreferenceRequest, GetConferencePreferenceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, GetConferencePreferenceCommand } from "../../client-alexa-for-business/mod.ts";
