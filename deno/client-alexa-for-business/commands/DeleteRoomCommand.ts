...
import { DeleteRoomRequest, DeleteRoomResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, DeleteRoomCommand } from "../../client-alexa-for-business/mod.ts";
