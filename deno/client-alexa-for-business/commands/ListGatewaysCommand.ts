...
import { ListGatewaysRequest, ListGatewaysResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, ListGatewaysCommand } from "../../client-alexa-for-business/mod.ts";
