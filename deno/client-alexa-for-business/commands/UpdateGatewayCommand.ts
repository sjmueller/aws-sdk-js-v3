...
import { UpdateGatewayRequest, UpdateGatewayResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, UpdateGatewayCommand } from "../../client-alexa-for-business/mod.ts";
