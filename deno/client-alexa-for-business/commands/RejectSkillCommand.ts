...
import { RejectSkillRequest, RejectSkillResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, RejectSkillCommand } from "../../client-alexa-for-business/mod.ts";
