...
import { SearchProfilesRequest, SearchProfilesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, SearchProfilesCommand } from "../../client-alexa-for-business/mod.ts";
