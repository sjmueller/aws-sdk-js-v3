...
import { deserializeAws_json1_1GetRoomCommand, serializeAws_json1_1GetRoomCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { AlexaForBusinessClient, GetRoomCommand } from "../../client-alexa-for-business/mod.ts";
