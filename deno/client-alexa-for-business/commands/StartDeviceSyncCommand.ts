...
import { StartDeviceSyncRequest, StartDeviceSyncResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, StartDeviceSyncCommand } from "../../client-alexa-for-business/mod.ts";
