...
import { ApproveSkillRequest, ApproveSkillResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, ApproveSkillCommand } from "../../client-alexa-for-business/mod.ts";
