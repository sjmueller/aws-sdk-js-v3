...
import { ListGatewayGroupsRequest, ListGatewayGroupsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, ListGatewayGroupsCommand } from "../../client-alexa-for-business/mod.ts";
