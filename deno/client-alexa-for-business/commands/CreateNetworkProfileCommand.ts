...
import { CreateNetworkProfileRequest, CreateNetworkProfileResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, CreateNetworkProfileCommand } from "../../client-alexa-for-business/mod.ts";
