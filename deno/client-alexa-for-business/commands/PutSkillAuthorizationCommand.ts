...
import { PutSkillAuthorizationRequest, PutSkillAuthorizationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, PutSkillAuthorizationCommand } from "../../client-alexa-for-business/mod.ts";
