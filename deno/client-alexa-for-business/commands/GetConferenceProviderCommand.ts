...
import { GetConferenceProviderRequest, GetConferenceProviderResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AlexaForBusinessClient, GetConferenceProviderCommand } from "../../client-alexa-for-business/mod.ts";
