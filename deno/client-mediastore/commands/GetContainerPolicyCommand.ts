...
import { GetContainerPolicyInput, GetContainerPolicyOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaStoreClient, GetContainerPolicyCommand } from "../../client-mediastore/mod.ts";
