...
import { DescribeTunnelRequest, DescribeTunnelResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTSecureTunnelingClient, DescribeTunnelCommand } from "../../client-iotsecuretunneling/mod.ts";
