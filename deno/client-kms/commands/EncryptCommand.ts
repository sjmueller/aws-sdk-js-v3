...
import { EncryptRequest, EncryptResponse } from "../models/models_0.ts";
import { deserializeAws_json1_1EncryptCommand, serializeAws_json1_1EncryptCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { KMSClient, EncryptCommand } from "../../client-kms/mod.ts";
