...
import { DeleteCustomKeyStoreRequest, DeleteCustomKeyStoreResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KMSClient, DeleteCustomKeyStoreCommand } from "../../client-kms/mod.ts";
