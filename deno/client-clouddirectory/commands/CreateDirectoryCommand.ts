...
import { CreateDirectoryRequest, CreateDirectoryResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudDirectoryClient, CreateDirectoryCommand } from "../../client-clouddirectory/mod.ts";
