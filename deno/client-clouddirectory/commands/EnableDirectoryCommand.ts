...
import { EnableDirectoryRequest, EnableDirectoryResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudDirectoryClient, EnableDirectoryCommand } from "../../client-clouddirectory/mod.ts";
