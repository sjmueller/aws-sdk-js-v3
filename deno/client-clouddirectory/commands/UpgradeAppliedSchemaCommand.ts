...
import { UpgradeAppliedSchemaRequest, UpgradeAppliedSchemaResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudDirectoryClient, UpgradeAppliedSchemaCommand } from "../../client-clouddirectory/mod.ts";
