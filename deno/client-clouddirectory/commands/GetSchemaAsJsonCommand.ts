...
import { GetSchemaAsJsonRequest, GetSchemaAsJsonResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudDirectoryClient, GetSchemaAsJsonCommand } from "../../client-clouddirectory/mod.ts";
