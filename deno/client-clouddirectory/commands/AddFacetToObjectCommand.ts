...
import { AddFacetToObjectRequest, AddFacetToObjectResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudDirectoryClient, AddFacetToObjectCommand } from "../../client-clouddirectory/mod.ts";
