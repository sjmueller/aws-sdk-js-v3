...
import { UntagResourcesInput, UntagResourcesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ResourceGroupsTaggingAPIClient, UntagResourcesCommand } from "../../client-resource-groups-tagging-api/mod.ts";
