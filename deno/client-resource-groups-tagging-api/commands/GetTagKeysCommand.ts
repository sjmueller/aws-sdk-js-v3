...
import { GetTagKeysInput, GetTagKeysOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ResourceGroupsTaggingAPIClient, GetTagKeysCommand } from "../../client-resource-groups-tagging-api/mod.ts";
