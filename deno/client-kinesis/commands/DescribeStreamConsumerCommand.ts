...
import { DescribeStreamConsumerInput, DescribeStreamConsumerOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KinesisClient, DescribeStreamConsumerCommand } from "../../client-kinesis/mod.ts";
