...
import { PutAccessControlRuleRequest, PutAccessControlRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkMailClient, PutAccessControlRuleCommand } from "../../client-workmail/mod.ts";
