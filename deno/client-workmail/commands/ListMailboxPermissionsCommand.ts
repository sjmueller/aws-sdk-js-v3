...
import { ListMailboxPermissionsRequest, ListMailboxPermissionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkMailClient, ListMailboxPermissionsCommand } from "../../client-workmail/mod.ts";
