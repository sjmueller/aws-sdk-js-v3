...
export type ListMobileDeviceAccessRulesCommandInput = ListMobileDeviceAccessRulesRequest;
export type ListMobileDeviceAccessRulesCommandOutput = ListMobileDeviceAccessRulesResponse & __MetadataBearer;
