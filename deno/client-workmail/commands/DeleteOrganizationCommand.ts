...
import { DeleteOrganizationRequest, DeleteOrganizationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkMailClient, DeleteOrganizationCommand } from "../../client-workmail/mod.ts";
