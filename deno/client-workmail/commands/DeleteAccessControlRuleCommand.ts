...
import { DeleteAccessControlRuleRequest, DeleteAccessControlRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkMailClient, DeleteAccessControlRuleCommand } from "../../client-workmail/mod.ts";
