...
import { ListMailboxExportJobsRequest, ListMailboxExportJobsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkMailClient, ListMailboxExportJobsCommand } from "../../client-workmail/mod.ts";
