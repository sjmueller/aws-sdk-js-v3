...
import { UpdateMobileDeviceAccessRuleRequest, UpdateMobileDeviceAccessRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WorkMailClient, UpdateMobileDeviceAccessRuleCommand } from "../../client-workmail/mod.ts";
