...
import { DeleteJobTemplateRequest, DeleteJobTemplateResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { MediaConvertClient, DeleteJobTemplateCommand } from "../../client-mediaconvert/mod.ts";
