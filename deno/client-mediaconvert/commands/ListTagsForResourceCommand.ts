...
import { ListTagsForResourceRequest, ListTagsForResourceResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { MediaConvertClient, ListTagsForResourceCommand } from "../../client-mediaconvert/mod.ts";
