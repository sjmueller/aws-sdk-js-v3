...
import { DeleteVolumeRequest } from "../models/models_2.ts";
import { deserializeAws_ec2DeleteVolumeCommand, serializeAws_ec2DeleteVolumeCommand } from "../protocols/Aws_ec2.ts";
 ...
 * ```javascript
 * import { EC2Client, DeleteVolumeCommand } from "../../client-ec2/mod.ts";
