...
import { DescribeSpotInstanceRequestsRequest, DescribeSpotInstanceRequestsResult } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeSpotInstanceRequestsCommand } from "../../client-ec2/mod.ts";
