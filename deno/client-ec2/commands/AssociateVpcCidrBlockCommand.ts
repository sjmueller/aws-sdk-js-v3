...
import { AssociateVpcCidrBlockRequest, AssociateVpcCidrBlockResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, AssociateVpcCidrBlockCommand } from "../../client-ec2/mod.ts";
