...
import { AssociateClientVpnTargetNetworkRequest, AssociateClientVpnTargetNetworkResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, AssociateClientVpnTargetNetworkCommand } from "../../client-ec2/mod.ts";
