...
import { MoveAddressToVpcRequest } from "../models/models_4.ts";
import { MoveAddressToVpcResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, MoveAddressToVpcCommand } from "../../client-ec2/mod.ts";
