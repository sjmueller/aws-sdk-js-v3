...
import { DeleteTrafficMirrorSessionRequest, DeleteTrafficMirrorSessionResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DeleteTrafficMirrorSessionCommand } from "../../client-ec2/mod.ts";
