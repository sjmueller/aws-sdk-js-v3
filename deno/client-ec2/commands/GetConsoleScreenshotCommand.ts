...
import { GetConsoleScreenshotRequest, GetConsoleScreenshotResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, GetConsoleScreenshotCommand } from "../../client-ec2/mod.ts";
