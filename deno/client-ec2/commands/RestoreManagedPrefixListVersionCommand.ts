...
import { RestoreManagedPrefixListVersionRequest, RestoreManagedPrefixListVersionResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, RestoreManagedPrefixListVersionCommand } from "../../client-ec2/mod.ts";
