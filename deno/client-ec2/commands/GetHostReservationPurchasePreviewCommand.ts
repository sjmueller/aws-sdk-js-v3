...
import { GetHostReservationPurchasePreviewRequest, GetHostReservationPurchasePreviewResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, GetHostReservationPurchasePreviewCommand } from "../../client-ec2/mod.ts";
