...
import { AuthorizeSecurityGroupEgressRequest, AuthorizeSecurityGroupEgressResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, AuthorizeSecurityGroupEgressCommand } from "../../client-ec2/mod.ts";
