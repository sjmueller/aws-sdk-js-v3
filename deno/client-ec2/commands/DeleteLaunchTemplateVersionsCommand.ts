...
import { DeleteLaunchTemplateVersionsRequest, DeleteLaunchTemplateVersionsResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DeleteLaunchTemplateVersionsCommand } from "../../client-ec2/mod.ts";
