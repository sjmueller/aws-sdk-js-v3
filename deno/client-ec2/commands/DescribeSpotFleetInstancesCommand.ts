...
import { DescribeSpotFleetInstancesRequest, DescribeSpotFleetInstancesResponse } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeSpotFleetInstancesCommand } from "../../client-ec2/mod.ts";
