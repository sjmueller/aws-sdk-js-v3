...
import { SearchLocalGatewayRoutesRequest, SearchLocalGatewayRoutesResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, SearchLocalGatewayRoutesCommand } from "../../client-ec2/mod.ts";
