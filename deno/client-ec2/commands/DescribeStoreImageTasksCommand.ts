...
import { DescribeStoreImageTasksRequest, DescribeStoreImageTasksResult } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeStoreImageTasksCommand } from "../../client-ec2/mod.ts";
