...
import { DescribeFastSnapshotRestoresRequest, DescribeFastSnapshotRestoresResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeFastSnapshotRestoresCommand } from "../../client-ec2/mod.ts";
