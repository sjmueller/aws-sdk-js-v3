...
import { AttachClassicLinkVpcRequest, AttachClassicLinkVpcResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, AttachClassicLinkVpcCommand } from "../../client-ec2/mod.ts";
