...
export type ModifyTransitGatewayVpcAttachmentCommandOutput = ModifyTransitGatewayVpcAttachmentResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_ec2ModifyTransitGatewayVpcAttachmentCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_ec2ModifyTransitGatewayVpcAttachmentCommand(
      output,
      context
    );
  }
