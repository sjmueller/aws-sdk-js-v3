...
import { EnableFastSnapshotRestoresRequest, EnableFastSnapshotRestoresResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, EnableFastSnapshotRestoresCommand } from "../../client-ec2/mod.ts";
