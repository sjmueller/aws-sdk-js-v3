...
import { DisassociateInstanceEventWindowRequest, DisassociateInstanceEventWindowResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DisassociateInstanceEventWindowCommand } from "../../client-ec2/mod.ts";
