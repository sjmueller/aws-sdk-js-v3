...
import { RejectVpcPeeringConnectionRequest, RejectVpcPeeringConnectionResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, RejectVpcPeeringConnectionCommand } from "../../client-ec2/mod.ts";
