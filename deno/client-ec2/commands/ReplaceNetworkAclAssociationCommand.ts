...
import { ReplaceNetworkAclAssociationRequest, ReplaceNetworkAclAssociationResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ReplaceNetworkAclAssociationCommand } from "../../client-ec2/mod.ts";
