...
import { GetEbsEncryptionByDefaultRequest, GetEbsEncryptionByDefaultResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, GetEbsEncryptionByDefaultCommand } from "../../client-ec2/mod.ts";
