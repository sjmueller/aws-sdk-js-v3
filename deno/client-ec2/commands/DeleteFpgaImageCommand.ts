...
import { DeleteFpgaImageRequest, DeleteFpgaImageResult } from "../models/models_1.ts";
import { deserializeAws_ec2DeleteFpgaImageCommand, serializeAws_ec2DeleteFpgaImageCommand } from "../protocols/Aws_ec2.ts";
 ...
 * ```javascript
 * import { EC2Client, DeleteFpgaImageCommand } from "../../client-ec2/mod.ts";
