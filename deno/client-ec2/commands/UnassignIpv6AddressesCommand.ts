...
import { UnassignIpv6AddressesRequest, UnassignIpv6AddressesResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, UnassignIpv6AddressesCommand } from "../../client-ec2/mod.ts";
