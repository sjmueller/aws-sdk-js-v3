...
import { ModifyFpgaImageAttributeRequest, ModifyFpgaImageAttributeResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ModifyFpgaImageAttributeCommand } from "../../client-ec2/mod.ts";
