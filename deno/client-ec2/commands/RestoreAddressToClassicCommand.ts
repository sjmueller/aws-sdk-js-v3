...
import { RestoreAddressToClassicRequest, RestoreAddressToClassicResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, RestoreAddressToClassicCommand } from "../../client-ec2/mod.ts";
