...
import { DescribeInstanceTypesRequest, DescribeInstanceTypesResult } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeInstanceTypesCommand } from "../../client-ec2/mod.ts";
