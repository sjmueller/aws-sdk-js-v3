...
import { ReplaceRouteRequest } from "../models/models_4.ts";
import { deserializeAws_ec2ReplaceRouteCommand, serializeAws_ec2ReplaceRouteCommand } from "../protocols/Aws_ec2.ts";
 ...
 * ```javascript
 * import { EC2Client, ReplaceRouteCommand } from "../../client-ec2/mod.ts";
