...
import { RequestSpotInstancesRequest, RequestSpotInstancesResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, RequestSpotInstancesCommand } from "../../client-ec2/mod.ts";
