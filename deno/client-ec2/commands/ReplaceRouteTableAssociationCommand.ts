...
import { ReplaceRouteTableAssociationRequest, ReplaceRouteTableAssociationResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ReplaceRouteTableAssociationCommand } from "../../client-ec2/mod.ts";
