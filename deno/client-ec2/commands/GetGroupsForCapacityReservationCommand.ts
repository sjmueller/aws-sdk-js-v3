...
import { GetGroupsForCapacityReservationRequest, GetGroupsForCapacityReservationResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, GetGroupsForCapacityReservationCommand } from "../../client-ec2/mod.ts";
