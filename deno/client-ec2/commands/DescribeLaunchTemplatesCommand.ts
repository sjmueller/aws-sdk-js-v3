...
import { DescribeLaunchTemplatesRequest, DescribeLaunchTemplatesResult } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeLaunchTemplatesCommand } from "../../client-ec2/mod.ts";
