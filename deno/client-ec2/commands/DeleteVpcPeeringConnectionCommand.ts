...
import { DeleteVpcPeeringConnectionRequest, DeleteVpcPeeringConnectionResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DeleteVpcPeeringConnectionCommand } from "../../client-ec2/mod.ts";
