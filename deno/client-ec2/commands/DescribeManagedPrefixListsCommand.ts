...
import { DescribeManagedPrefixListsRequest, DescribeManagedPrefixListsResult } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeManagedPrefixListsCommand } from "../../client-ec2/mod.ts";
