...
import { DeleteInstanceEventWindowRequest, DeleteInstanceEventWindowResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DeleteInstanceEventWindowCommand } from "../../client-ec2/mod.ts";
