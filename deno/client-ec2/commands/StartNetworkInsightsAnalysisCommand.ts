...
import { StartNetworkInsightsAnalysisRequest, StartNetworkInsightsAnalysisResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, StartNetworkInsightsAnalysisCommand } from "../../client-ec2/mod.ts";
