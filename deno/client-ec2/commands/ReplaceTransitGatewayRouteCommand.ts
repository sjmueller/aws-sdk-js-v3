...
import { ReplaceTransitGatewayRouteRequest, ReplaceTransitGatewayRouteResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ReplaceTransitGatewayRouteCommand } from "../../client-ec2/mod.ts";
