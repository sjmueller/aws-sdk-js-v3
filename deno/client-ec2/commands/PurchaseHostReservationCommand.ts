...
import { PurchaseHostReservationRequest, PurchaseHostReservationResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, PurchaseHostReservationCommand } from "../../client-ec2/mod.ts";
