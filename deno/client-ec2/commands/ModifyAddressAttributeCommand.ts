...
import { ModifyAddressAttributeRequest, ModifyAddressAttributeResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ModifyAddressAttributeCommand } from "../../client-ec2/mod.ts";
