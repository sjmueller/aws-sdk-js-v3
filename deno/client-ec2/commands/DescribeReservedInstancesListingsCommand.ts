...
export type DescribeReservedInstancesListingsCommandOutput = DescribeReservedInstancesListingsResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_ec2DescribeReservedInstancesListingsCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_ec2DescribeReservedInstancesListingsCommand(
      output,
      context
    );
  }
