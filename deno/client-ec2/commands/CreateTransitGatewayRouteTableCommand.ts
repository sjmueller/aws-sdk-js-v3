...
import { CreateTransitGatewayRouteTableRequest, CreateTransitGatewayRouteTableResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateTransitGatewayRouteTableCommand } from "../../client-ec2/mod.ts";
