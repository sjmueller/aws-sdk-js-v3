...
import { DeleteFleetsRequest } from "../models/models_1.ts";
import { DeleteFleetsResult } from "../models/models_2.ts";
 ...
 * ```javascript
 * import { EC2Client, DeleteFleetsCommand } from "../../client-ec2/mod.ts";
