...
import { DescribeVpcEndpointServicesRequest, DescribeVpcEndpointServicesResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeVpcEndpointServicesCommand } from "../../client-ec2/mod.ts";
