...
import { SearchTransitGatewayRoutesRequest, SearchTransitGatewayRoutesResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, SearchTransitGatewayRoutesCommand } from "../../client-ec2/mod.ts";
