...
import { ResetAddressAttributeRequest, ResetAddressAttributeResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ResetAddressAttributeCommand } from "../../client-ec2/mod.ts";
