...
import { RejectTransitGatewayVpcAttachmentRequest, RejectTransitGatewayVpcAttachmentResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, RejectTransitGatewayVpcAttachmentCommand } from "../../client-ec2/mod.ts";
