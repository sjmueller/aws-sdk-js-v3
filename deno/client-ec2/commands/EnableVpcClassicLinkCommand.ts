...
import { EnableVpcClassicLinkRequest, EnableVpcClassicLinkResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, EnableVpcClassicLinkCommand } from "../../client-ec2/mod.ts";
