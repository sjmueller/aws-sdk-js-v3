...
import { CreateReservedInstancesListingRequest, CreateReservedInstancesListingResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateReservedInstancesListingCommand } from "../../client-ec2/mod.ts";
