...
import { CreatePlacementGroupRequest, CreatePlacementGroupResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreatePlacementGroupCommand } from "../../client-ec2/mod.ts";
