...
import { DescribeSpotFleetRequestsRequest, DescribeSpotFleetRequestsResponse } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeSpotFleetRequestsCommand } from "../../client-ec2/mod.ts";
