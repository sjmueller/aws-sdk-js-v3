...
import { DescribeInstanceStatusRequest } from "../models/models_2.ts";
import { DescribeInstanceStatusResult } from "../models/models_3.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeInstanceStatusCommand } from "../../client-ec2/mod.ts";
