...
import { EnableEbsEncryptionByDefaultRequest, EnableEbsEncryptionByDefaultResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, EnableEbsEncryptionByDefaultCommand } from "../../client-ec2/mod.ts";
