...
import { CreateCustomerGatewayRequest, CreateCustomerGatewayResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateCustomerGatewayCommand } from "../../client-ec2/mod.ts";
