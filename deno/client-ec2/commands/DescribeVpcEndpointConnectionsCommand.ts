...
import { DescribeVpcEndpointConnectionsRequest, DescribeVpcEndpointConnectionsResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeVpcEndpointConnectionsCommand } from "../../client-ec2/mod.ts";
