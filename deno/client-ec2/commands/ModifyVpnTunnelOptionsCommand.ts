...
import { ModifyVpnTunnelOptionsRequest, ModifyVpnTunnelOptionsResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ModifyVpnTunnelOptionsCommand } from "../../client-ec2/mod.ts";
