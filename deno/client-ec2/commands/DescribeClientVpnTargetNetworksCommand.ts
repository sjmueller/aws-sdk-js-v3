...
import { DescribeClientVpnTargetNetworksRequest, DescribeClientVpnTargetNetworksResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeClientVpnTargetNetworksCommand } from "../../client-ec2/mod.ts";
