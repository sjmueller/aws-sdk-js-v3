...
import { CreateTagsRequest } from "../models/models_1.ts";
import { deserializeAws_ec2CreateTagsCommand, serializeAws_ec2CreateTagsCommand } from "../protocols/Aws_ec2.ts";
 ...
 * ```javascript
 * import { EC2Client, CreateTagsCommand } from "../../client-ec2/mod.ts";
