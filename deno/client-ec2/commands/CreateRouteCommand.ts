...
import { CreateRouteRequest, CreateRouteResult } from "../models/models_1.ts";
import { deserializeAws_ec2CreateRouteCommand, serializeAws_ec2CreateRouteCommand } from "../protocols/Aws_ec2.ts";
 ...
 * ```javascript
 * import { EC2Client, CreateRouteCommand } from "../../client-ec2/mod.ts";
