...
import { CreateInstanceEventWindowRequest, CreateInstanceEventWindowResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateInstanceEventWindowCommand } from "../../client-ec2/mod.ts";
