...
import { PurchaseScheduledInstancesRequest, PurchaseScheduledInstancesResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, PurchaseScheduledInstancesCommand } from "../../client-ec2/mod.ts";
