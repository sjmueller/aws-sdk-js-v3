...
import { CreateSubnetCidrReservationRequest, CreateSubnetCidrReservationResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateSubnetCidrReservationCommand } from "../../client-ec2/mod.ts";
