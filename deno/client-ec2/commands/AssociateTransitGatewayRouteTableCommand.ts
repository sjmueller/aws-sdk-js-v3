...
export type AssociateTransitGatewayRouteTableCommandOutput = AssociateTransitGatewayRouteTableResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_ec2AssociateTransitGatewayRouteTableCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_ec2AssociateTransitGatewayRouteTableCommand(
      output,
      context
    );
  }
