...
import { ModifyInstanceMetadataOptionsRequest, ModifyInstanceMetadataOptionsResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ModifyInstanceMetadataOptionsCommand } from "../../client-ec2/mod.ts";
