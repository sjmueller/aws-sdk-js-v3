...
import { CreateCapacityReservationRequest, CreateCapacityReservationResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateCapacityReservationCommand } from "../../client-ec2/mod.ts";
