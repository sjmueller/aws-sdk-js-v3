...
export type DescribeTransitGatewayAttachmentsCommandOutput = DescribeTransitGatewayAttachmentsResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_ec2DescribeTransitGatewayAttachmentsCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_ec2DescribeTransitGatewayAttachmentsCommand(
      output,
      context
    );
  }
