...
import { DisableSerialConsoleAccessRequest, DisableSerialConsoleAccessResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DisableSerialConsoleAccessCommand } from "../../client-ec2/mod.ts";
