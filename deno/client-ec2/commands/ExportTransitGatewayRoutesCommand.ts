...
import { ExportTransitGatewayRoutesRequest, ExportTransitGatewayRoutesResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ExportTransitGatewayRoutesCommand } from "../../client-ec2/mod.ts";
