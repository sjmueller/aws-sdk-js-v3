...
import { DisableImageDeprecationRequest, DisableImageDeprecationResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DisableImageDeprecationCommand } from "../../client-ec2/mod.ts";
