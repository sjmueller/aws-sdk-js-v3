...
import { CreateTrafficMirrorTargetRequest, CreateTrafficMirrorTargetResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateTrafficMirrorTargetCommand } from "../../client-ec2/mod.ts";
