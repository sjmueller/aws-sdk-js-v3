...
import { ModifyInstanceEventWindowRequest, ModifyInstanceEventWindowResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ModifyInstanceEventWindowCommand } from "../../client-ec2/mod.ts";
