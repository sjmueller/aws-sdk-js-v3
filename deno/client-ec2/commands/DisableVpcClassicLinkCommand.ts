...
import { DisableVpcClassicLinkRequest, DisableVpcClassicLinkResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DisableVpcClassicLinkCommand } from "../../client-ec2/mod.ts";
