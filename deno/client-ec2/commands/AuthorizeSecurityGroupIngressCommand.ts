...
import { AuthorizeSecurityGroupIngressRequest, AuthorizeSecurityGroupIngressResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, AuthorizeSecurityGroupIngressCommand } from "../../client-ec2/mod.ts";
