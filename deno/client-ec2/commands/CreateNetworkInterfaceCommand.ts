...
import { CreateNetworkInterfaceRequest, CreateNetworkInterfaceResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateNetworkInterfaceCommand } from "../../client-ec2/mod.ts";
