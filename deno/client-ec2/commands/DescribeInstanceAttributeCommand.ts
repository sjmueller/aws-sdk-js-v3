...
import { DescribeInstanceAttributeRequest, InstanceAttribute } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeInstanceAttributeCommand } from "../../client-ec2/mod.ts";
