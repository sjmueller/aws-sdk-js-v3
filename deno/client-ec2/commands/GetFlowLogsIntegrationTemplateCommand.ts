...
import { GetFlowLogsIntegrationTemplateRequest, GetFlowLogsIntegrationTemplateResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, GetFlowLogsIntegrationTemplateCommand } from "../../client-ec2/mod.ts";
