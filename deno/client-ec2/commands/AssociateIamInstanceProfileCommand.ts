...
import { AssociateIamInstanceProfileRequest, AssociateIamInstanceProfileResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, AssociateIamInstanceProfileCommand } from "../../client-ec2/mod.ts";
