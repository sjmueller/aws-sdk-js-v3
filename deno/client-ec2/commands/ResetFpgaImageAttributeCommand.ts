...
import { ResetFpgaImageAttributeRequest, ResetFpgaImageAttributeResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ResetFpgaImageAttributeCommand } from "../../client-ec2/mod.ts";
