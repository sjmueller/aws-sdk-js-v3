...
import { DescribeAvailabilityZonesRequest, DescribeAvailabilityZonesResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeAvailabilityZonesCommand } from "../../client-ec2/mod.ts";
