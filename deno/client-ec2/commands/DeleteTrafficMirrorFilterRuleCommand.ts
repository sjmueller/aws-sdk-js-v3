...
import { DeleteTrafficMirrorFilterRuleRequest, DeleteTrafficMirrorFilterRuleResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DeleteTrafficMirrorFilterRuleCommand } from "../../client-ec2/mod.ts";
