...
import { AssociateInstanceEventWindowRequest, AssociateInstanceEventWindowResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, AssociateInstanceEventWindowCommand } from "../../client-ec2/mod.ts";
