...
import { DescribeVpcEndpointsRequest, DescribeVpcEndpointsResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeVpcEndpointsCommand } from "../../client-ec2/mod.ts";
