...
import { ModifyVpnTunnelCertificateRequest, ModifyVpnTunnelCertificateResult } from "../models/models_5.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, ModifyVpnTunnelCertificateCommand } from "../../client-ec2/mod.ts";
