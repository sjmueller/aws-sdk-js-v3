...
import { DescribeIdentityIdFormatRequest, DescribeIdentityIdFormatResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeIdentityIdFormatCommand } from "../../client-ec2/mod.ts";
