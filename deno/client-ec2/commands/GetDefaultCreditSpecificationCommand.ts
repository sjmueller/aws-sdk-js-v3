...
import { GetDefaultCreditSpecificationRequest, GetDefaultCreditSpecificationResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, GetDefaultCreditSpecificationCommand } from "../../client-ec2/mod.ts";
