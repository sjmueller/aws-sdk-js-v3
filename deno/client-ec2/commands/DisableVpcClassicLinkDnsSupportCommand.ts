...
import { DisableVpcClassicLinkDnsSupportRequest, DisableVpcClassicLinkDnsSupportResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DisableVpcClassicLinkDnsSupportCommand } from "../../client-ec2/mod.ts";
