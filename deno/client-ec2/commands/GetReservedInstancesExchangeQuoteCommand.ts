...
import { GetReservedInstancesExchangeQuoteRequest, GetReservedInstancesExchangeQuoteResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, GetReservedInstancesExchangeQuoteCommand } from "../../client-ec2/mod.ts";
