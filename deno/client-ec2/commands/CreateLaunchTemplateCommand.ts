...
import { CreateLaunchTemplateRequest, CreateLaunchTemplateResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, CreateLaunchTemplateCommand } from "../../client-ec2/mod.ts";
