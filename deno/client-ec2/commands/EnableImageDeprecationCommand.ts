...
import { EnableImageDeprecationRequest, EnableImageDeprecationResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, EnableImageDeprecationCommand } from "../../client-ec2/mod.ts";
