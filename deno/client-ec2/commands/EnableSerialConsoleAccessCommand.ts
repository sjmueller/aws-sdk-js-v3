...
import { EnableSerialConsoleAccessRequest, EnableSerialConsoleAccessResult } from "../models/models_4.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, EnableSerialConsoleAccessCommand } from "../../client-ec2/mod.ts";
