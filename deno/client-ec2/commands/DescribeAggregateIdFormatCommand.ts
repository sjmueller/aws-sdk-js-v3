...
import { DescribeAggregateIdFormatRequest, DescribeAggregateIdFormatResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { EC2Client, DescribeAggregateIdFormatCommand } from "../../client-ec2/mod.ts";
