...
import { GetInstanceRequest, GetInstanceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceDiscoveryClient, GetInstanceCommand } from "../../client-servicediscovery/mod.ts";
