...
import { RegisterInstanceRequest, RegisterInstanceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceDiscoveryClient, RegisterInstanceCommand } from "../../client-servicediscovery/mod.ts";
