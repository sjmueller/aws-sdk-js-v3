...
import { UpdateRoutingControlStatesRequest, UpdateRoutingControlStatesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryClusterClient, UpdateRoutingControlStatesCommand } from "../../client-route53-recovery-cluster/mod.ts";
