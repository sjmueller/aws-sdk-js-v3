...
import { DeleteSystemTemplateRequest, DeleteSystemTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTThingsGraphClient, DeleteSystemTemplateCommand } from "../../client-iotthingsgraph/mod.ts";
