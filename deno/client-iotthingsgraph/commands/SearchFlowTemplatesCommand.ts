...
import { SearchFlowTemplatesRequest, SearchFlowTemplatesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTThingsGraphClient, SearchFlowTemplatesCommand } from "../../client-iotthingsgraph/mod.ts";
