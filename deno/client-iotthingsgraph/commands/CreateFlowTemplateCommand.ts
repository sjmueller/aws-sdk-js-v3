...
import { CreateFlowTemplateRequest, CreateFlowTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTThingsGraphClient, CreateFlowTemplateCommand } from "../../client-iotthingsgraph/mod.ts";
