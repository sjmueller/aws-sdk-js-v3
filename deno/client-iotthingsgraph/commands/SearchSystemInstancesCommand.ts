...
import { SearchSystemInstancesRequest, SearchSystemInstancesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTThingsGraphClient, SearchSystemInstancesCommand } from "../../client-iotthingsgraph/mod.ts";
