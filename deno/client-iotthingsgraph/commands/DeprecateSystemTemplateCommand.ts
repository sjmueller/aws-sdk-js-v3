...
import { DeprecateSystemTemplateRequest, DeprecateSystemTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTThingsGraphClient, DeprecateSystemTemplateCommand } from "../../client-iotthingsgraph/mod.ts";
