...
export type CreateSubscriptionDefinitionCommandOutput = CreateSubscriptionDefinitionResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1CreateSubscriptionDefinitionCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1CreateSubscriptionDefinitionCommand(
      output,
      context
    );
  }
