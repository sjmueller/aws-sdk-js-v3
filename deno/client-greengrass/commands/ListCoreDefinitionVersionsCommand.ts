...
import { ListCoreDefinitionVersionsRequest, ListCoreDefinitionVersionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GreengrassClient, ListCoreDefinitionVersionsCommand } from "../../client-greengrass/mod.ts";
