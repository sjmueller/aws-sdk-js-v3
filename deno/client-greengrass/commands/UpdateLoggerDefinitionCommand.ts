...
import { UpdateLoggerDefinitionRequest, UpdateLoggerDefinitionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GreengrassClient, UpdateLoggerDefinitionCommand } from "../../client-greengrass/mod.ts";
