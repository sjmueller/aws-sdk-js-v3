...
export type CreateGroupCertificateAuthorityCommandOutput = CreateGroupCertificateAuthorityResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1CreateGroupCertificateAuthorityCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1CreateGroupCertificateAuthorityCommand(
      output,
      context
    );
  }
