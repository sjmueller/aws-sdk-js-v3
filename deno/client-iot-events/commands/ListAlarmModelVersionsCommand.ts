...
import { ListAlarmModelVersionsRequest, ListAlarmModelVersionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTEventsClient, ListAlarmModelVersionsCommand } from "../../client-iot-events/mod.ts";
