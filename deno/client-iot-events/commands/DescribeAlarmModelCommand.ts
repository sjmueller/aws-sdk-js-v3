...
import { DescribeAlarmModelRequest, DescribeAlarmModelResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTEventsClient, DescribeAlarmModelCommand } from "../../client-iot-events/mod.ts";
