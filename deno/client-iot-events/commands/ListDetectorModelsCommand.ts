...
import { ListDetectorModelsRequest, ListDetectorModelsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTEventsClient, ListDetectorModelsCommand } from "../../client-iot-events/mod.ts";
