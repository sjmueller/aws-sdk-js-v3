...
import { UpdateDetectorModelRequest, UpdateDetectorModelResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTEventsClient, UpdateDetectorModelCommand } from "../../client-iot-events/mod.ts";
