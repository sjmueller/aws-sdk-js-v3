...
import { UpdateOrganizationalUnitRequest, UpdateOrganizationalUnitResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OrganizationsClient, UpdateOrganizationalUnitCommand } from "../../client-organizations/mod.ts";
