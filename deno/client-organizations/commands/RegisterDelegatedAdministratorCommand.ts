...
import { RegisterDelegatedAdministratorRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OrganizationsClient, RegisterDelegatedAdministratorCommand } from "../../client-organizations/mod.ts";
