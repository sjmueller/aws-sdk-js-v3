...
import { ListRootsRequest, ListRootsResponse } from "../models/models_0.ts";
import { deserializeAws_json1_1ListRootsCommand, serializeAws_json1_1ListRootsCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { OrganizationsClient, ListRootsCommand } from "../../client-organizations/mod.ts";
