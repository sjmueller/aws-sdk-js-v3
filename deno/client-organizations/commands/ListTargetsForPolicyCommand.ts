...
import { ListTargetsForPolicyRequest, ListTargetsForPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OrganizationsClient, ListTargetsForPolicyCommand } from "../../client-organizations/mod.ts";
