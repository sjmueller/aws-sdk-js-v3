...
import { ListHandshakesForAccountRequest, ListHandshakesForAccountResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OrganizationsClient, ListHandshakesForAccountCommand } from "../../client-organizations/mod.ts";
