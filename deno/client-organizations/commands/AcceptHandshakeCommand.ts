...
import { AcceptHandshakeRequest, AcceptHandshakeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OrganizationsClient, AcceptHandshakeCommand } from "../../client-organizations/mod.ts";
