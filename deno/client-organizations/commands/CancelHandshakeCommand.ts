...
import { CancelHandshakeRequest, CancelHandshakeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OrganizationsClient, CancelHandshakeCommand } from "../../client-organizations/mod.ts";
