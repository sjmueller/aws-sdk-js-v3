...
import { DescribeHandshakeRequest, DescribeHandshakeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OrganizationsClient, DescribeHandshakeCommand } from "../../client-organizations/mod.ts";
