...
import { DeletePlacementRequest, DeletePlacementResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoT1ClickProjectsClient, DeletePlacementCommand } from "../../client-iot-1click-projects/mod.ts";
