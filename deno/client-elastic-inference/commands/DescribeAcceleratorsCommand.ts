...
import { DescribeAcceleratorsRequest, DescribeAcceleratorsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticInferenceClient, DescribeAcceleratorsCommand } from "../../client-elastic-inference/mod.ts";
