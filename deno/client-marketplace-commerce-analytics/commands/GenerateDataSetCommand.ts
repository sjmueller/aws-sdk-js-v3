...
import { GenerateDataSetRequest, GenerateDataSetResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MarketplaceCommerceAnalyticsClient, GenerateDataSetCommand } from "../../client-marketplace-commerce-analytics/mod.ts";
