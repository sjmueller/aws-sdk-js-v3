...
} from "./commands/GenerateDataSetCommand.ts";
import {
  StartSupportDataExportCommandInput,
  StartSupportDataExportCommandOutput
} from "./commands/StartSupportDataExportCommand.ts";
...
export type MarketplaceCommerceAnalyticsClientConfig = Partial<
...
export type MarketplaceCommerceAnalyticsClientResolvedConfig = __SmithyResolvedConfiguration<
