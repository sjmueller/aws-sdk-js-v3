...
import { GetAnomalyMonitorsRequest, GetAnomalyMonitorsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CostExplorerClient, GetAnomalyMonitorsCommand } from "../../client-cost-explorer/mod.ts";
