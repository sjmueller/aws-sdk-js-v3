...
import { CreateAnomalyMonitorRequest, CreateAnomalyMonitorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CostExplorerClient, CreateAnomalyMonitorCommand } from "../../client-cost-explorer/mod.ts";
