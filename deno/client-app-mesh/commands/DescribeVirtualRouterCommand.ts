...
import { DescribeVirtualRouterInput, DescribeVirtualRouterOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AppMeshClient, DescribeVirtualRouterCommand } from "../../client-app-mesh/mod.ts";
