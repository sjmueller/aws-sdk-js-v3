...
import { DescribeGatewayRouteInput, DescribeGatewayRouteOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AppMeshClient, DescribeGatewayRouteCommand } from "../../client-app-mesh/mod.ts";
