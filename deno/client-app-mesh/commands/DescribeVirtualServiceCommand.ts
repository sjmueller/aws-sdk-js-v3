...
import { DescribeVirtualServiceInput, DescribeVirtualServiceOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AppMeshClient, DescribeVirtualServiceCommand } from "../../client-app-mesh/mod.ts";
