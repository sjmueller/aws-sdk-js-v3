...
import { DeleteVirtualNodeInput, DeleteVirtualNodeOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AppMeshClient, DeleteVirtualNodeCommand } from "../../client-app-mesh/mod.ts";
