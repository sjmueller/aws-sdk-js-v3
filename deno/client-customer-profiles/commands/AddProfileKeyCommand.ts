...
import { AddProfileKeyRequest, AddProfileKeyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CustomerProfilesClient, AddProfileKeyCommand } from "../../client-customer-profiles/mod.ts";
