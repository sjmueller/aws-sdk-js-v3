...
import { PutProfileObjectTypeRequest, PutProfileObjectTypeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CustomerProfilesClient, PutProfileObjectTypeCommand } from "../../client-customer-profiles/mod.ts";
