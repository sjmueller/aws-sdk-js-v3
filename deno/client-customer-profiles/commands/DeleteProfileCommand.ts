...
import { DeleteProfileRequest, DeleteProfileResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CustomerProfilesClient, DeleteProfileCommand } from "../../client-customer-profiles/mod.ts";
