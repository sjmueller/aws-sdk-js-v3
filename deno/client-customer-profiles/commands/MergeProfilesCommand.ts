...
import { MergeProfilesRequest, MergeProfilesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CustomerProfilesClient, MergeProfilesCommand } from "../../client-customer-profiles/mod.ts";
