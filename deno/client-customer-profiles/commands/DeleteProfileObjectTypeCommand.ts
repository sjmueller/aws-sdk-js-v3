...
import { DeleteProfileObjectTypeRequest, DeleteProfileObjectTypeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CustomerProfilesClient, DeleteProfileObjectTypeCommand } from "../../client-customer-profiles/mod.ts";
