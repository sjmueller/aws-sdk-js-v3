...
import { DeleteRetentionPolicyRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudWatchLogsClient, DeleteRetentionPolicyCommand } from "../../client-cloudwatch-logs/mod.ts";
