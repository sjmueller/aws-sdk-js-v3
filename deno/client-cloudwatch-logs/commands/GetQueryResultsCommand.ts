...
import { GetQueryResultsRequest, GetQueryResultsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudWatchLogsClient, GetQueryResultsCommand } from "../../client-cloudwatch-logs/mod.ts";
