...
import { DescribeLogStreamsRequest, DescribeLogStreamsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudWatchLogsClient, DescribeLogStreamsCommand } from "../../client-cloudwatch-logs/mod.ts";
