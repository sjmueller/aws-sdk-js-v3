...
import { PutQueryDefinitionRequest, PutQueryDefinitionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudWatchLogsClient, PutQueryDefinitionCommand } from "../../client-cloudwatch-logs/mod.ts";
