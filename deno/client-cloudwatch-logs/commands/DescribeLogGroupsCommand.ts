...
import { DescribeLogGroupsRequest, DescribeLogGroupsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudWatchLogsClient, DescribeLogGroupsCommand } from "../../client-cloudwatch-logs/mod.ts";
