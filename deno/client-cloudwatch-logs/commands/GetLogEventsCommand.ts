...
import { GetLogEventsRequest, GetLogEventsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudWatchLogsClient, GetLogEventsCommand } from "../../client-cloudwatch-logs/mod.ts";
