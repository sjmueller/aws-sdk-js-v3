...
import { GetReportDefinitionRequest, GetReportDefinitionResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApplicationCostProfilerClient, GetReportDefinitionCommand } from "../../client-applicationcostprofiler/mod.ts";
