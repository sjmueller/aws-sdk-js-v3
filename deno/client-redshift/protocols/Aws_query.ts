...
import { AddPartnerCommandInput, AddPartnerCommandOutput } from "../commands/AddPartnerCommand.ts";
import {
...
} from "../commands/AuthorizeEndpointAccessCommand.ts";
import {
...
} from "../commands/CreateAuthenticationProfileCommand.ts";
...
} from "../commands/CreateEndpointAccessCommand.ts";
import {
...
} from "../commands/DeleteAuthenticationProfileCommand.ts";
...
} from "../commands/DeleteEndpointAccessCommand.ts";
import {
...
import { DeletePartnerCommandInput, DeletePartnerCommandOutput } from "../commands/DeletePartnerCommand.ts";
import {
...
} from "../commands/DescribeAuthenticationProfilesCommand.ts";
import {
...
} from "../commands/DescribeEndpointAccessCommand.ts";
import {
...
import { DescribePartnersCommandInput, DescribePartnersCommandOutput } from "../commands/DescribePartnersCommand.ts";
import {
...
} from "../commands/ModifyAquaConfigurationCommand.ts";
import {
  ModifyAuthenticationProfileCommandInput,
  ModifyAuthenticationProfileCommandOutput,
} from "../commands/ModifyAuthenticationProfileCommand.ts";
...
} from "../commands/ModifyEndpointAccessCommand.ts";
import {
...
} from "../commands/RevokeEndpointAccessCommand.ts";
import {
...
} from "../commands/UpdatePartnerStatusCommand.ts";
import {
...
const deserializeAws_queryInvalidUsageLimitFaultResponse = async (
  ...
  const contents: InvalidUsageLimitFault = {
...
const deserializeAws_queryUsageLimitAlreadyExistsFaultResponse = async (
  ...
  const contents: UsageLimitAlreadyExistsFault = {
...
const deserializeAws_queryUsageLimitNotFoundFaultResponse = async (
  ...
  const contents: UsageLimitNotFoundFault = {
