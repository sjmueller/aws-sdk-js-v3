...
import { DescribeScheduledActionsMessage, ScheduledActionsMessage } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RedshiftClient, DescribeScheduledActionsCommand } from "../../client-redshift/mod.ts";
