...
import { ModifyAquaInputMessage, ModifyAquaOutputMessage } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RedshiftClient, ModifyAquaConfigurationCommand } from "../../client-redshift/mod.ts";
