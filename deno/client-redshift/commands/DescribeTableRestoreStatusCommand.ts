...
import { DescribeTableRestoreStatusMessage, TableRestoreStatusMessage } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RedshiftClient, DescribeTableRestoreStatusCommand } from "../../client-redshift/mod.ts";
