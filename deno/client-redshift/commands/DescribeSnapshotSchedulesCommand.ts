...
import { DescribeSnapshotSchedulesMessage, DescribeSnapshotSchedulesOutputMessage } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RedshiftClient, DescribeSnapshotSchedulesCommand } from "../../client-redshift/mod.ts";
