...
import { DeleteAuthenticationProfileMessage, DeleteAuthenticationProfileResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RedshiftClient, DeleteAuthenticationProfileCommand } from "../../client-redshift/mod.ts";
