...
import { EndpointAccess } from "../models/models_0.ts";
import { ModifyEndpointAccessMessage } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RedshiftClient, ModifyEndpointAccessCommand } from "../../client-redshift/mod.ts";
