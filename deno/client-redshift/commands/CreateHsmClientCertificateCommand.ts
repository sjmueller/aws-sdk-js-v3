...
import { CreateHsmClientCertificateMessage, CreateHsmClientCertificateResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RedshiftClient, CreateHsmClientCertificateCommand } from "../../client-redshift/mod.ts";
