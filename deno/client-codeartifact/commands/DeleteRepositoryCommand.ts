...
import { DeleteRepositoryRequest, DeleteRepositoryResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeartifactClient, DeleteRepositoryCommand } from "../../client-codeartifact/mod.ts";
