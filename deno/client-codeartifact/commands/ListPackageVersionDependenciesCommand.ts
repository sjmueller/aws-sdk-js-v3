...
import { ListPackageVersionDependenciesRequest, ListPackageVersionDependenciesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeartifactClient, ListPackageVersionDependenciesCommand } from "../../client-codeartifact/mod.ts";
