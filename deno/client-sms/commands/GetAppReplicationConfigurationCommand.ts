...
import { GetAppReplicationConfigurationRequest, GetAppReplicationConfigurationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SMSClient, GetAppReplicationConfigurationCommand } from "../../client-sms/mod.ts";
