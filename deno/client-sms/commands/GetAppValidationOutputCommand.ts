...
import { GetAppValidationOutputRequest, GetAppValidationOutputResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SMSClient, GetAppValidationOutputCommand } from "../../client-sms/mod.ts";
