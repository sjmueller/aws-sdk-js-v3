...
import { DeleteAppLaunchConfigurationRequest, DeleteAppLaunchConfigurationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SMSClient, DeleteAppLaunchConfigurationCommand } from "../../client-sms/mod.ts";
