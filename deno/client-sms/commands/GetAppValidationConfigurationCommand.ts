...
import { GetAppValidationConfigurationRequest, GetAppValidationConfigurationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SMSClient, GetAppValidationConfigurationCommand } from "../../client-sms/mod.ts";
