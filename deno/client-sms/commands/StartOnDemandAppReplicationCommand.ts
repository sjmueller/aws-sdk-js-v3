...
import { StartOnDemandAppReplicationRequest, StartOnDemandAppReplicationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SMSClient, StartOnDemandAppReplicationCommand } from "../../client-sms/mod.ts";
