...
import { CreateReplicationJobRequest, CreateReplicationJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SMSClient, CreateReplicationJobCommand } from "../../client-sms/mod.ts";
