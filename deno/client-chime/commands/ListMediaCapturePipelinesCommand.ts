...
import { ListMediaCapturePipelinesRequest, ListMediaCapturePipelinesResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, ListMediaCapturePipelinesCommand } from "../../client-chime/mod.ts";
