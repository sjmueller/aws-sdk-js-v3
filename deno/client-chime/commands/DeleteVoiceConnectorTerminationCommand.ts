...
import { DeleteVoiceConnectorTerminationRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, DeleteVoiceConnectorTerminationCommand } from "../../client-chime/mod.ts";
