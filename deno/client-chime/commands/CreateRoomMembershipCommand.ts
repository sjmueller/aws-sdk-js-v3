...
import { CreateRoomMembershipRequest, CreateRoomMembershipResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, CreateRoomMembershipCommand } from "../../client-chime/mod.ts";
