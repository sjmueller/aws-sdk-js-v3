...
import { UpdateRoomMembershipRequest, UpdateRoomMembershipResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, UpdateRoomMembershipCommand } from "../../client-chime/mod.ts";
