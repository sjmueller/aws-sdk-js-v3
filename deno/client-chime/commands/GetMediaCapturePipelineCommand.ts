...
import { GetMediaCapturePipelineRequest, GetMediaCapturePipelineResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, GetMediaCapturePipelineCommand } from "../../client-chime/mod.ts";
