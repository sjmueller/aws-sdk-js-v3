...
import { UpdateVoiceConnectorRequest, UpdateVoiceConnectorResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, UpdateVoiceConnectorCommand } from "../../client-chime/mod.ts";
