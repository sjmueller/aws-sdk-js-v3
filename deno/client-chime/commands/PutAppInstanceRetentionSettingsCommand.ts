...
import { PutAppInstanceRetentionSettingsRequest, PutAppInstanceRetentionSettingsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, PutAppInstanceRetentionSettingsCommand } from "../../client-chime/mod.ts";
