...
import { CreateSipMediaApplicationCallRequest, CreateSipMediaApplicationCallResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, CreateSipMediaApplicationCallCommand } from "../../client-chime/mod.ts";
