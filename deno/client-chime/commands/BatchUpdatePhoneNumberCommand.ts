...
import { BatchUpdatePhoneNumberRequest, BatchUpdatePhoneNumberResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, BatchUpdatePhoneNumberCommand } from "../../client-chime/mod.ts";
