...
import { BatchCreateAttendeeRequest, BatchCreateAttendeeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, BatchCreateAttendeeCommand } from "../../client-chime/mod.ts";
