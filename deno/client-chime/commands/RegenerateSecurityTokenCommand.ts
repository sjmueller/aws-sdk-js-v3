...
import { RegenerateSecurityTokenRequest, RegenerateSecurityTokenResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, RegenerateSecurityTokenCommand } from "../../client-chime/mod.ts";
