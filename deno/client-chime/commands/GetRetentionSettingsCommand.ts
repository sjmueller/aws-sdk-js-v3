...
import { GetRetentionSettingsRequest, GetRetentionSettingsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, GetRetentionSettingsCommand } from "../../client-chime/mod.ts";
