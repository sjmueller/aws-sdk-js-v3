...
import { CreateMeetingDialOutRequest, CreateMeetingDialOutResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, CreateMeetingDialOutCommand } from "../../client-chime/mod.ts";
