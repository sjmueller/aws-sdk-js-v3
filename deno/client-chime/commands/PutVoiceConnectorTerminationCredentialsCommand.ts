...
import { PutVoiceConnectorTerminationCredentialsRequest } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, PutVoiceConnectorTerminationCredentialsCommand } from "../../client-chime/mod.ts";
