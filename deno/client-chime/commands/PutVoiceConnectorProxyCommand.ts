...
import { PutVoiceConnectorProxyRequest, PutVoiceConnectorProxyResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, PutVoiceConnectorProxyCommand } from "../../client-chime/mod.ts";
