...
import { CreateMediaCapturePipelineRequest, CreateMediaCapturePipelineResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ChimeClient, CreateMediaCapturePipelineCommand } from "../../client-chime/mod.ts";
