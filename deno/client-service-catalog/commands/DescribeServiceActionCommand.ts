...
import { DescribeServiceActionInput, DescribeServiceActionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceCatalogClient, DescribeServiceActionCommand } from "../../client-service-catalog/mod.ts";
