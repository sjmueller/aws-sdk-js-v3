...
import { ProvisionProductInput, ProvisionProductOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceCatalogClient, ProvisionProductCommand } from "../../client-service-catalog/mod.ts";
