...
import { ImportAsProvisionedProductInput, ImportAsProvisionedProductOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceCatalogClient, ImportAsProvisionedProductCommand } from "../../client-service-catalog/mod.ts";
