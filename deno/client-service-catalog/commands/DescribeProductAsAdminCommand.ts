...
import { DescribeProductAsAdminInput, DescribeProductAsAdminOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceCatalogClient, DescribeProductAsAdminCommand } from "../../client-service-catalog/mod.ts";
