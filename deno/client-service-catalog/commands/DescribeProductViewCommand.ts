...
import { DescribeProductViewInput, DescribeProductViewOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceCatalogClient, DescribeProductViewCommand } from "../../client-service-catalog/mod.ts";
