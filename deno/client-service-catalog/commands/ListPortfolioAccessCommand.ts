...
import { ListPortfolioAccessInput, ListPortfolioAccessOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceCatalogClient, ListPortfolioAccessCommand } from "../../client-service-catalog/mod.ts";
