...
import { DescribePortfolioInput, DescribePortfolioOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceCatalogClient, DescribePortfolioCommand } from "../../client-service-catalog/mod.ts";
