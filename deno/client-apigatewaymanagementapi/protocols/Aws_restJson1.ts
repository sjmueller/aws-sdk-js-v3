...
} from "../commands/PostToConnectionCommand.ts";
import {
  ForbiddenException,
  GoneException,
  Identity,
...
export const deserializeAws_restJson1DeleteConnectionCommand = async (
  ...
  if (output.statusCode !== 204 && output.statusCode >= 400) {
    return deserializeAws_restJson1DeleteConnectionCommandError(
      output,
      context
    );
  }
...
export const deserializeAws_restJson1GetConnectionCommand = async (
  ...
  if (data.identity !== undefined && data.identity !== null) {
    contents.Identity = deserializeAws_restJson1Identity(
      data.identity,
      context
    );
  }
...
export const deserializeAws_restJson1PostToConnectionCommand = async (
  ...
  if (output.statusCode !== 200 && output.statusCode >= 400) {
    return deserializeAws_restJson1PostToConnectionCommandError(
      output,
      context
    );
  }
...
const deserializeAws_restJson1PostToConnectionCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.apigatewaymanagementapi#PayloadTooLargeException":
      response = {
        ...(await deserializeAws_restJson1PayloadTooLargeExceptionResponse(
          parsedOutput,
          context
        )),
        name: errorCode,
