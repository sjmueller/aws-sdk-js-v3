...
import { DeregisterRobotRequest, DeregisterRobotResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RoboMakerClient, DeregisterRobotCommand } from "../../client-robomaker/mod.ts";
