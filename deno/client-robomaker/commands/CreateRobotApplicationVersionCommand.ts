...
import { CreateRobotApplicationVersionRequest, CreateRobotApplicationVersionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RoboMakerClient, CreateRobotApplicationVersionCommand } from "../../client-robomaker/mod.ts";
