...
export type CreateRobotApplicationVersionCommandOutput = CreateRobotApplicationVersionResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1CreateRobotApplicationVersionCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1CreateRobotApplicationVersionCommand(
      output,
      context
    );
  }
