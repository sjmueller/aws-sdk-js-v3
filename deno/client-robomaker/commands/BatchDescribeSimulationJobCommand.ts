...
import { BatchDescribeSimulationJobRequest, BatchDescribeSimulationJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RoboMakerClient, BatchDescribeSimulationJobCommand } from "../../client-robomaker/mod.ts";
