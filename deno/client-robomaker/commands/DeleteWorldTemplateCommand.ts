...
import { DeleteWorldTemplateRequest, DeleteWorldTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RoboMakerClient, DeleteWorldTemplateCommand } from "../../client-robomaker/mod.ts";
