...
import { DescribeWorldTemplateRequest, DescribeWorldTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RoboMakerClient, DescribeWorldTemplateCommand } from "../../client-robomaker/mod.ts";
