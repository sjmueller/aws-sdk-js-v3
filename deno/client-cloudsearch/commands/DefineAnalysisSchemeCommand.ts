...
import { DefineAnalysisSchemeRequest, DefineAnalysisSchemeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudSearchClient, DefineAnalysisSchemeCommand } from "../../client-cloudsearch/mod.ts";
