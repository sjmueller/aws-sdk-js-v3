...
import { DefineExpressionRequest, DefineExpressionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudSearchClient, DefineExpressionCommand } from "../../client-cloudsearch/mod.ts";
