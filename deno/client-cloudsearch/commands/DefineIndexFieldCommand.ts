...
import { DefineIndexFieldRequest, DefineIndexFieldResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudSearchClient, DefineIndexFieldCommand } from "../../client-cloudsearch/mod.ts";
