...
import { GetContactPolicyRequest, GetContactPolicyResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMContactsClient, GetContactPolicyCommand } from "../../client-ssm-contacts/mod.ts";
