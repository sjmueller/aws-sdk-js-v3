...
import { DeleteContactChannelRequest, DeleteContactChannelResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMContactsClient, DeleteContactChannelCommand } from "../../client-ssm-contacts/mod.ts";
