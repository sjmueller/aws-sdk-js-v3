...
import { DeactivateContactChannelRequest, DeactivateContactChannelResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMContactsClient, DeactivateContactChannelCommand } from "../../client-ssm-contacts/mod.ts";
