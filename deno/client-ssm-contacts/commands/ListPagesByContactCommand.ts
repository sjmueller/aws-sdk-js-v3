...
import { ListPagesByContactRequest, ListPagesByContactResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMContactsClient, ListPagesByContactCommand } from "../../client-ssm-contacts/mod.ts";
