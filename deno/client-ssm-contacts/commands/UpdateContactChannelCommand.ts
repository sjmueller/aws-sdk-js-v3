...
import { UpdateContactChannelRequest, UpdateContactChannelResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMContactsClient, UpdateContactChannelCommand } from "../../client-ssm-contacts/mod.ts";
