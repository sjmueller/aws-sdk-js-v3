...
import { UpdatePublishingDestinationRequest, UpdatePublishingDestinationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GuardDutyClient, UpdatePublishingDestinationCommand } from "../../client-guardduty/mod.ts";
