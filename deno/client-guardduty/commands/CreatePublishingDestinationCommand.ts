...
import { CreatePublishingDestinationRequest, CreatePublishingDestinationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GuardDutyClient, CreatePublishingDestinationCommand } from "../../client-guardduty/mod.ts";
