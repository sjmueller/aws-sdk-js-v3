...
import { CreateThreatIntelSetRequest, CreateThreatIntelSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GuardDutyClient, CreateThreatIntelSetCommand } from "../../client-guardduty/mod.ts";
