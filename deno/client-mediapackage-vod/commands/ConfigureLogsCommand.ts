...
import { ConfigureLogsRequest, ConfigureLogsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaPackageVodClient, ConfigureLogsCommand } from "../../client-mediapackage-vod/mod.ts";
