...
import { PutReportDefinitionRequest, PutReportDefinitionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CostAndUsageReportServiceClient, PutReportDefinitionCommand } from "../../client-cost-and-usage-report-service/mod.ts";
