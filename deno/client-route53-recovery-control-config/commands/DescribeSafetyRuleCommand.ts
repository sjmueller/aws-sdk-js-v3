...
import { DescribeSafetyRuleRequest, DescribeSafetyRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, DescribeSafetyRuleCommand } from "../../client-route53-recovery-control-config/mod.ts";
