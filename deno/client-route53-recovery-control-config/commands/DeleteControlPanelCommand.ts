...
import { DeleteControlPanelRequest, DeleteControlPanelResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, DeleteControlPanelCommand } from "../../client-route53-recovery-control-config/mod.ts";
