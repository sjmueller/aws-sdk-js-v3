...
import { ListSafetyRulesRequest, ListSafetyRulesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, ListSafetyRulesCommand } from "../../client-route53-recovery-control-config/mod.ts";
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: ListSafetyRulesRequest.filterSensitiveLog,
      outputFilterSensitiveLog: ListSafetyRulesResponse.filterSensitiveLog,
    };
