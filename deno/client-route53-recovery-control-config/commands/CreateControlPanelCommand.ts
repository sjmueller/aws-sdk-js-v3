...
import { CreateControlPanelRequest, CreateControlPanelResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, CreateControlPanelCommand } from "../../client-route53-recovery-control-config/mod.ts";
