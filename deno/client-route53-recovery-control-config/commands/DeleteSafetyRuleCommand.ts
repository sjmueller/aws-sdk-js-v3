...
import { DeleteSafetyRuleRequest, DeleteSafetyRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, DeleteSafetyRuleCommand } from "../../client-route53-recovery-control-config/mod.ts";
