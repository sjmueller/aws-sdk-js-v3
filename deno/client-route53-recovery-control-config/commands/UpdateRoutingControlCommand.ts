...
import { UpdateRoutingControlRequest, UpdateRoutingControlResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, UpdateRoutingControlCommand } from "../../client-route53-recovery-control-config/mod.ts";
