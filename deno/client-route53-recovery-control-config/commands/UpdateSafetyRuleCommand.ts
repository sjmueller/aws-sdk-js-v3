...
import { UpdateSafetyRuleRequest, UpdateSafetyRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, UpdateSafetyRuleCommand } from "../../client-route53-recovery-control-config/mod.ts";
