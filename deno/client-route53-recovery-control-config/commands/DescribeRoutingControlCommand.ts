...
import { DescribeRoutingControlRequest, DescribeRoutingControlResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, DescribeRoutingControlCommand } from "../../client-route53-recovery-control-config/mod.ts";
