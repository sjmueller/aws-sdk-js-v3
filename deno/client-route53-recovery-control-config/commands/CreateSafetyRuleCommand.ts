...
import { CreateSafetyRuleRequest, CreateSafetyRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, CreateSafetyRuleCommand } from "../../client-route53-recovery-control-config/mod.ts";
