...
import { CreateRoutingControlRequest, CreateRoutingControlResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryControlConfigClient, CreateRoutingControlCommand } from "../../client-route53-recovery-control-config/mod.ts";
