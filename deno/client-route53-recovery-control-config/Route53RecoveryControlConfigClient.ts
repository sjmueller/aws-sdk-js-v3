...
import { CreateControlPanelCommandInput, CreateControlPanelCommandOutput } from "./commands/CreateControlPanelCommand.ts";
import {
  CreateRoutingControlCommandInput,
  CreateRoutingControlCommandOutput,
} from "./commands/CreateRoutingControlCommand.ts";
import { CreateSafetyRuleCommandInput, CreateSafetyRuleCommandOutput } from "./commands/CreateSafetyRuleCommand.ts";
import { DeleteClusterCommandInput, DeleteClusterCommandOutput } from "./commands/DeleteClusterCommand.ts";
import { DeleteControlPanelCommandInput, DeleteControlPanelCommandOutput } from "./commands/DeleteControlPanelCommand.ts";
import {
  DeleteRoutingControlCommandInput,
  DeleteRoutingControlCommandOutput,
} from "./commands/DeleteRoutingControlCommand.ts";
import { DeleteSafetyRuleCommandInput, DeleteSafetyRuleCommandOutput } from "./commands/DeleteSafetyRuleCommand.ts";
...
} from "./commands/DescribeControlPanelCommand.ts";
import {
  DescribeRoutingControlCommandInput,
  DescribeRoutingControlCommandOutput,
} from "./commands/DescribeRoutingControlCommand.ts";
import { DescribeSafetyRuleCommandInput, DescribeSafetyRuleCommandOutput } from "./commands/DescribeSafetyRuleCommand.ts";
import {
...
import { ListControlPanelsCommandInput, ListControlPanelsCommandOutput } from "./commands/ListControlPanelsCommand.ts";
import {
  ListRoutingControlsCommandInput,
  ListRoutingControlsCommandOutput,
} from "./commands/ListRoutingControlsCommand.ts";
import { ListSafetyRulesCommandInput, ListSafetyRulesCommandOutput } from "./commands/ListSafetyRulesCommand.ts";
import { UpdateControlPanelCommandInput, UpdateControlPanelCommandOutput } from "./commands/UpdateControlPanelCommand.ts";
import {
  UpdateRoutingControlCommandInput,
  UpdateRoutingControlCommandOutput,
} from "./commands/UpdateRoutingControlCommand.ts";
import { UpdateSafetyRuleCommandInput, UpdateSafetyRuleCommandOutput } from "./commands/UpdateSafetyRuleCommand.ts";
...
type Route53RecoveryControlConfigClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
  EndpointsInputConfig &
  RetryInputConfig &
...
type Route53RecoveryControlConfigClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
