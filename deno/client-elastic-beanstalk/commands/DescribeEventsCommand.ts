...
import { DescribeEventsMessage, EventDescriptionsMessage } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticBeanstalkClient, DescribeEventsCommand } from "../../client-elastic-beanstalk/mod.ts";
