...
import { DescribeAccountAttributesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticBeanstalkClient, DescribeAccountAttributesCommand } from "../../client-elastic-beanstalk/mod.ts";
