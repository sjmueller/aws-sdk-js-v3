...
import { SwapEnvironmentCNAMEsMessage } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticBeanstalkClient, SwapEnvironmentCNAMEsCommand } from "../../client-elastic-beanstalk/mod.ts";
