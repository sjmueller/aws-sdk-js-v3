...
import { EnvironmentDescription, UpdateEnvironmentMessage } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticBeanstalkClient, UpdateEnvironmentCommand } from "../../client-elastic-beanstalk/mod.ts";
