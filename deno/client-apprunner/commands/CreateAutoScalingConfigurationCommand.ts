...
import { CreateAutoScalingConfigurationRequest, CreateAutoScalingConfigurationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AppRunnerClient, CreateAutoScalingConfigurationCommand } from "../../client-apprunner/mod.ts";
