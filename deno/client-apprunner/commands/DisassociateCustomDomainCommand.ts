...
import { DisassociateCustomDomainRequest, DisassociateCustomDomainResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AppRunnerClient, DisassociateCustomDomainCommand } from "../../client-apprunner/mod.ts";
