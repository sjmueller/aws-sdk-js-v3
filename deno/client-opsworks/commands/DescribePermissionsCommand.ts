...
import { DescribePermissionsRequest, DescribePermissionsResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OpsWorksClient, DescribePermissionsCommand } from "../../client-opsworks/mod.ts";
