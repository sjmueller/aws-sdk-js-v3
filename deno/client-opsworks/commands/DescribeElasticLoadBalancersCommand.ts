...
import { DescribeElasticLoadBalancersRequest, DescribeElasticLoadBalancersResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OpsWorksClient, DescribeElasticLoadBalancersCommand } from "../../client-opsworks/mod.ts";
