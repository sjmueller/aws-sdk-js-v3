...
import { DescribeDeploymentsRequest, DescribeDeploymentsResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OpsWorksClient, DescribeDeploymentsCommand } from "../../client-opsworks/mod.ts";
