...
export type DescribeTimeBasedAutoScalingCommandOutput = DescribeTimeBasedAutoScalingResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeTimeBasedAutoScalingCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeTimeBasedAutoScalingCommand(
      output,
      context
    );
  }
