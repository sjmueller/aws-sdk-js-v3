...
import { DescribeEcsClustersRequest, DescribeEcsClustersResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OpsWorksClient, DescribeEcsClustersCommand } from "../../client-opsworks/mod.ts";
