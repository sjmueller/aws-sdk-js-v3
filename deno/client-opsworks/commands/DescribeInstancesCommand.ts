...
import { DescribeInstancesRequest, DescribeInstancesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OpsWorksClient, DescribeInstancesCommand } from "../../client-opsworks/mod.ts";
