...
import { StopStackRequest } from "../models/models_0.ts";
import { deserializeAws_json1_1StopStackCommand, serializeAws_json1_1StopStackCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { OpsWorksClient, StopStackCommand } from "../../client-opsworks/mod.ts";
