...
import { RegisterEcsClusterRequest, RegisterEcsClusterResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { OpsWorksClient, RegisterEcsClusterCommand } from "../../client-opsworks/mod.ts";
