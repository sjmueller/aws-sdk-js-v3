...
import { DeleteVpcPeeringConnectionInput, DeleteVpcPeeringConnectionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, DeleteVpcPeeringConnectionCommand } from "../../client-gamelift/mod.ts";
