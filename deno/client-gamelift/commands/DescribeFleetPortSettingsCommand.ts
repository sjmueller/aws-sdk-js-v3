...
import { DescribeFleetPortSettingsInput, DescribeFleetPortSettingsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, DescribeFleetPortSettingsCommand } from "../../client-gamelift/mod.ts";
