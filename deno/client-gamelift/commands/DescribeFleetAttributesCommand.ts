...
import { DescribeFleetAttributesInput, DescribeFleetAttributesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, DescribeFleetAttributesCommand } from "../../client-gamelift/mod.ts";
