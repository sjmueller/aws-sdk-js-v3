...
import { CreateGameServerGroupInput, CreateGameServerGroupOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, CreateGameServerGroupCommand } from "../../client-gamelift/mod.ts";
