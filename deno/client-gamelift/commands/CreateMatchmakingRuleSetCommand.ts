...
import { CreateMatchmakingRuleSetInput, CreateMatchmakingRuleSetOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, CreateMatchmakingRuleSetCommand } from "../../client-gamelift/mod.ts";
