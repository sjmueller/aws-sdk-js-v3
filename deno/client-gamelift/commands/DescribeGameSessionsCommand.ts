...
import { DescribeGameSessionsInput, DescribeGameSessionsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, DescribeGameSessionsCommand } from "../../client-gamelift/mod.ts";
