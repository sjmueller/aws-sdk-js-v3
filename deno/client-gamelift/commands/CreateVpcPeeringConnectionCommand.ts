...
import { CreateVpcPeeringConnectionInput, CreateVpcPeeringConnectionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, CreateVpcPeeringConnectionCommand } from "../../client-gamelift/mod.ts";
