...
import { UpdateFleetCapacityInput, UpdateFleetCapacityOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, UpdateFleetCapacityCommand } from "../../client-gamelift/mod.ts";
