...
import { CreatePlayerSessionInput, CreatePlayerSessionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, CreatePlayerSessionCommand } from "../../client-gamelift/mod.ts";
