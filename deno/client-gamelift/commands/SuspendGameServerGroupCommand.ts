...
import { SuspendGameServerGroupInput, SuspendGameServerGroupOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, SuspendGameServerGroupCommand } from "../../client-gamelift/mod.ts";
