...
import { DescribeFleetEventsInput, DescribeFleetEventsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, DescribeFleetEventsCommand } from "../../client-gamelift/mod.ts";
