...
import { DescribeMatchmakingRuleSetsInput, DescribeMatchmakingRuleSetsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, DescribeMatchmakingRuleSetsCommand } from "../../client-gamelift/mod.ts";
