...
import { DeleteGameServerGroupInput, DeleteGameServerGroupOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, DeleteGameServerGroupCommand } from "../../client-gamelift/mod.ts";
