...
import { SearchGameSessionsInput, SearchGameSessionsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, SearchGameSessionsCommand } from "../../client-gamelift/mod.ts";
