...
import { CreateGameSessionQueueInput, CreateGameSessionQueueOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, CreateGameSessionQueueCommand } from "../../client-gamelift/mod.ts";
