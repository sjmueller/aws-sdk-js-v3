...
} from "../commands/GetSessionCommand.ts";
import {
...
} from "../commands/PostTextCommand.ts";
import {
  PutSessionCommandInput,
  PutSessionCommandOutput
} from "../commands/PutSessionCommand.ts";
import {
  BadGatewayException,
  BadRequestException,
  Button,
...
export const serializeAws_restJson1PostTextCommand = async (
  ...
  body = JSON.stringify({
    ...
    ...(input.requestAttributes !== undefined && {
      requestAttributes: serializeAws_restJson1StringMap(
        input.requestAttributes,
        context
      )
    }),
    ...(input.sessionAttributes !== undefined && {
      sessionAttributes: serializeAws_restJson1StringMap(
        input.sessionAttributes,
        context
      )
    })
...
export const deserializeAws_restJson1GetSessionCommand = async (
  ...
  if (data.dialogAction !== undefined && data.dialogAction !== null) {
    contents.dialogAction = deserializeAws_restJson1DialogAction(
      data.dialogAction,
      context
    );
  }
  if (
    ...
    contents.recentIntentSummaryView = deserializeAws_restJson1IntentSummaryList(
      data.recentIntentSummaryView,
      context
    );
  }
  if (data.sessionAttributes !== undefined && data.sessionAttributes !== null) {
    contents.sessionAttributes = deserializeAws_restJson1StringMap(
...
const deserializeAws_restJson1PostContentCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.lexruntimeservice#DependencyFailedException":
      response = {
        ...(await deserializeAws_restJson1DependencyFailedExceptionResponse(
          parsedOutput,
          context
        )),
        name: errorCode,
    ...
    case "com.amazonaws.lexruntimeservice#LoopDetectedException":
      response = {
        ...(await deserializeAws_restJson1LoopDetectedExceptionResponse(
          parsedOutput,
          context
        )),
        name: errorCode,
    ...
    case "com.amazonaws.lexruntimeservice#NotAcceptableException":
      response = {
        ...(await deserializeAws_restJson1NotAcceptableExceptionResponse(
          parsedOutput,
          context
        )),
        name: errorCode,
...
export const deserializeAws_restJson1PostTextCommand = async (
  ...
  if (data.responseCard !== undefined && data.responseCard !== null) {
    contents.responseCard = deserializeAws_restJson1ResponseCard(
      data.responseCard,
      context
    );
  }
  if (data.sentimentResponse !== undefined && data.sentimentResponse !== null) {
    contents.sentimentResponse = deserializeAws_restJson1SentimentResponse(
...
const serializeAws_restJson1DialogAction = (
  input: DialogAction,
  context: __SerdeContext
): any => {
  return {
...
const serializeAws_restJson1IntentSummary = (
  input: IntentSummary,
  context: __SerdeContext
): any => {
  return {
...
const serializeAws_restJson1IntentSummaryList = (
  input: IntentSummary[],
  context: __SerdeContext
): any => {
  return input.map(entry =>
    serializeAws_restJson1IntentSummary(entry, context)
  );
};
...
const deserializeAws_restJson1Button = (
  output: any,
  context: __SerdeContext
): Button => {
  return {
...
const deserializeAws_restJson1DialogAction = (
  output: any,
  context: __SerdeContext
): DialogAction => {
  return {
...
const deserializeAws_restJson1GenericAttachment = (
  output: any,
  context: __SerdeContext
): GenericAttachment => {
  return {
...
const deserializeAws_restJson1genericAttachmentList = (
  ...
  return (output || []).map((entry: any) =>
    deserializeAws_restJson1GenericAttachment(entry, context)
  );
};

const deserializeAws_restJson1IntentSummary = (
  output: any,
  context: __SerdeContext
): IntentSummary => {
  return {
...
const deserializeAws_restJson1IntentSummaryList = (
  output: any,
  context: __SerdeContext
): IntentSummary[] => {
  return (output || []).map((entry: any) =>
    deserializeAws_restJson1IntentSummary(entry, context)
  );
};

const deserializeAws_restJson1listOfButtons = (
  output: any,
  context: __SerdeContext
): Button[] => {
  return (output || []).map((entry: any) =>
    deserializeAws_restJson1Button(entry, context)
  );
};

const deserializeAws_restJson1ResponseCard = (
  output: any,
  context: __SerdeContext
): ResponseCard => {
  return {
...
const deserializeAws_restJson1SentimentResponse = (
  output: any,
  context: __SerdeContext
): SentimentResponse => {
  return {
...
const deserializeAws_restJson1StringMap = (
  output: any,
  context: __SerdeContext
): { [key: string]: string } => {
