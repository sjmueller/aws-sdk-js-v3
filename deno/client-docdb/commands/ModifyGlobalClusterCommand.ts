...
import { ModifyGlobalClusterMessage, ModifyGlobalClusterResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DocDBClient, ModifyGlobalClusterCommand } from "../../client-docdb/mod.ts";
