 ...
 * ```javascript
 * import { CommanderClient, UntagResourceCommand } from "../../client-commander/mod.ts";
 * // const { CommanderClient, UntagResourceCommand } = require("@aws-sdk/client-commander"); // CommonJS import
