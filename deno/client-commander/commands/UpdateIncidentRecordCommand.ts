...
import { UpdateIncidentRecordInput, UpdateIncidentRecordOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CommanderClient, UpdateIncidentRecordCommand } from "../../client-commander/mod.ts";
