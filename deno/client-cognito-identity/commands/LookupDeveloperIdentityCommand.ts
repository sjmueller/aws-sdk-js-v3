...
import { LookupDeveloperIdentityInput, LookupDeveloperIdentityResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityClient, LookupDeveloperIdentityCommand } from "../../client-cognito-identity/mod.ts";
