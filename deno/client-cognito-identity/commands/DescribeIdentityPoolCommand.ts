...
import { DescribeIdentityPoolInput, IdentityPool } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityClient, DescribeIdentityPoolCommand } from "../../client-cognito-identity/mod.ts";
