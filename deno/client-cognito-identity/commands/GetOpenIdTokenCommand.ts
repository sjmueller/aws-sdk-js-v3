...
import { GetOpenIdTokenInput, GetOpenIdTokenResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityClient, GetOpenIdTokenCommand } from "../../client-cognito-identity/mod.ts";
