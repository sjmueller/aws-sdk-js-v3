...
import { GetIdentityPoolRolesInput, GetIdentityPoolRolesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CognitoIdentityClient, GetIdentityPoolRolesCommand } from "../../client-cognito-identity/mod.ts";
