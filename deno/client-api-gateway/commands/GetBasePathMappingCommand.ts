...
import { BasePathMapping, GetBasePathMappingRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { APIGatewayClient, GetBasePathMappingCommand } from "../../client-api-gateway/mod.ts";
