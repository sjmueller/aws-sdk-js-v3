...
import { GetRequestValidatorRequest, RequestValidator } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { APIGatewayClient, GetRequestValidatorCommand } from "../../client-api-gateway/mod.ts";
