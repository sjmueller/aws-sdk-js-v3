...
import { IntegrationResponse, PutIntegrationResponseRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { APIGatewayClient, PutIntegrationResponseCommand } from "../../client-api-gateway/mod.ts";
