...
import { BasePathMappings, GetBasePathMappingsRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { APIGatewayClient, GetBasePathMappingsCommand } from "../../client-api-gateway/mod.ts";
