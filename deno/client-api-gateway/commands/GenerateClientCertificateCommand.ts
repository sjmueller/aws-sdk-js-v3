...
import { ClientCertificate, GenerateClientCertificateRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { APIGatewayClient, GenerateClientCertificateCommand } from "../../client-api-gateway/mod.ts";
