...
import { GatewayResponses, GetGatewayResponsesRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { APIGatewayClient, GetGatewayResponsesCommand } from "../../client-api-gateway/mod.ts";
