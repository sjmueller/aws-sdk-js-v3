...
import { CreateSecretRequest, CreateSecretResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SecretsManagerClient, CreateSecretCommand } from "../../client-secrets-manager/mod.ts";
