...
import { DeleteResourcePolicyRequest, DeleteResourcePolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SecretsManagerClient, DeleteResourcePolicyCommand } from "../../client-secrets-manager/mod.ts";
