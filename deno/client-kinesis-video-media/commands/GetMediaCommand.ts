import {
  ...
  ServiceInputTypes,
  ServiceOutputTypes,
} from "../KinesisVideoMediaClient.ts";
import { GetMediaInput, GetMediaOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KinesisVideoMediaClient, GetMediaCommand } from "../../client-kinesis-video-media/mod.ts";
