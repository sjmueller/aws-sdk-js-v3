...
import { DeletePredictorBacktestExportJobRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ForecastClient, DeletePredictorBacktestExportJobCommand } from "../../client-forecast/mod.ts";
