...
import { DescribePredictorRequest, DescribePredictorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ForecastClient, DescribePredictorCommand } from "../../client-forecast/mod.ts";
