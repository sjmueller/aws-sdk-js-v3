...
import { CreateForecastExportJobRequest, CreateForecastExportJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ForecastClient, CreateForecastExportJobCommand } from "../../client-forecast/mod.ts";
