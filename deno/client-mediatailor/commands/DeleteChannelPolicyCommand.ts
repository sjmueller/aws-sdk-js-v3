...
import { DeleteChannelPolicyRequest, DeleteChannelPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaTailorClient, DeleteChannelPolicyCommand } from "../../client-mediatailor/mod.ts";
