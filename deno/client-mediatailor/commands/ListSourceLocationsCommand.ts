...
import { ListSourceLocationsRequest, ListSourceLocationsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaTailorClient, ListSourceLocationsCommand } from "../../client-mediatailor/mod.ts";
