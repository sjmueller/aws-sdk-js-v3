...
import { PutChannelPolicyRequest, PutChannelPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaTailorClient, PutChannelPolicyCommand } from "../../client-mediatailor/mod.ts";
