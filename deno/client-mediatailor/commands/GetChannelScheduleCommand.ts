...
import { GetChannelScheduleRequest, GetChannelScheduleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaTailorClient, GetChannelScheduleCommand } from "../../client-mediatailor/mod.ts";
