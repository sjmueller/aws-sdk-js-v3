...
import { DeleteSourceLocationRequest, DeleteSourceLocationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaTailorClient, DeleteSourceLocationCommand } from "../../client-mediatailor/mod.ts";
