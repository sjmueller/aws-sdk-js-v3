...
import { UpdateSourceLocationRequest, UpdateSourceLocationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaTailorClient, UpdateSourceLocationCommand } from "../../client-mediatailor/mod.ts";
