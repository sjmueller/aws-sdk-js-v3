...
import { UpdateVodSourceRequest, UpdateVodSourceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaTailorClient, UpdateVodSourceCommand } from "../../client-mediatailor/mod.ts";
