...
import { ListVodSourcesRequest, ListVodSourcesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaTailorClient, ListVodSourcesCommand } from "../../client-mediatailor/mod.ts";
