...
import { DeleteVodSourceRequest, DeleteVodSourceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaTailorClient, DeleteVodSourceCommand } from "../../client-mediatailor/mod.ts";
