...
import { CreateSolutionVersionRequest, CreateSolutionVersionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PersonalizeClient, CreateSolutionVersionCommand } from "../../client-personalize/mod.ts";
