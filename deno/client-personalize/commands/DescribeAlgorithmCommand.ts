...
import { DescribeAlgorithmRequest, DescribeAlgorithmResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PersonalizeClient, DescribeAlgorithmCommand } from "../../client-personalize/mod.ts";
