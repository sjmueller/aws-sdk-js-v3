...
import { DeregisterTypeInput, DeregisterTypeOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFormationClient, DeregisterTypeCommand } from "../../client-cloudformation/mod.ts";
