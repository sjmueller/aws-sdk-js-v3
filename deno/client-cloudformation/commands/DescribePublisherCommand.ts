...
import { DescribePublisherInput, DescribePublisherOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFormationClient, DescribePublisherCommand } from "../../client-cloudformation/mod.ts";
