...
import { ActivateTypeInput, ActivateTypeOutput } from "../models/models_0.ts";
import { deserializeAws_queryActivateTypeCommand, serializeAws_queryActivateTypeCommand } from "../protocols/Aws_query.ts";
 ...
 * ```javascript
 * import { CloudFormationClient, ActivateTypeCommand } from "../../client-cloudformation/mod.ts";
