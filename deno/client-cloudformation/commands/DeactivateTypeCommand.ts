...
import { DeactivateTypeInput, DeactivateTypeOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudFormationClient, DeactivateTypeCommand } from "../../client-cloudformation/mod.ts";
