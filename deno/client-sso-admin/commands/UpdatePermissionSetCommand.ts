...
import { UpdatePermissionSetRequest, UpdatePermissionSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSOAdminClient, UpdatePermissionSetCommand } from "../../client-sso-admin/mod.ts";
