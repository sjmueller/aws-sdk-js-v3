...
import { DescribePermissionSetRequest, DescribePermissionSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSOAdminClient, DescribePermissionSetCommand } from "../../client-sso-admin/mod.ts";
