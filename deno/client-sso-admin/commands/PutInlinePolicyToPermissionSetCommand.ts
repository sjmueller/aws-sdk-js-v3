...
import { PutInlinePolicyToPermissionSetRequest, PutInlinePolicyToPermissionSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSOAdminClient, PutInlinePolicyToPermissionSetCommand } from "../../client-sso-admin/mod.ts";
