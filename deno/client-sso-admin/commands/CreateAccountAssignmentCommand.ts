...
import { CreateAccountAssignmentRequest, CreateAccountAssignmentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSOAdminClient, CreateAccountAssignmentCommand } from "../../client-sso-admin/mod.ts";
