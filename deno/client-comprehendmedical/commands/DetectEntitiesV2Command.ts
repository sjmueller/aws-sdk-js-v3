...
import { DetectEntitiesV2Request, DetectEntitiesV2Response } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ComprehendMedicalClient, DetectEntitiesV2Command } from "../../client-comprehendmedical/mod.ts";
