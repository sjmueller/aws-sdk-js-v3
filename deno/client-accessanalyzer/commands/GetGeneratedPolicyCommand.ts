...
import { GetGeneratedPolicyRequest, GetGeneratedPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AccessAnalyzerClient, GetGeneratedPolicyCommand } from "../../client-accessanalyzer/mod.ts";
