...
import { ListArchiveRulesRequest, ListArchiveRulesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AccessAnalyzerClient, ListArchiveRulesCommand } from "../../client-accessanalyzer/mod.ts";
