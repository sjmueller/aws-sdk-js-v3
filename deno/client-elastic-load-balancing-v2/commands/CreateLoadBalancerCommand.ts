...
import { CreateLoadBalancerInput, CreateLoadBalancerOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticLoadBalancingV2Client, CreateLoadBalancerCommand } from "../../client-elastic-load-balancing-v2/mod.ts";
