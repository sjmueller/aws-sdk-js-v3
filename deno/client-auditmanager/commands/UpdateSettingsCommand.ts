...
import { UpdateSettingsRequest, UpdateSettingsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AuditManagerClient, UpdateSettingsCommand } from "../../client-auditmanager/mod.ts";
