...
import { DeleteAssessmentReportRequest, DeleteAssessmentReportResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AuditManagerClient, DeleteAssessmentReportCommand } from "../../client-auditmanager/mod.ts";
