...
import { RegisterAccountRequest, RegisterAccountResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AuditManagerClient, RegisterAccountCommand } from "../../client-auditmanager/mod.ts";
