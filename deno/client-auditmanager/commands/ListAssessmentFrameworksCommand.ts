...
import { ListAssessmentFrameworksRequest, ListAssessmentFrameworksResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AuditManagerClient, ListAssessmentFrameworksCommand } from "../../client-auditmanager/mod.ts";
