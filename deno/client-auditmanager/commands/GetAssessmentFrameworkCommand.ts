...
import { GetAssessmentFrameworkRequest, GetAssessmentFrameworkResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AuditManagerClient, GetAssessmentFrameworkCommand } from "../../client-auditmanager/mod.ts";
