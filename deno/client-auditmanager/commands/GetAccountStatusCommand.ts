...
import { GetAccountStatusRequest, GetAccountStatusResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AuditManagerClient, GetAccountStatusCommand } from "../../client-auditmanager/mod.ts";
