...
import { CreateAssessmentFrameworkRequest, CreateAssessmentFrameworkResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AuditManagerClient, CreateAssessmentFrameworkCommand } from "../../client-auditmanager/mod.ts";
