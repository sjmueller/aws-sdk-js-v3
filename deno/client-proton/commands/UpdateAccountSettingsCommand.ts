...
import { UpdateAccountSettingsInput, UpdateAccountSettingsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, UpdateAccountSettingsCommand } from "../../client-proton/mod.ts";
