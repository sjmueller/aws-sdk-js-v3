...
import { ListServiceTemplateVersionsInput, ListServiceTemplateVersionsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, ListServiceTemplateVersionsCommand } from "../../client-proton/mod.ts";
