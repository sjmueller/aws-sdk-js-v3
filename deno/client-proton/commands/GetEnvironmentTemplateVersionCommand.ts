...
import { GetEnvironmentTemplateVersionInput, GetEnvironmentTemplateVersionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, GetEnvironmentTemplateVersionCommand } from "../../client-proton/mod.ts";
