...
import { CancelServicePipelineDeploymentInput, CancelServicePipelineDeploymentOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, CancelServicePipelineDeploymentCommand } from "../../client-proton/mod.ts";
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: CancelServicePipelineDeploymentInput.filterSensitiveLog,
      outputFilterSensitiveLog: CancelServicePipelineDeploymentOutput.filterSensitiveLog,
    };
