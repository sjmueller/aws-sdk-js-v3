...
import { GetServiceInstanceInput, GetServiceInstanceOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, GetServiceInstanceCommand } from "../../client-proton/mod.ts";
