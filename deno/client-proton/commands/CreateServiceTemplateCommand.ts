...
import { CreateServiceTemplateInput, CreateServiceTemplateOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, CreateServiceTemplateCommand } from "../../client-proton/mod.ts";
