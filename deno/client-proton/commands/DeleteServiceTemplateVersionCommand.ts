...
import { DeleteServiceTemplateVersionInput, DeleteServiceTemplateVersionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, DeleteServiceTemplateVersionCommand } from "../../client-proton/mod.ts";
