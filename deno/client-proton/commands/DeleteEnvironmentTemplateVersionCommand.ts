...
import { DeleteEnvironmentTemplateVersionInput, DeleteEnvironmentTemplateVersionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, DeleteEnvironmentTemplateVersionCommand } from "../../client-proton/mod.ts";
