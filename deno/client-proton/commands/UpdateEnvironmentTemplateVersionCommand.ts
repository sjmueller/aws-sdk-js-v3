...
import { UpdateEnvironmentTemplateVersionInput, UpdateEnvironmentTemplateVersionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, UpdateEnvironmentTemplateVersionCommand } from "../../client-proton/mod.ts";
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: UpdateEnvironmentTemplateVersionInput.filterSensitiveLog,
      outputFilterSensitiveLog: UpdateEnvironmentTemplateVersionOutput.filterSensitiveLog,
    };
