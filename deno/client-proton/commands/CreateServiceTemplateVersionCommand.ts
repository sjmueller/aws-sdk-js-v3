...
import { CreateServiceTemplateVersionInput, CreateServiceTemplateVersionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, CreateServiceTemplateVersionCommand } from "../../client-proton/mod.ts";
