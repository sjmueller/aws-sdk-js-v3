...
import { UpdateServicePipelineInput, UpdateServicePipelineOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, UpdateServicePipelineCommand } from "../../client-proton/mod.ts";
