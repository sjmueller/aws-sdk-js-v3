...
import { CreateEnvironmentTemplateInput, CreateEnvironmentTemplateOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ProtonClient, CreateEnvironmentTemplateCommand } from "../../client-proton/mod.ts";
