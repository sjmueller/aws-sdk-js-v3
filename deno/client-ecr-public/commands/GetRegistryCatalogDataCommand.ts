...
export type GetRegistryCatalogDataCommandInput = GetRegistryCatalogDataRequest;
export type GetRegistryCatalogDataCommandOutput = GetRegistryCatalogDataResponse & __MetadataBearer;
