...
import { DescribeRegistriesRequest, DescribeRegistriesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ECRPUBLICClient, DescribeRegistriesCommand } from "../../client-ecr-public/mod.ts";
