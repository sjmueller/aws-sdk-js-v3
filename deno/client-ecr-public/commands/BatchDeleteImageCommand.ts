...
import { BatchDeleteImageRequest, BatchDeleteImageResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ECRPUBLICClient, BatchDeleteImageCommand } from "../../client-ecr-public/mod.ts";
