...
import { UploadLayerPartRequest, UploadLayerPartResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ECRPUBLICClient, UploadLayerPartCommand } from "../../client-ecr-public/mod.ts";
