...
import { UpdateEndpointGroupRequest, UpdateEndpointGroupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlobalAcceleratorClient, UpdateEndpointGroupCommand } from "../../client-global-accelerator/mod.ts";
