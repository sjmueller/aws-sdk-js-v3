...
import { WithdrawByoipCidrRequest, WithdrawByoipCidrResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlobalAcceleratorClient, WithdrawByoipCidrCommand } from "../../client-global-accelerator/mod.ts";
