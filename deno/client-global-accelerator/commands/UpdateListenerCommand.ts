...
import { UpdateListenerRequest, UpdateListenerResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlobalAcceleratorClient, UpdateListenerCommand } from "../../client-global-accelerator/mod.ts";
