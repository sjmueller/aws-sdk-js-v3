...
import { ListAcceleratorsRequest, ListAcceleratorsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlobalAcceleratorClient, ListAcceleratorsCommand } from "../../client-global-accelerator/mod.ts";
