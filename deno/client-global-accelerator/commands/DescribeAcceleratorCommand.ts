...
import { DescribeAcceleratorRequest, DescribeAcceleratorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlobalAcceleratorClient, DescribeAcceleratorCommand } from "../../client-global-accelerator/mod.ts";
