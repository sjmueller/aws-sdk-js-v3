...
import { DeleteCustomRoutingAcceleratorRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlobalAcceleratorClient, DeleteCustomRoutingAcceleratorCommand } from "../../client-global-accelerator/mod.ts";
