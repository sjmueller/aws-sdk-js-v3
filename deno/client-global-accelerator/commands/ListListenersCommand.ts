...
import { ListListenersRequest, ListListenersResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlobalAcceleratorClient, ListListenersCommand } from "../../client-global-accelerator/mod.ts";
