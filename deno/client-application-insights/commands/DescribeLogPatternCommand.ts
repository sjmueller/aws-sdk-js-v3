...
import { DescribeLogPatternRequest, DescribeLogPatternResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApplicationInsightsClient, DescribeLogPatternCommand } from "../../client-application-insights/mod.ts";
