...
import { ListLogPatternSetsRequest, ListLogPatternSetsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApplicationInsightsClient, ListLogPatternSetsCommand } from "../../client-application-insights/mod.ts";
