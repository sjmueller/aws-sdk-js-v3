...
import { GrantFlowEntitlementsRequest, GrantFlowEntitlementsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MediaConnectClient, GrantFlowEntitlementsCommand } from "../../client-mediaconnect/mod.ts";
