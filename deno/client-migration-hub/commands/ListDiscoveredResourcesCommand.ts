...
import { ListDiscoveredResourcesRequest, ListDiscoveredResourcesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MigrationHubClient, ListDiscoveredResourcesCommand } from "../../client-migration-hub/mod.ts";
