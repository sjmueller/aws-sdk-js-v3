...
import { GetResourceCollectionRequest, GetResourceCollectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DevOpsGuruClient, GetResourceCollectionCommand } from "../../client-devops-guru/mod.ts";
