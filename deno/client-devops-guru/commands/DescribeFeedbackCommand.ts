...
import { DescribeFeedbackRequest, DescribeFeedbackResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DevOpsGuruClient, DescribeFeedbackCommand } from "../../client-devops-guru/mod.ts";
