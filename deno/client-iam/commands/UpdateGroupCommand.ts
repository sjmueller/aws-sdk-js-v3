...
import { UpdateGroupRequest } from "../models/models_1.ts";
import { deserializeAws_queryUpdateGroupCommand, serializeAws_queryUpdateGroupCommand } from "../protocols/Aws_query.ts";
 ...
 * ```javascript
 * import { IAMClient, UpdateGroupCommand } from "../../client-iam/mod.ts";
