...
import { TagMFADeviceRequest } from "../models/models_0.ts";
import { deserializeAws_queryTagMFADeviceCommand, serializeAws_queryTagMFADeviceCommand } from "../protocols/Aws_query.ts";
 ...
 * ```javascript
 * import { IAMClient, TagMFADeviceCommand } from "../../client-iam/mod.ts";
