...
import { TagPolicyRequest } from "../models/models_0.ts";
import { deserializeAws_queryTagPolicyCommand, serializeAws_queryTagPolicyCommand } from "../protocols/Aws_query.ts";
 ...
 * ```javascript
 * import { IAMClient, TagPolicyCommand } from "../../client-iam/mod.ts";
