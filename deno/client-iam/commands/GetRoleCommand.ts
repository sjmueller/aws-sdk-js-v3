...
import { GetRoleRequest, GetRoleResponse } from "../models/models_0.ts";
import { deserializeAws_queryGetRoleCommand, serializeAws_queryGetRoleCommand } from "../protocols/Aws_query.ts";
 ...
 * ```javascript
 * import { IAMClient, GetRoleCommand } from "../../client-iam/mod.ts";
