...
import { GetContextKeysForPolicyResponse, GetContextKeysForPrincipalPolicyRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IAMClient, GetContextKeysForPrincipalPolicyCommand } from "../../client-iam/mod.ts";
