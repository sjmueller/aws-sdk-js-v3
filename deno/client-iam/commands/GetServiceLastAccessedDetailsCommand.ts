...
import { GetServiceLastAccessedDetailsRequest, GetServiceLastAccessedDetailsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IAMClient, GetServiceLastAccessedDetailsCommand } from "../../client-iam/mod.ts";
