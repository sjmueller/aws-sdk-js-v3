...
import { GetContextKeysForCustomPolicyRequest, GetContextKeysForPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IAMClient, GetContextKeysForCustomPolicyCommand } from "../../client-iam/mod.ts";
