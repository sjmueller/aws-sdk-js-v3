...
import { ListUserTagsRequest, ListUserTagsResponse } from "../models/models_0.ts";
import { deserializeAws_queryListUserTagsCommand, serializeAws_queryListUserTagsCommand } from "../protocols/Aws_query.ts";
 ...
 * ```javascript
 * import { IAMClient, ListUserTagsCommand } from "../../client-iam/mod.ts";
