...
import { GetServerCertificateRequest, GetServerCertificateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IAMClient, GetServerCertificateCommand } from "../../client-iam/mod.ts";
