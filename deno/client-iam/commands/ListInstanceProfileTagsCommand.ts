...
import { ListInstanceProfileTagsRequest, ListInstanceProfileTagsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IAMClient, ListInstanceProfileTagsCommand } from "../../client-iam/mod.ts";
