...
import { GetOrganizationsAccessReportRequest, GetOrganizationsAccessReportResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IAMClient, GetOrganizationsAccessReportCommand } from "../../client-iam/mod.ts";
