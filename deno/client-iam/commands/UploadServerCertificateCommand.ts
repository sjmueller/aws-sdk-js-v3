...
import { UploadServerCertificateRequest, UploadServerCertificateResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IAMClient, UploadServerCertificateCommand } from "../../client-iam/mod.ts";
