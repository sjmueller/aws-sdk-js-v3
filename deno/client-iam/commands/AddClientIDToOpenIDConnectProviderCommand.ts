...
import { AddClientIDToOpenIDConnectProviderRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IAMClient, AddClientIDToOpenIDConnectProviderCommand } from "../../client-iam/mod.ts";
