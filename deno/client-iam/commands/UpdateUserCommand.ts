...
import { UpdateUserRequest } from "../models/models_1.ts";
import { deserializeAws_queryUpdateUserCommand, serializeAws_queryUpdateUserCommand } from "../protocols/Aws_query.ts";
 ...
 * ```javascript
 * import { IAMClient, UpdateUserCommand } from "../../client-iam/mod.ts";
