...
export type DescribeEventSubscriptionsCommandOutput = DescribeEventSubscriptionsResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeEventSubscriptionsCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeEventSubscriptionsCommand(
      output,
      context
    );
  }
