...
import { DescribeSchemasMessage, DescribeSchemasResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DatabaseMigrationServiceClient, DescribeSchemasCommand } from "../../client-database-migration-service/mod.ts";
