...
import { CreateEventSubscriptionMessage, CreateEventSubscriptionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DatabaseMigrationServiceClient, CreateEventSubscriptionCommand } from "../../client-database-migration-service/mod.ts";
