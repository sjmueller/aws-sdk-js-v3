...
import { DeleteCertificateMessage, DeleteCertificateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DatabaseMigrationServiceClient, DeleteCertificateCommand } from "../../client-database-migration-service/mod.ts";
