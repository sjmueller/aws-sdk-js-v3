...
import { ModifyEndpointMessage, ModifyEndpointResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DatabaseMigrationServiceClient, ModifyEndpointCommand } from "../../client-database-migration-service/mod.ts";
