...
import { DescribeEventsMessage, DescribeEventsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DatabaseMigrationServiceClient, DescribeEventsCommand } from "../../client-database-migration-service/mod.ts";
