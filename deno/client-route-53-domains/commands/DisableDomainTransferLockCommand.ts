...
import { DisableDomainTransferLockRequest, DisableDomainTransferLockResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53DomainsClient, DisableDomainTransferLockCommand } from "../../client-route-53-domains/mod.ts";
