...
import { UpdateDomainContactPrivacyRequest, UpdateDomainContactPrivacyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53DomainsClient, UpdateDomainContactPrivacyCommand } from "../../client-route-53-domains/mod.ts";
