...
import { DeleteTagsForDomainRequest, DeleteTagsForDomainResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53DomainsClient, DeleteTagsForDomainCommand } from "../../client-route-53-domains/mod.ts";
