...
export type ResendContactReachabilityEmailCommandOutput = ResendContactReachabilityEmailResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1ResendContactReachabilityEmailCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1ResendContactReachabilityEmailCommand(
      output,
      context
    );
  }
