...
import { UpdateDomainNameserversRequest, UpdateDomainNameserversResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53DomainsClient, UpdateDomainNameserversCommand } from "../../client-route-53-domains/mod.ts";
