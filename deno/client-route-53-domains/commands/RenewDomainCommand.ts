...
import { RenewDomainRequest, RenewDomainResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53DomainsClient, RenewDomainCommand } from "../../client-route-53-domains/mod.ts";
