...
import { CreateBackendEnvironmentRequest, CreateBackendEnvironmentResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AmplifyClient, CreateBackendEnvironmentCommand } from "../../client-amplify/mod.ts";
