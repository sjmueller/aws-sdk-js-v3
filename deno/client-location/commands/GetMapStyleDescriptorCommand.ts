...
import { GetMapStyleDescriptorRequest, GetMapStyleDescriptorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, GetMapStyleDescriptorCommand } from "../../client-location/mod.ts";
