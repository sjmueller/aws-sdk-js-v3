...
import { CreatePlaceIndexRequest, CreatePlaceIndexResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, CreatePlaceIndexCommand } from "../../client-location/mod.ts";
