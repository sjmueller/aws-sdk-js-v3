...
import { ListGeofenceCollectionsRequest, ListGeofenceCollectionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, ListGeofenceCollectionsCommand } from "../../client-location/mod.ts";
