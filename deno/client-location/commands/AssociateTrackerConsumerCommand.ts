...
import { AssociateTrackerConsumerRequest, AssociateTrackerConsumerResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, AssociateTrackerConsumerCommand } from "../../client-location/mod.ts";
