...
import { GetDevicePositionHistoryRequest, GetDevicePositionHistoryResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, GetDevicePositionHistoryCommand } from "../../client-location/mod.ts";
