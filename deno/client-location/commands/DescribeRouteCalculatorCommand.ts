...
import { DescribeRouteCalculatorRequest, DescribeRouteCalculatorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, DescribeRouteCalculatorCommand } from "../../client-location/mod.ts";
