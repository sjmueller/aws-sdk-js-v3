...
import { SearchPlaceIndexForTextRequest, SearchPlaceIndexForTextResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, SearchPlaceIndexForTextCommand } from "../../client-location/mod.ts";
