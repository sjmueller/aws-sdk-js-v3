...
import { SearchPlaceIndexForPositionRequest, SearchPlaceIndexForPositionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, SearchPlaceIndexForPositionCommand } from "../../client-location/mod.ts";
