...
import { CreateRouteCalculatorRequest, CreateRouteCalculatorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, CreateRouteCalculatorCommand } from "../../client-location/mod.ts";
