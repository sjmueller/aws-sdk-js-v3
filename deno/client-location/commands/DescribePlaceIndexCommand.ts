...
import { DescribePlaceIndexRequest, DescribePlaceIndexResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, DescribePlaceIndexCommand } from "../../client-location/mod.ts";
