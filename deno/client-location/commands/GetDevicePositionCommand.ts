...
import { GetDevicePositionRequest, GetDevicePositionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LocationClient, GetDevicePositionCommand } from "../../client-location/mod.ts";
