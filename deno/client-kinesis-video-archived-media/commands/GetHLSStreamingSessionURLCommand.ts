...
import { GetHLSStreamingSessionURLInput, GetHLSStreamingSessionURLOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KinesisVideoArchivedMediaClient, GetHLSStreamingSessionURLCommand } from "../../client-kinesis-video-archived-media/mod.ts";
