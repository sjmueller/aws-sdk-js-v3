...
import { AssociateResourceShareRequest, AssociateResourceShareResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RAMClient, AssociateResourceShareCommand } from "../../client-ram/mod.ts";
