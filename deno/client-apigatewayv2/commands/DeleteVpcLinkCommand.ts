...
import { DeleteVpcLinkRequest, DeleteVpcLinkResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, DeleteVpcLinkCommand } from "../../client-apigatewayv2/mod.ts";
