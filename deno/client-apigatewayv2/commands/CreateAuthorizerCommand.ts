...
import { CreateAuthorizerRequest, CreateAuthorizerResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, CreateAuthorizerCommand } from "../../client-apigatewayv2/mod.ts";
