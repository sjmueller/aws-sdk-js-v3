...
import { GetModelTemplateRequest, GetModelTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, GetModelTemplateCommand } from "../../client-apigatewayv2/mod.ts";
