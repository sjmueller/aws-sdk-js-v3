...
import { DeleteIntegrationResponseRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, DeleteIntegrationResponseCommand } from "../../client-apigatewayv2/mod.ts";
