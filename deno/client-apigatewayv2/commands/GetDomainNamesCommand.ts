...
import { GetDomainNamesRequest, GetDomainNamesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, GetDomainNamesCommand } from "../../client-apigatewayv2/mod.ts";
