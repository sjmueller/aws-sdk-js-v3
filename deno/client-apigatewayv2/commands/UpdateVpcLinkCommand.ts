...
import { UpdateVpcLinkRequest, UpdateVpcLinkResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, UpdateVpcLinkCommand } from "../../client-apigatewayv2/mod.ts";
