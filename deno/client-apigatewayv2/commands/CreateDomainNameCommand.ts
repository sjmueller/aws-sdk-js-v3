...
import { CreateDomainNameRequest, CreateDomainNameResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, CreateDomainNameCommand } from "../../client-apigatewayv2/mod.ts";
