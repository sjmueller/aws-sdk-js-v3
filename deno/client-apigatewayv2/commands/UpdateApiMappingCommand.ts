...
import { UpdateApiMappingRequest, UpdateApiMappingResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, UpdateApiMappingCommand } from "../../client-apigatewayv2/mod.ts";
