...
import { UpdateRouteResponseRequest, UpdateRouteResponseResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, UpdateRouteResponseCommand } from "../../client-apigatewayv2/mod.ts";
