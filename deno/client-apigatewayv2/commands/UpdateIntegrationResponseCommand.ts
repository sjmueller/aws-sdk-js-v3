...
import { UpdateIntegrationResponseRequest, UpdateIntegrationResponseResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ApiGatewayV2Client, UpdateIntegrationResponseCommand } from "../../client-apigatewayv2/mod.ts";
