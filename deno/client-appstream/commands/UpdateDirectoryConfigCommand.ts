...
import { UpdateDirectoryConfigRequest, UpdateDirectoryConfigResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AppStreamClient, UpdateDirectoryConfigCommand } from "../../client-appstream/mod.ts";
