...
import { DescribeGlobalSettingsInput, DescribeGlobalSettingsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BackupClient, DescribeGlobalSettingsCommand } from "../../client-backup/mod.ts";
