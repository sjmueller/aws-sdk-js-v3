...
import { PutBackupVaultAccessPolicyInput } from "../models/index.ts";
import {
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1PutBackupVaultAccessPolicyCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1PutBackupVaultAccessPolicyCommand(
      output,
      context
    );
  }
