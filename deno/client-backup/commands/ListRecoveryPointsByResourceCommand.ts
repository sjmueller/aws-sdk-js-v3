...
import { ListRecoveryPointsByResourceInput, ListRecoveryPointsByResourceOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BackupClient, ListRecoveryPointsByResourceCommand } from "../../client-backup/mod.ts";
