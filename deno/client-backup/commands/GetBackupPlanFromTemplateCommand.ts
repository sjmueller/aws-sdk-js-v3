...
import { GetBackupPlanFromTemplateInput, GetBackupPlanFromTemplateOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BackupClient, GetBackupPlanFromTemplateCommand } from "../../client-backup/mod.ts";
