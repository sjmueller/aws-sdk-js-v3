...
import { GetBackupVaultNotificationsInput, GetBackupVaultNotificationsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BackupClient, GetBackupVaultNotificationsCommand } from "../../client-backup/mod.ts";
