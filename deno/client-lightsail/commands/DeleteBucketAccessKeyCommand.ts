...
import { DeleteBucketAccessKeyRequest, DeleteBucketAccessKeyResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, DeleteBucketAccessKeyCommand } from "../../client-lightsail/mod.ts";
