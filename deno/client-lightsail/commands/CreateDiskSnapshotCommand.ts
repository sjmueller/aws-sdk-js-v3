...
import { CreateDiskSnapshotRequest, CreateDiskSnapshotResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, CreateDiskSnapshotCommand } from "../../client-lightsail/mod.ts";
