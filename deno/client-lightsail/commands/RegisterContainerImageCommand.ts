...
import { RegisterContainerImageRequest, RegisterContainerImageResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, RegisterContainerImageCommand } from "../../client-lightsail/mod.ts";
