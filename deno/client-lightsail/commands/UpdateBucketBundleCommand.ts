...
import { UpdateBucketBundleRequest, UpdateBucketBundleResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, UpdateBucketBundleCommand } from "../../client-lightsail/mod.ts";
