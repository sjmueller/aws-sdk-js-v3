...
import { GetBucketMetricDataRequest, GetBucketMetricDataResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, GetBucketMetricDataCommand } from "../../client-lightsail/mod.ts";
