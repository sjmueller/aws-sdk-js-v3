...
import { GetRelationalDatabaseSnapshotRequest, GetRelationalDatabaseSnapshotResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, GetRelationalDatabaseSnapshotCommand } from "../../client-lightsail/mod.ts";
