...
import { SetIpAddressTypeRequest, SetIpAddressTypeResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, SetIpAddressTypeCommand } from "../../client-lightsail/mod.ts";
