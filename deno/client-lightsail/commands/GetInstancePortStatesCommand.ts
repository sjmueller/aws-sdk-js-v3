...
import { GetInstancePortStatesRequest, GetInstancePortStatesResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, GetInstancePortStatesCommand } from "../../client-lightsail/mod.ts";
