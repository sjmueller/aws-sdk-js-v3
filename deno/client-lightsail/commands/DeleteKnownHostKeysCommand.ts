...
import { DeleteKnownHostKeysRequest, DeleteKnownHostKeysResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, DeleteKnownHostKeysCommand } from "../../client-lightsail/mod.ts";
