...
import { SetResourceAccessForBucketRequest, SetResourceAccessForBucketResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, SetResourceAccessForBucketCommand } from "../../client-lightsail/mod.ts";
