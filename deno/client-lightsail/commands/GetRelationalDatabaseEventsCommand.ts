...
import { GetRelationalDatabaseEventsRequest, GetRelationalDatabaseEventsResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, GetRelationalDatabaseEventsCommand } from "../../client-lightsail/mod.ts";
