...
import { GetInstanceMetricDataRequest, GetInstanceMetricDataResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { LightsailClient, GetInstanceMetricDataCommand } from "../../client-lightsail/mod.ts";
