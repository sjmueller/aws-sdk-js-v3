...
import { DescribeSecurityPolicyRequest, DescribeSecurityPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TransferClient, DescribeSecurityPolicyCommand } from "../../client-transfer/mod.ts";
