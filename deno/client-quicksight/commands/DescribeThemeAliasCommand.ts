...
import { DescribeThemeAliasRequest, DescribeThemeAliasResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, DescribeThemeAliasCommand } from "../../client-quicksight/mod.ts";
