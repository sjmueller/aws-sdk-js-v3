...
import { UpdateTemplateAliasRequest, UpdateTemplateAliasResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, UpdateTemplateAliasCommand } from "../../client-quicksight/mod.ts";
