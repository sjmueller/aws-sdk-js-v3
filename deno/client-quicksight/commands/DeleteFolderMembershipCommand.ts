...
import { DeleteFolderMembershipRequest, DeleteFolderMembershipResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, DeleteFolderMembershipCommand } from "../../client-quicksight/mod.ts";
