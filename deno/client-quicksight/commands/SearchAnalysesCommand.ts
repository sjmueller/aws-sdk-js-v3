...
import { SearchAnalysesRequest, SearchAnalysesResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, SearchAnalysesCommand } from "../../client-quicksight/mod.ts";
