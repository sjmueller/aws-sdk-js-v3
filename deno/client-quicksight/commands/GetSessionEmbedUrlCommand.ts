...
import { GetSessionEmbedUrlRequest, GetSessionEmbedUrlResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, GetSessionEmbedUrlCommand } from "../../client-quicksight/mod.ts";
