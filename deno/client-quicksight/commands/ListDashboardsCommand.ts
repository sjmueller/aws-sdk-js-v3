...
import { ListDashboardsRequest, ListDashboardsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, ListDashboardsCommand } from "../../client-quicksight/mod.ts";
