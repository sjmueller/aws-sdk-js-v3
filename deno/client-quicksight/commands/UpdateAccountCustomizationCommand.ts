...
import { UpdateAccountCustomizationRequest, UpdateAccountCustomizationResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, UpdateAccountCustomizationCommand } from "../../client-quicksight/mod.ts";
