...
import { CreateFolderMembershipRequest, CreateFolderMembershipResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, CreateFolderMembershipCommand } from "../../client-quicksight/mod.ts";
