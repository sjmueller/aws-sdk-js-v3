...
import { DescribeTemplateRequest, DescribeTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, DescribeTemplateCommand } from "../../client-quicksight/mod.ts";
