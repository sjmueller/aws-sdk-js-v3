...
import { DescribeFolderPermissionsRequest, DescribeFolderPermissionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { QuickSightClient, DescribeFolderPermissionsCommand } from "../../client-quicksight/mod.ts";
