...
import { DeleteBudgetActionRequest, DeleteBudgetActionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BudgetsClient, DeleteBudgetActionCommand } from "../../client-budgets/mod.ts";
