...
import { DescribeNotificationsForBudgetRequest, DescribeNotificationsForBudgetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BudgetsClient, DescribeNotificationsForBudgetCommand } from "../../client-budgets/mod.ts";
