...
import { ListThingGroupsForThingRequest, ListThingGroupsForThingResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, ListThingGroupsForThingCommand } from "../../client-iot/mod.ts";
