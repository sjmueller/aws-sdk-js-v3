...
import { CreateProvisioningTemplateRequest, CreateProvisioningTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, CreateProvisioningTemplateCommand } from "../../client-iot/mod.ts";
