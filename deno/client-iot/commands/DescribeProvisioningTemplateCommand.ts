...
export type DescribeProvisioningTemplateCommandOutput = DescribeProvisioningTemplateResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1DescribeProvisioningTemplateCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1DescribeProvisioningTemplateCommand(
      output,
      context
    );
  }
