...
import { ListThingRegistrationTaskReportsRequest, ListThingRegistrationTaskReportsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, ListThingRegistrationTaskReportsCommand } from "../../client-iot/mod.ts";
