...
export type ListOutgoingCertificatesCommandOutput = ListOutgoingCertificatesResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1ListOutgoingCertificatesCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1ListOutgoingCertificatesCommand(
      output,
      context
    );
  }
