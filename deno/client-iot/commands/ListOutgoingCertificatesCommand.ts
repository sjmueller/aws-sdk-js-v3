...
import { ListOutgoingCertificatesRequest, ListOutgoingCertificatesResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, ListOutgoingCertificatesCommand } from "../../client-iot/mod.ts";
