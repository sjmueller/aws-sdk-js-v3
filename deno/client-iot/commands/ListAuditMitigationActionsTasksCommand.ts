...
export type ListAuditMitigationActionsTasksCommandOutput = ListAuditMitigationActionsTasksResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1ListAuditMitigationActionsTasksCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1ListAuditMitigationActionsTasksCommand(
      output,
      context
    );
  }
