...
import { RejectCertificateTransferRequest } from "../models/index.ts";
import {
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1RejectCertificateTransferCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1RejectCertificateTransferCommand(
      output,
      context
    );
  }
