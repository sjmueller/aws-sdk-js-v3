...
export type UpdateDomainConfigurationCommandOutput = UpdateDomainConfigurationResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1UpdateDomainConfigurationCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1UpdateDomainConfigurationCommand(
      output,
      context
    );
  }
