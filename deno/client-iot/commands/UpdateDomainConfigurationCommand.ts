...
import { UpdateDomainConfigurationRequest, UpdateDomainConfigurationResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, UpdateDomainConfigurationCommand } from "../../client-iot/mod.ts";
