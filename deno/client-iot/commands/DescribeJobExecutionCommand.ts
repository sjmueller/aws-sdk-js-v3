...
import { DescribeJobExecutionRequest, DescribeJobExecutionResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, DescribeJobExecutionCommand } from "../../client-iot/mod.ts";
