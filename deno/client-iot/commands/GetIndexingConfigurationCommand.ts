...
import { GetIndexingConfigurationRequest, GetIndexingConfigurationResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, GetIndexingConfigurationCommand } from "../../client-iot/mod.ts";
