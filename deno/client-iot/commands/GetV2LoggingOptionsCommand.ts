...
import { GetV2LoggingOptionsRequest, GetV2LoggingOptionsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, GetV2LoggingOptionsCommand } from "../../client-iot/mod.ts";
