...
import { ListPrincipalThingsRequest, ListPrincipalThingsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, ListPrincipalThingsCommand } from "../../client-iot/mod.ts";
