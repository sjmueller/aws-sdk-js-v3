...
import { RegisterCertificateWithoutCARequest, RegisterCertificateWithoutCAResponse } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { IoTClient, RegisterCertificateWithoutCACommand } from "../../client-iot/mod.ts";
