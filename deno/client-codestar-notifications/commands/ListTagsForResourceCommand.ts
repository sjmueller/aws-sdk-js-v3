...
import { ListTagsForResourceRequest, ListTagsForResourceResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodestarNotificationsClient, ListTagsForResourceCommand } from "../../client-codestar-notifications/mod.ts";
