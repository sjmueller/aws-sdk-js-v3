...
import { ResetAllResourceLogLevelsRequest, ResetAllResourceLogLevelsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTWirelessClient, ResetAllResourceLogLevelsCommand } from "../../client-iot-wireless/mod.ts";
