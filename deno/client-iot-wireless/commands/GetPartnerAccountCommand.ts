...
import { GetPartnerAccountRequest, GetPartnerAccountResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTWirelessClient, GetPartnerAccountCommand } from "../../client-iot-wireless/mod.ts";
