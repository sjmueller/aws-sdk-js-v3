...
import { CreateServiceProfileRequest, CreateServiceProfileResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTWirelessClient, CreateServiceProfileCommand } from "../../client-iot-wireless/mod.ts";
