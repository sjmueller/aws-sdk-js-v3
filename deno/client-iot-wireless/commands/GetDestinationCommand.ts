...
import { GetDestinationRequest, GetDestinationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTWirelessClient, GetDestinationCommand } from "../../client-iot-wireless/mod.ts";
