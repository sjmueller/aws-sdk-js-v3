...
import { GetDeviceProfileRequest, GetDeviceProfileResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTWirelessClient, GetDeviceProfileCommand } from "../../client-iot-wireless/mod.ts";
