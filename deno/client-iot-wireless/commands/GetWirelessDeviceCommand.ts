...
import { GetWirelessDeviceRequest, GetWirelessDeviceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTWirelessClient, GetWirelessDeviceCommand } from "../../client-iot-wireless/mod.ts";
