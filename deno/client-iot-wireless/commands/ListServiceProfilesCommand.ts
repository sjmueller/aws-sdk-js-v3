...
import { ListServiceProfilesRequest, ListServiceProfilesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTWirelessClient, ListServiceProfilesCommand } from "../../client-iot-wireless/mod.ts";
