...
import { GetWirelessGatewayRequest, GetWirelessGatewayResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTWirelessClient, GetWirelessGatewayCommand } from "../../client-iot-wireless/mod.ts";
