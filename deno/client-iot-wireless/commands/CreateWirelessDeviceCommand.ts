...
import { CreateWirelessDeviceRequest, CreateWirelessDeviceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTWirelessClient, CreateWirelessDeviceCommand } from "../../client-iot-wireless/mod.ts";
