...
export type DeleteWirelessGatewayTaskCommandInput = DeleteWirelessGatewayTaskRequest;
export type DeleteWirelessGatewayTaskCommandOutput = DeleteWirelessGatewayTaskResponse & __MetadataBearer;
