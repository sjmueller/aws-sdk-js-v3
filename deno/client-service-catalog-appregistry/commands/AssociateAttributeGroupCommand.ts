...
import { AssociateAttributeGroupRequest, AssociateAttributeGroupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ServiceCatalogAppRegistryClient, AssociateAttributeGroupCommand } from "../../client-service-catalog-appregistry/mod.ts";
