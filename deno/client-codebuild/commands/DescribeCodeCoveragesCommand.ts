...
import { DescribeCodeCoveragesInput, DescribeCodeCoveragesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeBuildClient, DescribeCodeCoveragesCommand } from "../../client-codebuild/mod.ts";
