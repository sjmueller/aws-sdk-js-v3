...
import { BatchGetReportGroupsInput, BatchGetReportGroupsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeBuildClient, BatchGetReportGroupsCommand } from "../../client-codebuild/mod.ts";
