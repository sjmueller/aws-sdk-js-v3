...
import { ListSharedProjectsInput, ListSharedProjectsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeBuildClient, ListSharedProjectsCommand } from "../../client-codebuild/mod.ts";
