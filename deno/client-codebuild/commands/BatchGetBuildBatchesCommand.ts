...
import { BatchGetBuildBatchesInput, BatchGetBuildBatchesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeBuildClient, BatchGetBuildBatchesCommand } from "../../client-codebuild/mod.ts";
