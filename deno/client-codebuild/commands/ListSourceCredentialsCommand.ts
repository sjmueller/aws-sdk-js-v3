...
import { ListSourceCredentialsInput, ListSourceCredentialsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeBuildClient, ListSourceCredentialsCommand } from "../../client-codebuild/mod.ts";
