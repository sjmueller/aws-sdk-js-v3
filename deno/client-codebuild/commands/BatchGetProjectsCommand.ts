...
import { BatchGetProjectsInput, BatchGetProjectsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeBuildClient, BatchGetProjectsCommand } from "../../client-codebuild/mod.ts";
