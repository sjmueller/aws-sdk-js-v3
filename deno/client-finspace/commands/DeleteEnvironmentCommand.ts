...
import { DeleteEnvironmentRequest, DeleteEnvironmentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FinspaceClient, DeleteEnvironmentCommand } from "../../client-finspace/mod.ts";
