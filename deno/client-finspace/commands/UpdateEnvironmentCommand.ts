...
import { UpdateEnvironmentRequest, UpdateEnvironmentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FinspaceClient, UpdateEnvironmentCommand } from "../../client-finspace/mod.ts";
