...
import { CreateRealtimeEndpointInput, CreateRealtimeEndpointOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MachineLearningClient, CreateRealtimeEndpointCommand } from "../../client-machine-learning/mod.ts";
