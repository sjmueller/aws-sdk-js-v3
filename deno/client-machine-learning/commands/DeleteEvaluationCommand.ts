...
import { DeleteEvaluationInput, DeleteEvaluationOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MachineLearningClient, DeleteEvaluationCommand } from "../../client-machine-learning/mod.ts";
