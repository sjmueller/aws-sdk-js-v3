...
import { DescribeBatchPredictionsInput, DescribeBatchPredictionsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MachineLearningClient, DescribeBatchPredictionsCommand } from "../../client-machine-learning/mod.ts";
