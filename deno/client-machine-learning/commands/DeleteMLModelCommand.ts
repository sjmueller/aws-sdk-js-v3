...
import { DeleteMLModelInput, DeleteMLModelOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MachineLearningClient, DeleteMLModelCommand } from "../../client-machine-learning/mod.ts";
