...
import { BatchMeterUsageRequest, BatchMeterUsageResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MarketplaceMeteringClient, BatchMeterUsageCommand } from "../../client-marketplace-metering/mod.ts";
