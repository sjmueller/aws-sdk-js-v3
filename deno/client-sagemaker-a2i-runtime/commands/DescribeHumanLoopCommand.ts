...
import { DescribeHumanLoopRequest, DescribeHumanLoopResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SageMakerA2IRuntimeClient, DescribeHumanLoopCommand } from "../../client-sagemaker-a2i-runtime/mod.ts";
