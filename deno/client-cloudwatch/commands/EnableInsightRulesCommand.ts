...
import { EnableInsightRulesInput, EnableInsightRulesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudWatchClient, EnableInsightRulesCommand } from "../../client-cloudwatch/mod.ts";
