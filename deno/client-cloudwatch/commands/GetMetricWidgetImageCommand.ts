...
import { GetMetricWidgetImageInput, GetMetricWidgetImageOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudWatchClient, GetMetricWidgetImageCommand } from "../../client-cloudwatch/mod.ts";
