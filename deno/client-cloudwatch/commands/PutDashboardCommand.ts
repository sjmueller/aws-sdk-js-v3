...
import { PutDashboardInput, PutDashboardOutput } from "../models/models_0.ts";
import { deserializeAws_queryPutDashboardCommand, serializeAws_queryPutDashboardCommand } from "../protocols/Aws_query.ts";
 ...
 * ```javascript
 * import { CloudWatchClient, PutDashboardCommand } from "../../client-cloudwatch/mod.ts";
