...
import { GetCommentsForComparedCommitInput, GetCommentsForComparedCommitOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeCommitClient, GetCommentsForComparedCommitCommand } from "../../client-codecommit/mod.ts";
