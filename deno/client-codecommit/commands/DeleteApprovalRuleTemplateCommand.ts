...
import { DeleteApprovalRuleTemplateInput, DeleteApprovalRuleTemplateOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeCommitClient, DeleteApprovalRuleTemplateCommand } from "../../client-codecommit/mod.ts";
