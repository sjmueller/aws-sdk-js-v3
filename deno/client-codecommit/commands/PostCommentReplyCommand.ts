...
import { PostCommentReplyInput, PostCommentReplyOutput } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CodeCommitClient, PostCommentReplyCommand } from "../../client-codecommit/mod.ts";
