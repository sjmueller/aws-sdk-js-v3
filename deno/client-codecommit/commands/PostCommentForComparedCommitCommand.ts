...
import { PostCommentForComparedCommitInput, PostCommentForComparedCommitOutput } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CodeCommitClient, PostCommentForComparedCommitCommand } from "../../client-codecommit/mod.ts";
