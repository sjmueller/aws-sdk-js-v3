...
import { UpdatePullRequestTitleInput, UpdatePullRequestTitleOutput } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { CodeCommitClient, UpdatePullRequestTitleCommand } from "../../client-codecommit/mod.ts";
