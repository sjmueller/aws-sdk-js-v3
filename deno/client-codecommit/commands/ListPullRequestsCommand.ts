...
import { ListPullRequestsInput, ListPullRequestsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeCommitClient, ListPullRequestsCommand } from "../../client-codecommit/mod.ts";
