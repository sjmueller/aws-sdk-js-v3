...
import { CreateDeliveryStreamInput, CreateDeliveryStreamOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FirehoseClient, CreateDeliveryStreamCommand } from "../../client-firehose/mod.ts";
