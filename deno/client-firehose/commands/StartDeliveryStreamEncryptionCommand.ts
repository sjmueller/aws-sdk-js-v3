...
export type StartDeliveryStreamEncryptionCommandOutput = StartDeliveryStreamEncryptionOutput &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1StartDeliveryStreamEncryptionCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1StartDeliveryStreamEncryptionCommand(
      output,
      context
    );
  }
