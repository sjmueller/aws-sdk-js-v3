...
import { DescribeDeliveryStreamInput, DescribeDeliveryStreamOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FirehoseClient, DescribeDeliveryStreamCommand } from "../../client-firehose/mod.ts";
