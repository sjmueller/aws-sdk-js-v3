...
import { DeleteTimelineEventInput, DeleteTimelineEventOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, DeleteTimelineEventCommand } from "../../client-ssm-incidents/mod.ts";
