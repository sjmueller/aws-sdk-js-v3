...
import { DeleteResourcePolicyInput, DeleteResourcePolicyOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, DeleteResourcePolicyCommand } from "../../client-ssm-incidents/mod.ts";
