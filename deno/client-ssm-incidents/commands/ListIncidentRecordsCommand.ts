...
import { ListIncidentRecordsInput, ListIncidentRecordsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, ListIncidentRecordsCommand } from "../../client-ssm-incidents/mod.ts";
