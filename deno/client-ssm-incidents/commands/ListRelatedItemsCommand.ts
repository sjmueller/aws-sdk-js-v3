...
import { ListRelatedItemsInput, ListRelatedItemsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, ListRelatedItemsCommand } from "../../client-ssm-incidents/mod.ts";
