...
import { GetReplicationSetInput, GetReplicationSetOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, GetReplicationSetCommand } from "../../client-ssm-incidents/mod.ts";
