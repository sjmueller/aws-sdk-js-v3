...
import { ListResponsePlansInput, ListResponsePlansOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, ListResponsePlansCommand } from "../../client-ssm-incidents/mod.ts";
