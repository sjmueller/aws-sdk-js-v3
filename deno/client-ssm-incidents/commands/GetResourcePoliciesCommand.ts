...
import { GetResourcePoliciesInput, GetResourcePoliciesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, GetResourcePoliciesCommand } from "../../client-ssm-incidents/mod.ts";
