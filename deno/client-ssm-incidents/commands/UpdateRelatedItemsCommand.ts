...
import { UpdateRelatedItemsInput, UpdateRelatedItemsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, UpdateRelatedItemsCommand } from "../../client-ssm-incidents/mod.ts";
