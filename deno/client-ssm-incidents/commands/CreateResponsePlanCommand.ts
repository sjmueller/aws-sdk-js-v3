...
import { CreateResponsePlanInput, CreateResponsePlanOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, CreateResponsePlanCommand } from "../../client-ssm-incidents/mod.ts";
