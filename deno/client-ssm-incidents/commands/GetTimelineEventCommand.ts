...
import { GetTimelineEventInput, GetTimelineEventOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMIncidentsClient, GetTimelineEventCommand } from "../../client-ssm-incidents/mod.ts";
