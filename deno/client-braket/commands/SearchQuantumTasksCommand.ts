...
import { SearchQuantumTasksRequest, SearchQuantumTasksResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { BraketClient, SearchQuantumTasksCommand } from "../../client-braket/mod.ts";
