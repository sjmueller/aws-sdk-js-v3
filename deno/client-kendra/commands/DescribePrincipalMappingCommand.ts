...
import { DescribePrincipalMappingRequest, DescribePrincipalMappingResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KendraClient, DescribePrincipalMappingCommand } from "../../client-kendra/mod.ts";
