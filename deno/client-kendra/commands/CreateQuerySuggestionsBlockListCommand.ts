...
import { CreateQuerySuggestionsBlockListRequest, CreateQuerySuggestionsBlockListResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KendraClient, CreateQuerySuggestionsBlockListCommand } from "../../client-kendra/mod.ts";
