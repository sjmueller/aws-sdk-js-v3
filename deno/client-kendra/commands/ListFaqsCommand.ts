...
import { ListFaqsRequest, ListFaqsResponse } from "../models/models_0.ts";
import { deserializeAws_json1_1ListFaqsCommand, serializeAws_json1_1ListFaqsCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { KendraClient, ListFaqsCommand } from "../../client-kendra/mod.ts";
