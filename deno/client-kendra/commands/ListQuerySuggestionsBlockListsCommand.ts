...
import { ListQuerySuggestionsBlockListsRequest, ListQuerySuggestionsBlockListsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KendraClient, ListQuerySuggestionsBlockListsCommand } from "../../client-kendra/mod.ts";
