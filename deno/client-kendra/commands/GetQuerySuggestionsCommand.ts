...
import { GetQuerySuggestionsRequest, GetQuerySuggestionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { KendraClient, GetQuerySuggestionsCommand } from "../../client-kendra/mod.ts";
