...
import { ExitStandbyAnswer, ExitStandbyQuery } from "../models/models_0.ts";
import { deserializeAws_queryExitStandbyCommand, serializeAws_queryExitStandbyCommand } from "../protocols/Aws_query.ts";
 ...
 * ```javascript
 * import { AutoScalingClient, ExitStandbyCommand } from "../../client-auto-scaling/mod.ts";
