...
import { GetBackendAPIModelsRequest, GetBackendAPIModelsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AmplifyBackendClient, GetBackendAPIModelsCommand } from "../../client-amplifybackend/mod.ts";
