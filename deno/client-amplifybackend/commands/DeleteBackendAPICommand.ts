...
import { DeleteBackendAPIRequest, DeleteBackendAPIResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AmplifyBackendClient, DeleteBackendAPICommand } from "../../client-amplifybackend/mod.ts";
