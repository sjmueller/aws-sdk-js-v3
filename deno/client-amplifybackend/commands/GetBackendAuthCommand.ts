...
import { GetBackendAuthRequest, GetBackendAuthResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AmplifyBackendClient, GetBackendAuthCommand } from "../../client-amplifybackend/mod.ts";
