...
import { RemoveAllBackendsRequest, RemoveAllBackendsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AmplifyBackendClient, RemoveAllBackendsCommand } from "../../client-amplifybackend/mod.ts";
