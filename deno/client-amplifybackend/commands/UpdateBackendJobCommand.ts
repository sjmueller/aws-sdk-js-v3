...
import { UpdateBackendJobRequest, UpdateBackendJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AmplifyBackendClient, UpdateBackendJobCommand } from "../../client-amplifybackend/mod.ts";
