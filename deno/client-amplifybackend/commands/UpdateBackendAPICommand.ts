...
import { UpdateBackendAPIRequest, UpdateBackendAPIResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AmplifyBackendClient, UpdateBackendAPICommand } from "../../client-amplifybackend/mod.ts";
