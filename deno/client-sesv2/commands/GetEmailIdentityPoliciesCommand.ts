...
import { GetEmailIdentityPoliciesRequest, GetEmailIdentityPoliciesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SESv2Client, GetEmailIdentityPoliciesCommand } from "../../client-sesv2/mod.ts";
