...
import { UpdateEmailTemplateRequest, UpdateEmailTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SESv2Client, UpdateEmailTemplateCommand } from "../../client-sesv2/mod.ts";
