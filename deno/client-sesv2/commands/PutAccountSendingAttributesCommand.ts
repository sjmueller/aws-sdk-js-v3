...
import { PutAccountSendingAttributesRequest, PutAccountSendingAttributesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SESv2Client, PutAccountSendingAttributesCommand } from "../../client-sesv2/mod.ts";
