...
import { CreateEmailIdentityPolicyRequest, CreateEmailIdentityPolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SESv2Client, CreateEmailIdentityPolicyCommand } from "../../client-sesv2/mod.ts";
