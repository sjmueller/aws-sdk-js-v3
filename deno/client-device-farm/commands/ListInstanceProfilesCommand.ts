...
import { ListInstanceProfilesRequest, ListInstanceProfilesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DeviceFarmClient, ListInstanceProfilesCommand } from "../../client-device-farm/mod.ts";
