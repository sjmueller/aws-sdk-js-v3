...
import { GetInstanceProfileRequest, GetInstanceProfileResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DeviceFarmClient, GetInstanceProfileCommand } from "../../client-device-farm/mod.ts";
