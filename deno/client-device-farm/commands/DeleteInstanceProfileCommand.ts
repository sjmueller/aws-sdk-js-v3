...
import { DeleteInstanceProfileRequest, DeleteInstanceProfileResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DeviceFarmClient, DeleteInstanceProfileCommand } from "../../client-device-farm/mod.ts";
