...
import { CreateRemoteAccessSessionRequest, CreateRemoteAccessSessionResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DeviceFarmClient, CreateRemoteAccessSessionCommand } from "../../client-device-farm/mod.ts";
