...
import { GetSuiteRequest, GetSuiteResult } from "../models/models_0.ts";
import { deserializeAws_json1_1GetSuiteCommand, serializeAws_json1_1GetSuiteCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { DeviceFarmClient, GetSuiteCommand } from "../../client-device-farm/mod.ts";
