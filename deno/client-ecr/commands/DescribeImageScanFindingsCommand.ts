...
import { DescribeImageScanFindingsRequest, DescribeImageScanFindingsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ECRClient, DescribeImageScanFindingsCommand } from "../../client-ecr/mod.ts";
