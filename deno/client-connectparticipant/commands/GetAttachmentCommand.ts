...
import { GetAttachmentRequest, GetAttachmentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ConnectParticipantClient, GetAttachmentCommand } from "../../client-connectparticipant/mod.ts";
