...
import { CreateSMSSandboxPhoneNumberInput, CreateSMSSandboxPhoneNumberResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SNSClient, CreateSMSSandboxPhoneNumberCommand } from "../../client-sns/mod.ts";
