...
import { GetSMSSandboxAccountStatusInput, GetSMSSandboxAccountStatusResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SNSClient, GetSMSSandboxAccountStatusCommand } from "../../client-sns/mod.ts";
