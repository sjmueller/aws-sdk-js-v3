...
import { VerifySMSSandboxPhoneNumberInput, VerifySMSSandboxPhoneNumberResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SNSClient, VerifySMSSandboxPhoneNumberCommand } from "../../client-sns/mod.ts";
