...
export type DescribeElasticsearchDomainCommandOutput = DescribeElasticsearchDomainResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1DescribeElasticsearchDomainCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1DescribeElasticsearchDomainCommand(
      output,
      context
    );
  }
