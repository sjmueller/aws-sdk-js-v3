...
import { GetUpgradeStatusRequest, GetUpgradeStatusResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticsearchServiceClient, GetUpgradeStatusCommand } from "../../client-elasticsearch-service/mod.ts";
