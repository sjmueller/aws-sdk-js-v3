...
import { DescribePackagesRequest, DescribePackagesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElasticsearchServiceClient, DescribePackagesCommand } from "../../client-elasticsearch-service/mod.ts";
