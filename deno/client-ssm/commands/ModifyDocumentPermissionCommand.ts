...
import { ModifyDocumentPermissionRequest, ModifyDocumentPermissionResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, ModifyDocumentPermissionCommand } from "../../client-ssm/mod.ts";
