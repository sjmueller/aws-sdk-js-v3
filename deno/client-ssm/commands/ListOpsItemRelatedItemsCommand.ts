...
import { ListOpsItemRelatedItemsRequest, ListOpsItemRelatedItemsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, ListOpsItemRelatedItemsCommand } from "../../client-ssm/mod.ts";
