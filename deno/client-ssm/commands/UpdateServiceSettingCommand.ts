...
import { UpdateServiceSettingRequest, UpdateServiceSettingResult } from "../models/models_2.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, UpdateServiceSettingCommand } from "../../client-ssm/mod.ts";
