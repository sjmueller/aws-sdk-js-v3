...
import { ListInventoryEntriesRequest, ListInventoryEntriesResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, ListInventoryEntriesCommand } from "../../client-ssm/mod.ts";
