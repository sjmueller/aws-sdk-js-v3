...
import { UpdateAssociationStatusRequest, UpdateAssociationStatusResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, UpdateAssociationStatusCommand } from "../../client-ssm/mod.ts";
