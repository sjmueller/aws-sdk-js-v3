...
import { ListResourceDataSyncRequest, ListResourceDataSyncResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, ListResourceDataSyncCommand } from "../../client-ssm/mod.ts";
