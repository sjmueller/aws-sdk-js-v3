...
import { UpdateMaintenanceWindowRequest, UpdateMaintenanceWindowResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, UpdateMaintenanceWindowCommand } from "../../client-ssm/mod.ts";
