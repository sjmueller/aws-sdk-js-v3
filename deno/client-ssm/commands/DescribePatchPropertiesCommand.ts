...
import { DescribePatchPropertiesRequest, DescribePatchPropertiesResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, DescribePatchPropertiesCommand } from "../../client-ssm/mod.ts";
