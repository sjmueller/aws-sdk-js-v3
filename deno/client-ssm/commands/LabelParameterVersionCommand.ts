...
import { LabelParameterVersionRequest, LabelParameterVersionResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, LabelParameterVersionCommand } from "../../client-ssm/mod.ts";
