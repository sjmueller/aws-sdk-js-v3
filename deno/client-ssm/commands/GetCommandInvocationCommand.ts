...
import { GetCommandInvocationRequest, GetCommandInvocationResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, GetCommandInvocationCommand } from "../../client-ssm/mod.ts";
