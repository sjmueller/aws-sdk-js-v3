...
import { DeregisterManagedInstanceRequest, DeregisterManagedInstanceResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SSMClient, DeregisterManagedInstanceCommand } from "../../client-ssm/mod.ts";
