...
import { CreateDBClusterEndpointMessage, CreateDBClusterEndpointOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { NeptuneClient, CreateDBClusterEndpointCommand } from "../../client-neptune/mod.ts";
