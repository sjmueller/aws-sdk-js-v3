...
import { ListTagsForResourceMessage, TagListMessage } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElastiCacheClient, ListTagsForResourceCommand } from "../../client-elasticache/mod.ts";
