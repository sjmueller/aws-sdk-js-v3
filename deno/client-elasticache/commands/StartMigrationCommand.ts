...
import { StartMigrationMessage, StartMigrationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ElastiCacheClient, StartMigrationCommand } from "../../client-elasticache/mod.ts";
