...
import { CreateResolverRuleRequest, CreateResolverRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, CreateResolverRuleCommand } from "../../client-route53resolver/mod.ts";
