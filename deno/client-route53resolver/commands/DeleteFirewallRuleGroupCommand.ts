...
import { DeleteFirewallRuleGroupRequest, DeleteFirewallRuleGroupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, DeleteFirewallRuleGroupCommand } from "../../client-route53resolver/mod.ts";
