...
import { CreateFirewallRuleRequest, CreateFirewallRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, CreateFirewallRuleCommand } from "../../client-route53resolver/mod.ts";
