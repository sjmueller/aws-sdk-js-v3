...
import { GetResolverRuleRequest, GetResolverRuleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, GetResolverRuleCommand } from "../../client-route53resolver/mod.ts";
