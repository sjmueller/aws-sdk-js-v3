...
import { GetResolverRulePolicyRequest, GetResolverRulePolicyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, GetResolverRulePolicyCommand } from "../../client-route53resolver/mod.ts";
