...
import { UpdateFirewallDomainsRequest, UpdateFirewallDomainsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, UpdateFirewallDomainsCommand } from "../../client-route53resolver/mod.ts";
