...
import { UpdateResolverDnssecConfigRequest, UpdateResolverDnssecConfigResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, UpdateResolverDnssecConfigCommand } from "../../client-route53resolver/mod.ts";
