...
import { DeleteResolverEndpointRequest, DeleteResolverEndpointResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, DeleteResolverEndpointCommand } from "../../client-route53resolver/mod.ts";
