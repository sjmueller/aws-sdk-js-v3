...
import { ListFirewallDomainsRequest, ListFirewallDomainsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53ResolverClient, ListFirewallDomainsCommand } from "../../client-route53resolver/mod.ts";
