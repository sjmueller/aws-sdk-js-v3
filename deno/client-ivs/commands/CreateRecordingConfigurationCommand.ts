...
import { CreateRecordingConfigurationRequest, CreateRecordingConfigurationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IvsClient, CreateRecordingConfigurationCommand } from "../../client-ivs/mod.ts";
