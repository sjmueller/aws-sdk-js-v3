...
import { GetRecordingConfigurationRequest, GetRecordingConfigurationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IvsClient, GetRecordingConfigurationCommand } from "../../client-ivs/mod.ts";
