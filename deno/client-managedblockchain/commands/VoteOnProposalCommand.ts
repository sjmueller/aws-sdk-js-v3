...
import { VoteOnProposalInput, VoteOnProposalOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ManagedBlockchainClient, VoteOnProposalCommand } from "../../client-managedblockchain/mod.ts";
