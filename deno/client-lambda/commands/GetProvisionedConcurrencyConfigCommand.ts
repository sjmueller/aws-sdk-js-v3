...
export type GetProvisionedConcurrencyConfigCommandOutput = GetProvisionedConcurrencyConfigResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1GetProvisionedConcurrencyConfigCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1GetProvisionedConcurrencyConfigCommand(
      output,
      context
    );
  }
