...
export type UpdateEventSourceMappingCommandOutput = EventSourceMappingConfiguration &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1UpdateEventSourceMappingCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1UpdateEventSourceMappingCommand(
      output,
      context
    );
  }
