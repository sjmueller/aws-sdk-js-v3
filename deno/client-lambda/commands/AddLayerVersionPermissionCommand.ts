...
import { AddLayerVersionPermissionRequest, AddLayerVersionPermissionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LambdaClient, AddLayerVersionPermissionCommand } from "../../client-lambda/mod.ts";
