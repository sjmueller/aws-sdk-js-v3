...
import { FunctionEventInvokeConfig, PutFunctionEventInvokeConfigRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LambdaClient, PutFunctionEventInvokeConfigCommand } from "../../client-lambda/mod.ts";
