...
import { CreateEventSourceMappingRequest, EventSourceMappingConfiguration } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LambdaClient, CreateEventSourceMappingCommand } from "../../client-lambda/mod.ts";
