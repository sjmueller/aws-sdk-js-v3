...
import { DeleteFunctionCodeSigningConfigRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LambdaClient, DeleteFunctionCodeSigningConfigCommand } from "../../client-lambda/mod.ts";
