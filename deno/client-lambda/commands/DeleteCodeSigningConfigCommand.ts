...
import { DeleteCodeSigningConfigRequest, DeleteCodeSigningConfigResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LambdaClient, DeleteCodeSigningConfigCommand } from "../../client-lambda/mod.ts";
