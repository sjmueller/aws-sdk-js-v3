...
import { CreateCodeSigningConfigRequest, CreateCodeSigningConfigResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LambdaClient, CreateCodeSigningConfigCommand } from "../../client-lambda/mod.ts";
