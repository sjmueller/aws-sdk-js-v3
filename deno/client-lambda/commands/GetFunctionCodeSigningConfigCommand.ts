...
import { GetFunctionCodeSigningConfigRequest, GetFunctionCodeSigningConfigResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LambdaClient, GetFunctionCodeSigningConfigCommand } from "../../client-lambda/mod.ts";
