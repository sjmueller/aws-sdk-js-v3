...
import { DeleteProvisionedConcurrencyConfigRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LambdaClient, DeleteProvisionedConcurrencyConfigCommand } from "../../client-lambda/mod.ts";
