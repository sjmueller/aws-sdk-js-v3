...
import { UpdateAnomalyDetectorRequest, UpdateAnomalyDetectorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LookoutMetricsClient, UpdateAnomalyDetectorCommand } from "../../client-lookoutmetrics/mod.ts";
