...
import { GetSampleDataRequest, GetSampleDataResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LookoutMetricsClient, GetSampleDataCommand } from "../../client-lookoutmetrics/mod.ts";
