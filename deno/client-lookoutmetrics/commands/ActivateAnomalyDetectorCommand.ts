...
import { ActivateAnomalyDetectorRequest, ActivateAnomalyDetectorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LookoutMetricsClient, ActivateAnomalyDetectorCommand } from "../../client-lookoutmetrics/mod.ts";
