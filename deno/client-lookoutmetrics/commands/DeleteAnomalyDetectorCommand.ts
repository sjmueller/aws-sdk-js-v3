...
import { DeleteAnomalyDetectorRequest, DeleteAnomalyDetectorResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LookoutMetricsClient, DeleteAnomalyDetectorCommand } from "../../client-lookoutmetrics/mod.ts";
