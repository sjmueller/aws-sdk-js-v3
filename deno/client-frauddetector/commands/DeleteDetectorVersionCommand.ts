...
import { DeleteDetectorVersionRequest, DeleteDetectorVersionResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FraudDetectorClient, DeleteDetectorVersionCommand } from "../../client-frauddetector/mod.ts";
