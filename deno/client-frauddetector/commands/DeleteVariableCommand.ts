...
import { DeleteVariableRequest, DeleteVariableResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FraudDetectorClient, DeleteVariableCommand } from "../../client-frauddetector/mod.ts";
