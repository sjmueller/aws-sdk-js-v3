...
import { UpdateDetectorVersionStatusRequest, UpdateDetectorVersionStatusResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FraudDetectorClient, UpdateDetectorVersionStatusCommand } from "../../client-frauddetector/mod.ts";
