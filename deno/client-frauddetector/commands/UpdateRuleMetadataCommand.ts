...
import { UpdateRuleMetadataRequest, UpdateRuleMetadataResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FraudDetectorClient, UpdateRuleMetadataCommand } from "../../client-frauddetector/mod.ts";
