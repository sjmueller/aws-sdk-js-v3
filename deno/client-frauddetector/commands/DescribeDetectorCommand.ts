...
import { DescribeDetectorRequest, DescribeDetectorResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FraudDetectorClient, DescribeDetectorCommand } from "../../client-frauddetector/mod.ts";
