...
import { GetModelsRequest, GetModelsResult } from "../models/models_0.ts";
import { deserializeAws_json1_1GetModelsCommand, serializeAws_json1_1GetModelsCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { FraudDetectorClient, GetModelsCommand } from "../../client-frauddetector/mod.ts";
