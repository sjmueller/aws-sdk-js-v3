...
import { BatchCreateVariableRequest, BatchCreateVariableResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FraudDetectorClient, BatchCreateVariableCommand } from "../../client-frauddetector/mod.ts";
