...
import { GetModelVersionRequest, GetModelVersionResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FraudDetectorClient, GetModelVersionCommand } from "../../client-frauddetector/mod.ts";
