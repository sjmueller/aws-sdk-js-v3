...
import { ListAssetModelsRequest, ListAssetModelsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTSiteWiseClient, ListAssetModelsCommand } from "../../client-iotsitewise/mod.ts";
