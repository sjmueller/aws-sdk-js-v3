...
import { ListAssociatedAssetsRequest, ListAssociatedAssetsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { IoTSiteWiseClient, ListAssociatedAssetsCommand } from "../../client-iotsitewise/mod.ts";
