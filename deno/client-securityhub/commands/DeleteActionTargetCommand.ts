...
import { DeleteActionTargetRequest, DeleteActionTargetResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SecurityHubClient, DeleteActionTargetCommand } from "../../client-securityhub/mod.ts";
