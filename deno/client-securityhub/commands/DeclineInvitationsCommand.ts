...
import { DeclineInvitationsRequest } from "../models/models_0.ts";
import { DeclineInvitationsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SecurityHubClient, DeclineInvitationsCommand } from "../../client-securityhub/mod.ts";
