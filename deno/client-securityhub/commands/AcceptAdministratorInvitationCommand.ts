...
import { AcceptAdministratorInvitationRequest, AcceptAdministratorInvitationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SecurityHubClient, AcceptAdministratorInvitationCommand } from "../../client-securityhub/mod.ts";
