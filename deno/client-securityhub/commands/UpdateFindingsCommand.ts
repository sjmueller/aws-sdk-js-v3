...
import { UpdateFindingsRequest, UpdateFindingsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SecurityHubClient, UpdateFindingsCommand } from "../../client-securityhub/mod.ts";
