...
import { GetInvitationsCountRequest, GetInvitationsCountResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SecurityHubClient, GetInvitationsCountCommand } from "../../client-securityhub/mod.ts";
