...
import { BatchUpdateFindingsRequest, BatchUpdateFindingsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SecurityHubClient, BatchUpdateFindingsCommand } from "../../client-securityhub/mod.ts";
