...
import { DeleteInterconnectRequest, DeleteInterconnectResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, DeleteInterconnectCommand } from "../../client-direct-connect/mod.ts";
