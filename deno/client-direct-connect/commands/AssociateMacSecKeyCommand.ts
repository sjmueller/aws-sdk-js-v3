...
import { AssociateMacSecKeyRequest, AssociateMacSecKeyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, AssociateMacSecKeyCommand } from "../../client-direct-connect/mod.ts";
