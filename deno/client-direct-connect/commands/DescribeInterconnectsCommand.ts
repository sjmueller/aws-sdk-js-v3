...
import { DescribeInterconnectsRequest, Interconnects } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, DescribeInterconnectsCommand } from "../../client-direct-connect/mod.ts";
