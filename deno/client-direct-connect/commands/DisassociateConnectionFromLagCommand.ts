...
import { Connection, DisassociateConnectionFromLagRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, DisassociateConnectionFromLagCommand } from "../../client-direct-connect/mod.ts";
