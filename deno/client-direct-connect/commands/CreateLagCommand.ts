...
import { CreateLagRequest, Lag } from "../models/models_0.ts";
import { deserializeAws_json1_1CreateLagCommand, serializeAws_json1_1CreateLagCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { DirectConnectClient, CreateLagCommand } from "../../client-direct-connect/mod.ts";
