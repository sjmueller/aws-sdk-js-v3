...
import { AssociateVirtualInterfaceRequest, VirtualInterface } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, AssociateVirtualInterfaceCommand } from "../../client-direct-connect/mod.ts";
