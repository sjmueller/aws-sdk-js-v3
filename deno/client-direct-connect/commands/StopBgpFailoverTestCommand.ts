...
import { StopBgpFailoverTestRequest, StopBgpFailoverTestResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, StopBgpFailoverTestCommand } from "../../client-direct-connect/mod.ts";
