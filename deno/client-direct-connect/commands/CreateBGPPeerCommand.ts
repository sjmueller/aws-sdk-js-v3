...
import { CreateBGPPeerRequest, CreateBGPPeerResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, CreateBGPPeerCommand } from "../../client-direct-connect/mod.ts";
