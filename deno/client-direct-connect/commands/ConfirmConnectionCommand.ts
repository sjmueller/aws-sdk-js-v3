...
import { ConfirmConnectionRequest, ConfirmConnectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, ConfirmConnectionCommand } from "../../client-direct-connect/mod.ts";
