...
import { CreateInterconnectRequest, Interconnect } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, CreateInterconnectCommand } from "../../client-direct-connect/mod.ts";
