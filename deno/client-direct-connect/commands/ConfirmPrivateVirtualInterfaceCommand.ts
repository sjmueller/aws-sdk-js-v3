...
export type ConfirmPrivateVirtualInterfaceCommandOutput = ConfirmPrivateVirtualInterfaceResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1ConfirmPrivateVirtualInterfaceCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1ConfirmPrivateVirtualInterfaceCommand(
      output,
      context
    );
  }
