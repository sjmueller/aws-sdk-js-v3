...
import { DisassociateMacSecKeyRequest, DisassociateMacSecKeyResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DirectConnectClient, DisassociateMacSecKeyCommand } from "../../client-direct-connect/mod.ts";
