...
import { ContainsPiiEntitiesRequest, ContainsPiiEntitiesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ComprehendClient, ContainsPiiEntitiesCommand } from "../../client-comprehend/mod.ts";
