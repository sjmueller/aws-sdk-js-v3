...
import { ClassifyDocumentRequest, ClassifyDocumentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ComprehendClient, ClassifyDocumentCommand } from "../../client-comprehend/mod.ts";
