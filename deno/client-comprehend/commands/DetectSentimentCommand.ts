...
import { DetectSentimentRequest, DetectSentimentResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ComprehendClient, DetectSentimentCommand } from "../../client-comprehend/mod.ts";
