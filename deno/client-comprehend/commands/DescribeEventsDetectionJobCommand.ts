...
import { DescribeEventsDetectionJobRequest, DescribeEventsDetectionJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ComprehendClient, DescribeEventsDetectionJobCommand } from "../../client-comprehend/mod.ts";
