...
import { DescribeTopicsDetectionJobRequest, DescribeTopicsDetectionJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ComprehendClient, DescribeTopicsDetectionJobCommand } from "../../client-comprehend/mod.ts";
