...
import { ListEventsDetectionJobsRequest, ListEventsDetectionJobsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ComprehendClient, ListEventsDetectionJobsCommand } from "../../client-comprehend/mod.ts";
