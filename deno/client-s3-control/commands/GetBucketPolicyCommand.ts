...
import { GetBucketPolicyRequest, GetBucketPolicyResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { S3ControlClient, GetBucketPolicyCommand } from "../../client-s3-control/mod.ts";
