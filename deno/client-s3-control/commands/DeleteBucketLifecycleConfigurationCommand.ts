...
import { DeleteBucketLifecycleConfigurationRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { S3ControlClient, DeleteBucketLifecycleConfigurationCommand } from "../../client-s3-control/mod.ts";
