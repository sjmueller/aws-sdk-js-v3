...
import { GetAccessPointForObjectLambdaRequest, GetAccessPointForObjectLambdaResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { S3ControlClient, GetAccessPointForObjectLambdaCommand } from "../../client-s3-control/mod.ts";
