...
import { GetComplianceDetailRequest, GetComplianceDetailResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { FMSClient, GetComplianceDetailCommand } from "../../client-fms/mod.ts";
