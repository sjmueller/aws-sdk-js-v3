...
} from "./commands/GetScalingPlanResourceForecastDataCommand.ts";
import {
  UpdateScalingPlanCommand,
  UpdateScalingPlanCommandInput,
  UpdateScalingPlanCommandOutput,
} from "./commands/UpdateScalingPlanCommand.ts";
