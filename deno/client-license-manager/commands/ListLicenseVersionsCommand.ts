...
import { ListLicenseVersionsRequest, ListLicenseVersionsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LicenseManagerClient, ListLicenseVersionsCommand } from "../../client-license-manager/mod.ts";
