...
import { DeleteGrantRequest, DeleteGrantResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LicenseManagerClient, DeleteGrantCommand } from "../../client-license-manager/mod.ts";
