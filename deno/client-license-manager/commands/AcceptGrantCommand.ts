...
import { AcceptGrantRequest, AcceptGrantResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LicenseManagerClient, AcceptGrantCommand } from "../../client-license-manager/mod.ts";
