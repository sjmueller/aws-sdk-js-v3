...
import { CheckInLicenseRequest, CheckInLicenseResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { LicenseManagerClient, CheckInLicenseCommand } from "../../client-license-manager/mod.ts";
