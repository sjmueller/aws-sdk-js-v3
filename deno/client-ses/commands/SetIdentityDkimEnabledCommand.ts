...
import { SetIdentityDkimEnabledRequest, SetIdentityDkimEnabledResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SESClient, SetIdentityDkimEnabledCommand } from "../../client-ses/mod.ts";
