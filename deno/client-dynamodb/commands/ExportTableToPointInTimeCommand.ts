...
import { ExportTableToPointInTimeInput, ExportTableToPointInTimeOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DynamoDBClient, ExportTableToPointInTimeCommand } from "../../client-dynamodb/mod.ts";
