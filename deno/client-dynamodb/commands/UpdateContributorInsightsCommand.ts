...
import { UpdateContributorInsightsInput, UpdateContributorInsightsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DynamoDBClient, UpdateContributorInsightsCommand } from "../../client-dynamodb/mod.ts";
