...
import { DescribeTimeToLiveInput, DescribeTimeToLiveOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DynamoDBClient, DescribeTimeToLiveCommand } from "../../client-dynamodb/mod.ts";
