...
import { CreateGlobalTableInput, CreateGlobalTableOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DynamoDBClient, CreateGlobalTableCommand } from "../../client-dynamodb/mod.ts";
