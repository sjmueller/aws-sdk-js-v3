...
import { ExecuteTransactionInput, ExecuteTransactionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DynamoDBClient, ExecuteTransactionCommand } from "../../client-dynamodb/mod.ts";
