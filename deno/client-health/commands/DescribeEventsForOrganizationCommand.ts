...
import { DescribeEventsForOrganizationRequest, DescribeEventsForOrganizationResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { HealthClient, DescribeEventsForOrganizationCommand } from "../../client-health/mod.ts";
