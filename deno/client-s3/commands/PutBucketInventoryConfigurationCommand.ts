...
import { PutBucketInventoryConfigurationRequest } from "../models/index.ts";
import {
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restXmlPutBucketInventoryConfigurationCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restXmlPutBucketInventoryConfigurationCommand(
      output,
      context
    );
  }
