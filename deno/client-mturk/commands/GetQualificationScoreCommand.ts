...
import { GetQualificationScoreRequest, GetQualificationScoreResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MTurkClient, GetQualificationScoreCommand } from "../../client-mturk/mod.ts";
