...
import { UpdateNotificationSettingsRequest, UpdateNotificationSettingsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MTurkClient, UpdateNotificationSettingsCommand } from "../../client-mturk/mod.ts";
