...
import { UpdateQualificationTypeRequest, UpdateQualificationTypeResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { MTurkClient, UpdateQualificationTypeCommand } from "../../client-mturk/mod.ts";
