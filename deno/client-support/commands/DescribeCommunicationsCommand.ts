...
import { DescribeCommunicationsRequest, DescribeCommunicationsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SupportClient, DescribeCommunicationsCommand } from "../../client-support/mod.ts";
