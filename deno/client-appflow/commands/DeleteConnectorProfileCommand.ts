...
import { DeleteConnectorProfileRequest, DeleteConnectorProfileResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { AppflowClient, DeleteConnectorProfileCommand } from "../../client-appflow/mod.ts";
