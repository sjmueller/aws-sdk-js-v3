...
import { GetTelemetryMetadataRequest, GetTelemetryMetadataResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { InspectorClient, GetTelemetryMetadataCommand } from "../../client-inspector/mod.ts";
