...
import { CreateResourceGroupRequest, CreateResourceGroupResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { InspectorClient, CreateResourceGroupCommand } from "../../client-inspector/mod.ts";
