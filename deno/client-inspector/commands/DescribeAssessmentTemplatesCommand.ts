...
import { DescribeAssessmentTemplatesRequest, DescribeAssessmentTemplatesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { InspectorClient, DescribeAssessmentTemplatesCommand } from "../../client-inspector/mod.ts";
