...
import { DescribeCrossAccountAccessRoleResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { InspectorClient, DescribeCrossAccountAccessRoleCommand } from "../../client-inspector/mod.ts";
