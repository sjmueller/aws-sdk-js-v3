...
import { DescribeDRTAccessRequest, DescribeDRTAccessResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ShieldClient, DescribeDRTAccessCommand } from "../../client-shield/mod.ts";
