...
import { CreateSubscriptionRequest, CreateSubscriptionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ShieldClient, CreateSubscriptionCommand } from "../../client-shield/mod.ts";
