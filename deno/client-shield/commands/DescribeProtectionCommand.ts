...
import { DescribeProtectionRequest, DescribeProtectionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ShieldClient, DescribeProtectionCommand } from "../../client-shield/mod.ts";
