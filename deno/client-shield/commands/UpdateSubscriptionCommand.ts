...
import { UpdateSubscriptionRequest, UpdateSubscriptionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { ShieldClient, UpdateSubscriptionCommand } from "../../client-shield/mod.ts";
