...
import { GetRecordRequest, GetRecordResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SageMakerFeatureStoreRuntimeClient, GetRecordCommand } from "../../client-sagemaker-featurestore-runtime/mod.ts";
