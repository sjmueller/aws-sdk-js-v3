...
import { BatchGetRecordRequest, BatchGetRecordResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SageMakerFeatureStoreRuntimeClient, BatchGetRecordCommand } from "../../client-sagemaker-featurestore-runtime/mod.ts";
