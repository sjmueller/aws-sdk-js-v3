...
import { DeleteRecordRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SageMakerFeatureStoreRuntimeClient, DeleteRecordCommand } from "../../client-sagemaker-featurestore-runtime/mod.ts";
