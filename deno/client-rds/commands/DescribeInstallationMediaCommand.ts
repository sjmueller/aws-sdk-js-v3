...
import { DescribeInstallationMediaMessage, InstallationMediaMessage } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RDSClient, DescribeInstallationMediaCommand } from "../../client-rds/mod.ts";
