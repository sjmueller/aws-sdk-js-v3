...
import { RemoveFromGlobalClusterMessage, RemoveFromGlobalClusterResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RDSClient, RemoveFromGlobalClusterCommand } from "../../client-rds/mod.ts";
