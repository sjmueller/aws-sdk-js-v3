...
import { DescribeEventCategoriesMessage, EventCategoriesMessage } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RDSClient, DescribeEventCategoriesCommand } from "../../client-rds/mod.ts";
