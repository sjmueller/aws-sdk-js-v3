...
import { DescribeDBSnapshotAttributesMessage, DescribeDBSnapshotAttributesResult } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RDSClient, DescribeDBSnapshotAttributesCommand } from "../../client-rds/mod.ts";
