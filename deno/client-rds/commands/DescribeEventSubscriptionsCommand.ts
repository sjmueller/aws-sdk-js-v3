...
import { DescribeEventSubscriptionsMessage, EventSubscriptionsMessage } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RDSClient, DescribeEventSubscriptionsCommand } from "../../client-rds/mod.ts";
