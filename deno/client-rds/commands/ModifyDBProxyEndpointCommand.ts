...
import { ModifyDBProxyEndpointRequest, ModifyDBProxyEndpointResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { RDSClient, ModifyDBProxyEndpointCommand } from "../../client-rds/mod.ts";
