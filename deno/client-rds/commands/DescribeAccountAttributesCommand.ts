...
import { AccountAttributesMessage, DescribeAccountAttributesMessage } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RDSClient, DescribeAccountAttributesCommand } from "../../client-rds/mod.ts";
