...
import { CreateDBProxyEndpointRequest, CreateDBProxyEndpointResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { RDSClient, CreateDBProxyEndpointCommand } from "../../client-rds/mod.ts";
