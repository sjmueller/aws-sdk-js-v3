...
import { DescribePipelinesInput, DescribePipelinesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DataPipelineClient, DescribePipelinesCommand } from "../../client-data-pipeline/mod.ts";
