...
import { DescribeObjectsInput, DescribeObjectsOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DataPipelineClient, DescribeObjectsCommand } from "../../client-data-pipeline/mod.ts";
