...
} from "./commands/DescribeTrailsCommand.ts";
import {
  GetEventSelectorsCommand,
  GetEventSelectorsCommandInput,
  GetEventSelectorsCommandOutput,
} from "./commands/GetEventSelectorsCommand.ts";
import {
  GetInsightSelectorsCommand,
  GetInsightSelectorsCommandInput,
  GetInsightSelectorsCommandOutput,
} from "./commands/GetInsightSelectorsCommand.ts";
import { GetTrailCommand, GetTrailCommandInput, GetTrailCommandOutput } from "./commands/GetTrailCommand.ts";
import {
  GetTrailStatusCommand,
  GetTrailStatusCommandInput,
  GetTrailStatusCommandOutput,
} from "./commands/GetTrailStatusCommand.ts";
import {
...
} from "./commands/PutEventSelectorsCommand.ts";
import {
