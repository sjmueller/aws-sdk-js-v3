...
import { GetInsightSelectorsRequest, GetInsightSelectorsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudTrailClient, GetInsightSelectorsCommand } from "../../client-cloudtrail/mod.ts";
