...
import { ListTagsForProjectRequest, ListTagsForProjectResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeStarClient, ListTagsForProjectCommand } from "../../client-codestar/mod.ts";
