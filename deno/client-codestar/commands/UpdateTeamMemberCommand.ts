...
import { UpdateTeamMemberRequest, UpdateTeamMemberResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CodeStarClient, UpdateTeamMemberCommand } from "../../client-codestar/mod.ts";
