...
import { DeleteReadinessCheckRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryReadinessClient, DeleteReadinessCheckCommand } from "../../client-route53-recovery-readiness/mod.ts";
