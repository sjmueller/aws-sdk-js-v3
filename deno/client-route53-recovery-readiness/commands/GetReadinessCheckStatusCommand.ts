...
import { GetReadinessCheckStatusRequest, GetReadinessCheckStatusResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryReadinessClient, GetReadinessCheckStatusCommand } from "../../client-route53-recovery-readiness/mod.ts";
