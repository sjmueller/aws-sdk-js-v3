...
import { DeleteResourceSetRequest } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryReadinessClient, DeleteResourceSetCommand } from "../../client-route53-recovery-readiness/mod.ts";
