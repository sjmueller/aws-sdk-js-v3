...
import { GetReadinessCheckRequest, GetReadinessCheckResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryReadinessClient, GetReadinessCheckCommand } from "../../client-route53-recovery-readiness/mod.ts";
