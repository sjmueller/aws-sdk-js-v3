...
import { GetResourceSetRequest, GetResourceSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryReadinessClient, GetResourceSetCommand } from "../../client-route53-recovery-readiness/mod.ts";
