...
import { UpdateResourceSetRequest, UpdateResourceSetResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { Route53RecoveryReadinessClient, UpdateResourceSetCommand } from "../../client-route53-recovery-readiness/mod.ts";
