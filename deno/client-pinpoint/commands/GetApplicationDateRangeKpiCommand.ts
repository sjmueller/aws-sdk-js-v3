...
import { GetApplicationDateRangeKpiRequest, GetApplicationDateRangeKpiResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, GetApplicationDateRangeKpiCommand } from "../../client-pinpoint/mod.ts";
