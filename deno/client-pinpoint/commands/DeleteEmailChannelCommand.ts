...
import { DeleteEmailChannelRequest, DeleteEmailChannelResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, DeleteEmailChannelCommand } from "../../client-pinpoint/mod.ts";
