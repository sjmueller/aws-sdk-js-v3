...
import { GetApnsVoipSandboxChannelRequest, GetApnsVoipSandboxChannelResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, GetApnsVoipSandboxChannelCommand } from "../../client-pinpoint/mod.ts";
