...
import { UpdateJourneyStateRequest, UpdateJourneyStateResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, UpdateJourneyStateCommand } from "../../client-pinpoint/mod.ts";
