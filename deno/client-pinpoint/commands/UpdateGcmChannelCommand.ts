...
import { UpdateGcmChannelRequest, UpdateGcmChannelResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, UpdateGcmChannelCommand } from "../../client-pinpoint/mod.ts";
