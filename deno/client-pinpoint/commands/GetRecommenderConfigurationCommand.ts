...
import { GetRecommenderConfigurationRequest, GetRecommenderConfigurationResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, GetRecommenderConfigurationCommand } from "../../client-pinpoint/mod.ts";
