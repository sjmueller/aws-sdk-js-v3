...
import { CreateVoiceTemplateRequest, CreateVoiceTemplateResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, CreateVoiceTemplateCommand } from "../../client-pinpoint/mod.ts";
