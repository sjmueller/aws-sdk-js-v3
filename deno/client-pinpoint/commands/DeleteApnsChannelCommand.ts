...
import { DeleteApnsChannelRequest, DeleteApnsChannelResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, DeleteApnsChannelCommand } from "../../client-pinpoint/mod.ts";
