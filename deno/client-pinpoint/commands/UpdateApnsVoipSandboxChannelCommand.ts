...
import { UpdateApnsVoipSandboxChannelRequest, UpdateApnsVoipSandboxChannelResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, UpdateApnsVoipSandboxChannelCommand } from "../../client-pinpoint/mod.ts";
