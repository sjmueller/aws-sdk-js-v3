...
import { DeleteApnsVoipChannelRequest, DeleteApnsVoipChannelResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { PinpointClient, DeleteApnsVoipChannelCommand } from "../../client-pinpoint/mod.ts";
