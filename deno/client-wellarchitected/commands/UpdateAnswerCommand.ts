...
import { UpdateAnswerInput, UpdateAnswerOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WellArchitectedClient, UpdateAnswerCommand } from "../../client-wellarchitected/mod.ts";
