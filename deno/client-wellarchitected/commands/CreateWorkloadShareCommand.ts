...
import { CreateWorkloadShareInput, CreateWorkloadShareOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WellArchitectedClient, CreateWorkloadShareCommand } from "../../client-wellarchitected/mod.ts";
