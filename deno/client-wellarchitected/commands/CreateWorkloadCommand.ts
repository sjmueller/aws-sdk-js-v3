...
import { CreateWorkloadInput, CreateWorkloadOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WellArchitectedClient, CreateWorkloadCommand } from "../../client-wellarchitected/mod.ts";
