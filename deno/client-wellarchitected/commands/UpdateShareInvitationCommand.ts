...
import { UpdateShareInvitationInput, UpdateShareInvitationOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { WellArchitectedClient, UpdateShareInvitationCommand } from "../../client-wellarchitected/mod.ts";
