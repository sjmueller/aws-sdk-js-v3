...
import { AddTagsToResourceRequest, AddTagsToResourceResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudHSMClient, AddTagsToResourceCommand } from "../../client-cloudhsm/mod.ts";
