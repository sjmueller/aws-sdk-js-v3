...
import { ListHsmsRequest, ListHsmsResponse } from "../models/models_0.ts";
import { deserializeAws_json1_1ListHsmsCommand, serializeAws_json1_1ListHsmsCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { CloudHSMClient, ListHsmsCommand } from "../../client-cloudhsm/mod.ts";
