...
import { ListAvailableZonesRequest, ListAvailableZonesResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { CloudHSMClient, ListAvailableZonesCommand } from "../../client-cloudhsm/mod.ts";
