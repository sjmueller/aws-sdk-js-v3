...
import { ListHapgsRequest, ListHapgsResponse } from "../models/models_0.ts";
import { deserializeAws_json1_1ListHapgsCommand, serializeAws_json1_1ListHapgsCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { CloudHSMClient, ListHapgsCommand } from "../../client-cloudhsm/mod.ts";
