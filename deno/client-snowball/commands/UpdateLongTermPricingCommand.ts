...
import { UpdateLongTermPricingRequest, UpdateLongTermPricingResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SnowballClient, UpdateLongTermPricingCommand } from "../../client-snowball/mod.ts";
