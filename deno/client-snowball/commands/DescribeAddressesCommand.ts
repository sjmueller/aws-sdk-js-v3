...
import { DescribeAddressesRequest, DescribeAddressesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SnowballClient, DescribeAddressesCommand } from "../../client-snowball/mod.ts";
