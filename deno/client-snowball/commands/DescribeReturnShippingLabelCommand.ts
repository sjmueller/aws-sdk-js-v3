...
import { DescribeReturnShippingLabelRequest, DescribeReturnShippingLabelResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { SnowballClient, DescribeReturnShippingLabelCommand } from "../../client-snowball/mod.ts";
