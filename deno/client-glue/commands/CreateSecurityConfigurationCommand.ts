...
export type CreateSecurityConfigurationCommandOutput = CreateSecurityConfigurationResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1CreateSecurityConfigurationCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1CreateSecurityConfigurationCommand(
      output,
      context
    );
  }
