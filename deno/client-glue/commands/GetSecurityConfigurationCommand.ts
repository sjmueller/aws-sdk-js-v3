...
import { GetSecurityConfigurationRequest, GetSecurityConfigurationResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, GetSecurityConfigurationCommand } from "../../client-glue/mod.ts";
