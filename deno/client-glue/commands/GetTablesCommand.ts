...
import { GetTablesRequest, GetTablesResponse } from "../models/models_1.ts";
import { deserializeAws_json1_1GetTablesCommand, serializeAws_json1_1GetTablesCommand } from "../protocols/Aws_json1_1.ts";
 ...
 * ```javascript
 * import { GlueClient, GetTablesCommand } from "../../client-glue/mod.ts";
