...
import { CreateUserDefinedFunctionRequest, CreateUserDefinedFunctionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, CreateUserDefinedFunctionCommand } from "../../client-glue/mod.ts";
