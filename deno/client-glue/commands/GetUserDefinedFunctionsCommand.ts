...
import { GetUserDefinedFunctionsRequest, GetUserDefinedFunctionsResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, GetUserDefinedFunctionsCommand } from "../../client-glue/mod.ts";
