...
import { BatchDeletePartitionRequest, BatchDeletePartitionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, BatchDeletePartitionCommand } from "../../client-glue/mod.ts";
