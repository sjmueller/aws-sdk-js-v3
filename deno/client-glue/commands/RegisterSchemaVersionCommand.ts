...
import { RegisterSchemaVersionInput, RegisterSchemaVersionResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, RegisterSchemaVersionCommand } from "../../client-glue/mod.ts";
