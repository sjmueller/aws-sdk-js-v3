...
import { CheckSchemaVersionValidityInput, CheckSchemaVersionValidityResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, CheckSchemaVersionValidityCommand } from "../../client-glue/mod.ts";
