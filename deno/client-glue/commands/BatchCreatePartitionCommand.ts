...
import { BatchCreatePartitionRequest, BatchCreatePartitionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GlueClient, BatchCreatePartitionCommand } from "../../client-glue/mod.ts";
