...
import { UpdateLocationObjectStorageRequest, UpdateLocationObjectStorageResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DataSyncClient, UpdateLocationObjectStorageCommand } from "../../client-datasync/mod.ts";
