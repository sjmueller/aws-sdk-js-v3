...
import { UpdateLocationSmbRequest, UpdateLocationSmbResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DataSyncClient, UpdateLocationSmbCommand } from "../../client-datasync/mod.ts";
