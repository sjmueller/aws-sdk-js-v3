...
import { UpdateTaskExecutionRequest, UpdateTaskExecutionResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DataSyncClient, UpdateTaskExecutionCommand } from "../../client-datasync/mod.ts";
