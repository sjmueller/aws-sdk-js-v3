...
import { DescribeLocationEfsRequest, DescribeLocationEfsResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { DataSyncClient, DescribeLocationEfsCommand } from "../../client-datasync/mod.ts";
