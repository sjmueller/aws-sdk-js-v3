...
import { CreateTapeWithBarcodeInput, CreateTapeWithBarcodeOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, CreateTapeWithBarcodeCommand } from "../../client-storage-gateway/mod.ts";
