...
import { AssignTapePoolInput, AssignTapePoolOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, AssignTapePoolCommand } from "../../client-storage-gateway/mod.ts";
