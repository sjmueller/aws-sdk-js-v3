...
import { AddWorkingStorageInput, AddWorkingStorageOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, AddWorkingStorageCommand } from "../../client-storage-gateway/mod.ts";
