...
import { DescribeTapesInput, DescribeTapesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, DescribeTapesCommand } from "../../client-storage-gateway/mod.ts";
