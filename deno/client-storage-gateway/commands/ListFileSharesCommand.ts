...
import { ListFileSharesInput, ListFileSharesOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, ListFileSharesCommand } from "../../client-storage-gateway/mod.ts";
