...
import { DeleteTapePoolInput, DeleteTapePoolOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, DeleteTapePoolCommand } from "../../client-storage-gateway/mod.ts";
