...
import { UpdateGatewaySoftwareNowInput, UpdateGatewaySoftwareNowOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, UpdateGatewaySoftwareNowCommand } from "../../client-storage-gateway/mod.ts";
