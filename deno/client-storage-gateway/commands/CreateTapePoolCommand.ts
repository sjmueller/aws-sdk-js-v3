...
import { CreateTapePoolInput, CreateTapePoolOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, CreateTapePoolCommand } from "../../client-storage-gateway/mod.ts";
