...
import { DeleteTapeArchiveInput, DeleteTapeArchiveOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, DeleteTapeArchiveCommand } from "../../client-storage-gateway/mod.ts";
