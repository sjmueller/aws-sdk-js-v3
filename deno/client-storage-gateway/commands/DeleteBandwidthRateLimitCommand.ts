...
import { DeleteBandwidthRateLimitInput, DeleteBandwidthRateLimitOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, DeleteBandwidthRateLimitCommand } from "../../client-storage-gateway/mod.ts";
