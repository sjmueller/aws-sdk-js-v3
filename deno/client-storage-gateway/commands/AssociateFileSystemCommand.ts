...
import { AssociateFileSystemInput, AssociateFileSystemOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { StorageGatewayClient, AssociateFileSystemCommand } from "../../client-storage-gateway/mod.ts";
