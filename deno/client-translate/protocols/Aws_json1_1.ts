...
} from "../commands/DeleteTerminologyCommand.ts";
import {
...
} from "../commands/GetTerminologyCommand.ts";
import {
  ImportTerminologyCommandInput,
  ImportTerminologyCommandOutput
} from "../commands/ImportTerminologyCommand.ts";
import {
  ListTerminologiesCommandInput,
  ListTerminologiesCommandOutput
} from "../commands/ListTerminologiesCommand.ts";
import {
...
} from "../commands/TranslateTextCommand.ts";
import {
  AppliedTerminology,
...
const deserializeAws_json1_1Term = (
  ...
  return {
    __type: "Term",
    SourceText:
      output.SourceText !== undefined && output.SourceText !== null
        ? output.SourceText
        : undefined,
    TargetText:
      output.TargetText !== undefined && output.TargetText !== null
        ? output.TargetText
        : undefined
  } as any;
};
  ...
  return {
    ...
    TargetLanguageCodes:
      ...
      output.TargetLanguageCodes !== null
        ...
        : undefined,
    TermCount:
      output.TermCount !== undefined && output.TermCount !== null
        ? output.TermCount
        : undefined
  } as any;
};
  ...
  return {
    ...
    TargetLanguageCode:
      ...
      output.TargetLanguageCode !== null
        ...
        : undefined,
    TranslatedText:
      output.TranslatedText !== undefined && output.TranslatedText !== null
