...
import { StartTextTranslationJobRequest, StartTextTranslationJobResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TranslateClient, StartTextTranslationJobCommand } from "../../client-translate/mod.ts";
