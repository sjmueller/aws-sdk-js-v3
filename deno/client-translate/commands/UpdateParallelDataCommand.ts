...
import { UpdateParallelDataRequest, UpdateParallelDataResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TranslateClient, UpdateParallelDataCommand } from "../../client-translate/mod.ts";
