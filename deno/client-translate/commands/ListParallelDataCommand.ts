...
import { ListParallelDataRequest, ListParallelDataResponse } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { TranslateClient, ListParallelDataCommand } from "../../client-translate/mod.ts";
