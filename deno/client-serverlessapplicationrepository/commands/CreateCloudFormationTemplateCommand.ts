...
export type CreateCloudFormationTemplateCommandOutput = CreateCloudFormationTemplateResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1CreateCloudFormationTemplateCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1CreateCloudFormationTemplateCommand(
      output,
      context
    );
  }
