...
import { GetSamplingStatisticSummariesRequest, GetSamplingStatisticSummariesResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { XRayClient, GetSamplingStatisticSummariesCommand } from "../../client-xray/mod.ts";
