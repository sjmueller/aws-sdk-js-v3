...
import { GetTimeSeriesServiceStatisticsRequest, GetTimeSeriesServiceStatisticsResult } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { XRayClient, GetTimeSeriesServiceStatisticsCommand } from "../../client-xray/mod.ts";
